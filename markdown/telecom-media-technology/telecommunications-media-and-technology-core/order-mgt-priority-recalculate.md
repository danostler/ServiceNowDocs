...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-media-technology/telecommunications-media-and-technology-core/order-mgt-priority-recalculate.html
release: zurich
...
3.  Update the Priority field in the Customer Order form or for the order line items and click **Re-calculate**.
