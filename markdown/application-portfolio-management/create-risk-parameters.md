...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/create-risk-parameters.html
release: zurich
topic_type: task
...
3.  Fill in the form fields.
    ...
    For field information, see [Risk Parameter form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/risk-parameter-form.md).
...
After creating the risk parameters [run the TPM risk engine to load the risk parameters and compute the application service risks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/run-scheduled-job-to-calculate-risks.md).
