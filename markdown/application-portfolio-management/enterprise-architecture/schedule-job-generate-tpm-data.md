...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/enterprise-architecture/schedule-job-generate-tpm-data.html
release: zurich
...
**Note:** You can also run the job on-demand. For details, see [Run a scheduled job to generate TPM lifecycle data - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/run-scheduled-job-update-tpm-data.md).
