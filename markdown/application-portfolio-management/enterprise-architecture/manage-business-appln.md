...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/enterprise-architecture/manage-business-appln.html
release: zurich
...
3.  On the form, fill in the fields.
    ...
    For field information, see [Business Application Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/business-application-form.md).
...
6.  To [view the roadmap of the business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/view-business-application-roadmap.md) and its related data, select **View Application Roadmap**.

    You have to activate the PPM Standard \(com.snc.financial\_planning\_pmo\) plugin to view the business application roadmap.

7.  To get all the available and significant information of a business application, select [Application 360](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/applications-360-dashboard.md).
...
10. To retrieve [software models associated to the business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/software-models-suggestions-application-service.md), select **Manage Technology Models**.
...
11. To navigate to the timeline view of the business application and to view the timeline of all its associated epics, stories, enhancements, other stories, projects, and demands, select the additional actions icon \(\) and configure UI actions to display the **View Application Backlog** button.
    ...
    For more information on this timeline view, see [Application Backlog view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/tpm-by-app-unified-backlog.md).


## What to do next

To have a complete view of the business applications, select the [Application 360 dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/applications-360-dashboard.md).
