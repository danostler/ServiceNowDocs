...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/enterprise-architecture/balm-req-digital-integration.html
release: zurich
...
3.  On the Request a Digital Integration form, fill in the fields.
    ...
    For a description of the field values, see [Request digital integration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/request-digital-integration-form.md).
