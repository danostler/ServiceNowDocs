...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/enterprise-architecture/balm-request-arb-review.html
release: zurich
...
3.  On the form, fill in the fields.
    ...
    **Note:**
    ...
    For field information, see [Request Architecture Review form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/enterprise-architecture/request-architecture-review-form.md).
