...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/create-data-domain-info-architecture.html
release: zurich
topic_type: task
