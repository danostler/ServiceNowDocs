...
4.  On the **Details** tab, on the form, fill in the fields.
    ...
    To learn more about the fields, see [configure a territory phone display rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/t_ConfigATerritoryPhoneDisplRule.md).
...
6.  Select **Save**
    ...
    Related tabs appear next to the **Details** tab. To learn more, see [configure a territory phone display rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/t_ConfigATerritoryPhoneDisplRule.md).
