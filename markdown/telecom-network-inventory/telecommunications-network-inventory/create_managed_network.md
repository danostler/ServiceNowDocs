...
-   Install network discovery plugins. To learn more, see [Network discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/discovery/c_NetworkDiscovery.md).
...
4.  Under the **Details** tab, on the form, fill in the fields.
    ...
    To learn more, see [Managed Network form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/managed_network_form.md).
...
7.  Select **Save**.
    ...
    CMDB 360 data and packs related tabs appear on the form. To learn more, see [Related tabs in the network inventory forms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/inventory-related-tab.md).
