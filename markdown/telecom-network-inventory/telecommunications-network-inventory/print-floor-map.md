...
10. Select the paper size and orientation from the Print Layout panel.
    ...
    For more information about the options, see [Map printing options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/indoor-mapping/map-printing-options.md).
...
12. Configure the options in the Print Layout panel.
    ...
    For a description of the field values, see [Map printing options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/indoor-mapping/map-printing-options.md).
