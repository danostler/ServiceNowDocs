...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/override-tile-icon-with-custom-images.html
release: zurich
topic_type: task
...
**Parent Topic:**[Tile icon illustrations in Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/tile-icons-in-tb.md)
