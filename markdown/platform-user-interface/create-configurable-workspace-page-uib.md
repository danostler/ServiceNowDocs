...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/create-configurable-workspace-page-uib.html
release: zurich
topic_type: task
...
7.  Create the [variant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configurable-workspace-glossary.md) for your page by completing the following fields.
