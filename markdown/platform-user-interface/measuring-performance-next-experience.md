...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/measuring-performance-next-experience.html
release: zurich
topic_type: concept
...
-   **[View the server response time](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/view-server-response-time.md)**  
