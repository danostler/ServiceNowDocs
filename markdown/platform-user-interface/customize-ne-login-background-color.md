...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/customize-ne-login-background-color.html
release: zurich
topic_type: task
