...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/adoption-services/provide-customer-feedback.html
release: zurich
...
4.  When you have completed your feedback, select **Submit**.
    ...
    **Note:** If you do not want the **Provide Feedback** button to appear in the Help Center, you can [disable it](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/adoption-services/disable-feedbak.md).
