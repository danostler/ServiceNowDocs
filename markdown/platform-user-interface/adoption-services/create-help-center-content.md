...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/adoption-services/create-help-center-content.html
release: zurich
...
Create or edit an embedded help record before creating a guidance record by following the steps in [Add custom Embedded Help content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/adoption-services/add-custom-help-topic.md) to create content or [Add custom Embedded Help from a copy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/adoption-services/add-custom-help-copy.md) to modify existing content.
...
Part of the URL for the workspace page that you're targeting, in the format `now/<yourpagename>`.
 ...
 See the [examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/adoption-services/create-help-center-content.md) following these steps for more information on identifying the application route from the URL.
...
A value found in the URL of the workspace page you're targeting that immediately follows the Application Route. For example, in `now/sow/home`, the context is `home`.
 ...
 See the [examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/adoption-services/create-help-center-content.md) following these steps for more information on identifying the context from the URL.
...
An advanced configuration to display guidance only when users view specific lists or record types within your workspace.
 ...
 See the [examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/adoption-services/create-help-center-content.md) following these steps for more information on identifying route parameters from the URL.
