...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/drag-and-drop-recipients-in-to-cc-and-bcc-email-fields.html
release: australia
...
6.  To select multiple recipients, use keyboard and mouse device shortcuts.
    ...
    For reference, see [Keyboard and mouse device shortcuts for adding recipients to email fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/keyboard-and-mouse-shortcuts-for-adding-recipients-to-email.md).
