...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/customize-themeable-empty-state-images.html
release: australia
...
5.  Add your custom image in one of the following ways.
    ...
    -   Add your custom image to the Images \[db\_images\_list.do\] table.
        ...
        **Note:** Verify that your image is in SVG format.
        ...
        1.  For detailed instructions, see [Upload one or more images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/upload-multiple-images.md).
...
**Parent Topic:**[Working with theme-able empty state images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/themeable-empty-state-images.md)
