...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/configure-per-user-ui16-landing-page-in-next-experience.html
release: australia
