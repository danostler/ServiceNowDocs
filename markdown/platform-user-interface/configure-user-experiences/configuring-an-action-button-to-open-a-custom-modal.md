...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/configuring-an-action-button-to-open-a-custom-modal.html
release: australia
