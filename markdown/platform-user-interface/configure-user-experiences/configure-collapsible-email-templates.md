...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/configure-collapsible-email-templates.html
release: australia
...
2.  From the Email Client Templates list, select an email template or create a new one.
    ...
    For instructions on creating an email template, see [Configure an email template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/configure-email-templates.md).
