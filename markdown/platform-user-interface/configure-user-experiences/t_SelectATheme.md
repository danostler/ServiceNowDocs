...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/t\_SelectATheme.html
release: australia
...
Themes are user-specific. Each user can select a different theme and the selection is stored as a [user preference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/c_UserPreferences.md).
