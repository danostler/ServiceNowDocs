...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/empty-state-illustrations.html
release: australia
...
-   **[Configure the colors for empty state illustrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/customize-colors-empty-state.md)**  
...
-   **[Override empty state illustrations with custom images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/override-empty-state-illustrations.md)**  
