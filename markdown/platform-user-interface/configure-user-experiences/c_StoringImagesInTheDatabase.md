...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-user-experiences/c\_StoringImagesInTheDatabase.html
release: zurich
...
-   **[Update an existing image](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-user-experiences/t_UpdatingAnExistingImage.md)**  
You can change an existing image to an updated version.
-   **[Upload one or more images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-user-experiences/upload-multiple-images.md)**  
You can upload one image or multiple images at one time.
-   **[Restrict file extensions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-user-experiences/restrict-file-extensions.md)**  
