...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-user-experiences/tile-icons-in-tb.html
release: zurich
...
-   **[Configure colors for tile icon illustrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-user-experiences/configure-tile-icon-colors.md)**  
...
-   **[Override tile icon illustrations with custom images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-user-experiences/override-tile-icon-with-custom-images.md)**  
