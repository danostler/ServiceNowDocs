...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/live-list-updates-configurable-workspace.html
release: australia
