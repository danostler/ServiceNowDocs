...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/set-up-asychronous-record-addition-declarative-actions.html
release: australia
