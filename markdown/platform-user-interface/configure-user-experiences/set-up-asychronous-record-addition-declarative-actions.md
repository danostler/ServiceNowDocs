...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-user-experiences/set-up-asychronous-record-addition-declarative-actions.html
release: zurich
