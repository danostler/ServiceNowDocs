...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/compose-emails-in-the-activity-stream.html
release: australia
...
7.  Create the email body.
    ...
    You can insert an email template into the email body. For more information, see [Use email templates in the mini email composer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/compose-emails-with-email-templates.md).

    You can attach a file to the email. For more information, see [Add a file to an email from the mini email composer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/add-a-file-to-an-email-from-the-mini-email-composer.md).

8.  Select **Send**.

    Drafts save automatically after a set number of seconds. For more information on finding email drafts, see [Review email drafts from the mini email composer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/review-email-drafts-from-the-mini-email-composer.md).
