...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/disable-list-actions-based-on-dynamic-conditions.html
release: australia
