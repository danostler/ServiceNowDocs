...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-user-experiences/delete-custom-font.html
release: zurich
...
5.  Select **Delete**.
    ...
    \[Omitted image "tb-custom-font-delete-modal.png"\] Alt text: Custom font family preview modal with Delete button selected.
