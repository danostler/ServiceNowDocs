...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-user-experiences/expand-text-shown-in-fields-before-scrolling.html
release: zurich
