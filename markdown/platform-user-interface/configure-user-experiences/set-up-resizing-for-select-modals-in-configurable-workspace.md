...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/set-up-resizing-for-select-modals-in-configurable-workspace.html
release: australia
