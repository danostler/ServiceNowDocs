...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/next-experience-landing-pages.html
release: australia
...
By default, users on new Next Experience instances see the Next Experience landing page. Users on upgraded instances see the landing pages they had before in the Next Experience UI. You can also set a [Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/c_UI16.md) landing page for all users and configure user-specific landing pages.

**Note:** If you want to turn off the welcome splash screen after upgrading your instance, see [Turn off the Next Experience welcome screen after upgrading your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/remove-welcome-splash-screen.md).

-   **[Create a Next Experience landing page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/create-next-experience-landing-page.md)**  
...
-   **[Configure per-user landing pages in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/configure-per-user-ui16-landing-page-in-next-experience.md)**  
...
-   **[Configure a Core UI global landing page in Next Experience enabled instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/use-ui16-landing-page-in-next-experience.md)**  
...
-   **[Configure a Next Experience landing page footer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/configure-next-experience-landing-page-footer.md)**  
...
-   **[Next Experience default admin landing page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/next-experience-admin-landing-page.md)**  
