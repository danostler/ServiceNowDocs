...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-user-experiences/configure-da-action-layout.html
release: zurich
...
A form action layout combines multiple [form action layout items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-user-experiences/configurable-workspace-glossary.md) and [form action layout groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-user-experiences/configurable-workspace-glossary.md) into a single table-based layout that determines which actions appear on the form.
...
2.  Select or create a page that contains the Form component.
    ...
    For instructions on creating a workspace page in UI Builder, see [Create a Configurable Workspace page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-user-experiences/create-configurable-workspace-page-uib.md).
