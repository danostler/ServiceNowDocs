...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-map-markers.html
release: zurich
topic_type: task
...
Set up a [map data item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-data-items.md) before you accomplish this task.
...
Continue to the next task to [define map marker click actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-markers.md).
...
Continue to the next task to complete your [map marker setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-markers.md).
