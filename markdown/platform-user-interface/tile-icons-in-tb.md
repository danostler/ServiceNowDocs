...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/tile-icons-in-tb.html
release: zurich
topic_type: concept
...
-   **[Configure colors for tile icon illustrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-tile-icon-colors.md)**  
...
-   **[Override tile icon illustrations with custom images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/override-tile-icon-with-custom-images.md)**  
...
**Parent Topic:**[Working with Image styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/working-with-image-styles.md)
