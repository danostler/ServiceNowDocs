...
To enable checklists, navigate to the form and add the **Checklist** formatter. For instructions, see [Add a formatter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/c_FormDesign.md).
