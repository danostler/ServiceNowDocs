...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/config-da-limit-workspace-page.html
release: zurich
topic_type: task
