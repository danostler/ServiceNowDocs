...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/drag-and-drop-recipients-in-to-cc-and-bcc-email-fields.html
release: zurich
topic_type: task
...
6.  To select multiple recipients, use keyboard and mouse device shortcuts.
    ...
    For reference, see [Keyboard and mouse device shortcuts for adding recipients to email fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/keyboard-and-mouse-shortcuts-for-adding-recipients-to-email.md).
