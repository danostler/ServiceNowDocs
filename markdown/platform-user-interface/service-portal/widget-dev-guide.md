...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/service-portal/widget-dev-guide.html
release: zurich
...
-   **[General guidelines for developing widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/general-guidelines-developing-widgets.md)**  
...
-   **[Tutorial: Build a custom widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/adv-widget-tutorial.md)**  
...
-   **[Clone a widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/t_CloneAndEditAWidget.md)**  
Take advantage of existing code by cloning and editing an existing widget.
-   **[Create a new widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/create-new-widget.md)**  
Create a new widget to build a custom widget from scratch.
-   **[Widget option schema](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/c_WidgetInstanceOptions.md)**  
...
-   **[Widget API reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/widget-api-reference.md)**  
Service Portal includes client and server side APIs to use in widget client and server scripts.
-   **[Reuse components with Angular Providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/angular-providers.md)**  
...
-   **[Embedded widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/c_NestedWidgets.md)**  
Embed a widget in the HTML template, server script, or client script.
-   **[Create a widget dependency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/widget-dependencies.md)**  
...
-   **[Internationalize a widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/c_WidgetLocalization.md)**  
...
-   **[Replace a Service Catalog form script with a widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/ui-macro-widget.md)**  
