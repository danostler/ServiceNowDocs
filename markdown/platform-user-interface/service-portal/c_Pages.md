...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/service-portal/c\_Pages.html
release: zurich
...
-   **[Create and edit a page using the Service Portal Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/t_ConfigureAPage.md)**  
Create or edit a page and use layouts to organize the columns that house the widgets.
-   **[Standard ticket page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/standard-ticket-page.md)**  
...
-   **[Redirect a reference to a page ID](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/reroute-page.md)**  
...
-   **[Attaching files to records from portal pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/attaching-files-portal-pages.md)**  
