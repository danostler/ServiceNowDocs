...
3.  Show welcome text by set the property **glide.ui.polaris.login.show\_welcome** to **true**.
    ...
    If this property doesn't exist, add it as a true/false property. For more information, see [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md).
