...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/override-empty-state-illustrations.html
release: zurich
topic_type: task
...
**Parent Topic:**[Empty state illustrations in Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/empty-state-illustrations.md)
