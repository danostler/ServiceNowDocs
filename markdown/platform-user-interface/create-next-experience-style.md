...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/create-next-experience-style.html
release: zurich
topic_type: task
...
You upload new typefaces or images in a separate process. See [Add Next Experience font and image assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/add-image-asset.md).
...
6.  Add fonts, images, and other theme assets.
    ...
    For more information, see [Add Next Experience font and image assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/add-image-asset.md).
