...
-   **Application scope**: Enables application developers to view and select the application where their changes apply. For more information, see [Application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/building-applications/c_ApplicationScope.md).
...
-   **Update set**: Enables admin users to choose an update set for making and tracking customizations. For more information, see [Exploring System Update Sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/system-update-sets/exploring-system-update-sets.md).
