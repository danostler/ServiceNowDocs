...
3.  Select the **Primary** check box to indicate if this company is the primary company.
    ...
    If needed, [configure the form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/configure-form-layout.md) to add the **Primary** check box. Designate only one company in your system as the primary company.
