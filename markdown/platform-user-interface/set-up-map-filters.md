...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/set-up-map-filters.html
release: zurich
topic_type: task
...
A [map data item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-data-items.md) should be configured before accomplishing this task. The example map data item can work with the example map filter tables below to successfully set up a map filter.
...
Select the options in the table to successfully create your Map Page filter item. This setup works with the [map data item example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-data-items.md).
...
Continue to the next task to [configure a map filter data mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/set-up-map-filters.md).

**Parent Topic:**[Create an advanced Map Page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/create-advanced-map-page.md)
...
Select the options in the table to create your map filter data mapping. This setup works with the [map data item example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-data-items.md).
...
Continue to the next task to [select your map filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/set-up-map-filters.md), and complete the map filter setup.
...
You've set up your map filter. Continue to the [next task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/set-up-map-filters.md) to see that you have successfully created it.
