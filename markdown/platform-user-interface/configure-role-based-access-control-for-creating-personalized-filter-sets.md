...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-role-based-access-control-for-creating-personalized-filter-sets.html
release: zurich
topic_type: task
