...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-collapsible-email-templates.html
release: zurich
topic_type: task
...
2.  From the Email Client Templates list, select an email template or create a new one.
    ...
    For instructions on creating an email template, see [Configure an email template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-email-templates.md).
