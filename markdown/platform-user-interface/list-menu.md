...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/list-menu.html
release: zurich
topic_type: concept
...
Any lists that you create appear in this section. Lists in this section are only visible to you. For more information about creating your own list categories and list filters, see [Create My Lists in workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/create-filtered-list-agent-workspace.md).

## Next

Learn how to [work with lists in list view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/work-with-lists.md).
