...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-map-data-items.html
release: zurich
topic_type: task
...
Select the options in the table to successfully create a map data item. Use this configuration with the examples in [Add a map filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/set-up-map-filters.md) and [Configure a map filter data mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/set-up-map-filters.md) to successfully create a map filter.
...
Create [map markers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-markers.md) for your map.
