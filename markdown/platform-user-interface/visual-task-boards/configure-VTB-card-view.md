...
3.  Under the Form view and section, select the VTB view.
    ...
    You may need to create a VTB view for the form. For more information, see [Create and delete views](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/create-delete-view.md).
