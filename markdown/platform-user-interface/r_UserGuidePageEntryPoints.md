...
Help pages generated with the user guide can be displayed to end users from configurable entry points in the system, including application modules and [UI actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/c_UIActions.md). To create these entry points, you must express a target URL using these parameters:
