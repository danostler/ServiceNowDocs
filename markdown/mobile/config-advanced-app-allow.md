...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/config-advanced-app-allow.html
release: zurich
topic_type: task
...
3.  In the **Example** field, configure the two following properties:
    ...
    For an example of a completed script, see [Advanced app allowance example script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/adv-app-allow-sample-script.md).
