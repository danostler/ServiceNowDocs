...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/add-push-notifications-mobile-apps.html
release: zurich
topic_type: task
...
This task describes how to reuse a push notification from one mobile app to another using MAB. For more information about MAB, see [Mobile App Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mab-concept.md).

To create a push notification from scratch, see [Mobile push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-push-notifications.md).
