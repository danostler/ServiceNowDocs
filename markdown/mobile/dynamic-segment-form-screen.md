...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/dynamic-segment-form-screen.html
release: zurich
topic_type: concept
...
A record screen that contains a dynamic segment is comprised of the following components. For configuration details, see [Configure a dynamic segment to display selected data in a record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/form-screen-dynamic-segment.md)

-   Record screen header - An item view that displays a summary of records within a record screen. For more information, see [Record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/form-screen.md).
...
-   Header segment - Optional component that displays the whole list of records. For more information, see [Embedded lists for a record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-embedded-list.md).
-   Segmented control - Area that includes both the dynamic segment and the header segment.
-   Embedded list screen - Display area as defined by the user's selection in the segmented control. For more information, see [Embedded lists for a record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-embedded-list.md).
-   Footer function - A function instance or function location that appears at the bottom of a record screen. For more information, see [Associate a function with a location in the app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-button-instances.md).
