...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-mobile-attachments.html
release: zurich
topic_type: concept
...
For details on the record screen configuration, see [Configure a record screen for use with a list screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-configure-form-applet.md).
