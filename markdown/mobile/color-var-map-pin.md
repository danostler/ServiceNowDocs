...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/color-var-map-pin.html
release: zurich
...
Map screens have a **Pin Color** section with a **Pin color variable** field to control the color map pins using a color variable. A map pin is used on the map template screen, to indicate points of interest on the map.
 ...
 For details on creating icon UI sections, see [Configure an icon UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-ui-section-config-navig.md).
