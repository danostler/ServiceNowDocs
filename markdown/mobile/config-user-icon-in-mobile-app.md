...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/config-user-icon-in-mobile-app.html
release: zurich
topic_type: task
 ...
 **Note:** Use a navigation function to navigate to a user profile record screen when you use a user type icon. For more information, see [Navigation functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-nav-functions.md).
