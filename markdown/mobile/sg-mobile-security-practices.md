...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-mobile-security-practices.html
release: zurich
topic_type: concept
...
-   **[Security controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-security-controls.md)**  
Configure security controls to restrict copy/paste, enforce PIN, or block attachment functionality.
-   **[Security patching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-security-patching.md)**  
...
-   **[User data collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-security-user-data.md)**  
ServiceNow mobile apps do not specifically collect any user data.
-   **[Shared data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-security-shared-data.md)**  
ServiceNow mobile apps communicate with a third party software for app crash reporting. No customer information is shared.
-   **[Incident reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-security-incidents.md)**  
