...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/request-public-branded-ios-app.html
release: zurich
topic_type: task
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded iOS app for public distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/testpubnu-iosapp-pubdist.md).
