...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/register-assoc-records-offline-cache.html
release: zurich
topic_type: task
