...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/empty-state-search-results.html
release: zurich
topic_type: task
...
For more information, see [Configure an empty state](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/empty-state-default.md).
