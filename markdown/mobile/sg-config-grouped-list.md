...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-config-grouped-list.html
release: zurich
topic_type: task
...
The function used within this function instance.
    ...
    For more information on mobile functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-mobile-button-types.md).
