...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/configure-form-browser-screen.html
release: zurich
topic_type: task
...
8.  Complete the mobile web screen form by using the instructions in [Configure a mobile web screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-configure-url-screen.md).
