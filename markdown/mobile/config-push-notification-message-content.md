...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/config-push-notification-message-content.html
release: zurich
topic_type: task
...
To configure push notification message content, you must generate a deep link using the mobile deep link generator. For more information, see [Deep linking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/deep-link-mobile.md).
...
Mobile UI styles are also available for additional fields. For more information around styling, see [Mobile UI styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-ui-styles.md).
