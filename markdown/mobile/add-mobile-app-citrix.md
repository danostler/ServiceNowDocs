...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/add-mobile-app-citrix.html
release: zurich
topic_type: task
...
7.  For each of the platforms, complete the following steps.
    ...
    If Android for Work cannot find the ServiceNow application, the app might not be approved for your organization. You can [approve the app in the Google Play store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/approve-app-google.md).
...
**Parent Topic:**[Citrix XenMobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/citrix-mdm.md)
