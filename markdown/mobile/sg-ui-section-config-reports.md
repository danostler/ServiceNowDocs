...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-ui-section-config-reports.html
release: zurich
topic_type: task
...
For an analytics UI section to display data visualizations you need both a mobile analytics preview and a chart screen with navigation functions. For more information, see [Create a mobile analytics preview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-dashboard-preview.md) and [Chart screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/chart-screen.md). A maximum of six analytics previews can be displayed in an analytics UI section.
...
After creating an analytics UI section, you must add the UI sections to a launcher screen so they're displayed. For more information, see [Add a UI section to the launcher screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/ui-section-to-launcher-screen.md).
