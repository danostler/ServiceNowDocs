...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/param-screen-config-inputs.html
release: zurich
topic_type: task
...
The autofill variable used for this input. For details on variables, [Configure attributes for input form screen variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/param-screen-config-variables.md).
