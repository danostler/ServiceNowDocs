...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/data-source-script-examples.html
release: zurich
...
**Note:** All the scripts listed in this topic are configured within the data source record. For more information, see [Configure data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/data-sources-config.md).
