...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/create-embedded-list-1.html
release: zurich
topic_type: task
...
5.  In the **Embedded screen** section, click **Choose** to select a screen to embed.\[Omitted image "embedded-screen-section.png"\] Alt text: Embedded screen section
    ...
    **Note:** You can also click the **New** button create a new screen. For details on creating screens, see [Create a screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-configure-applet-screens.md).
...
To learn more about relationship data items used for embedded lists, see [Configure a relationship data item for an embedded list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-data-item-relationship.md).
