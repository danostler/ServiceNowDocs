...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/config-font-icon-to-use-color-theme-var.html
release: australia
...
Enter the name listed for the icon in the font family. For example, if you wanted to use the shopping cart icon in the **now-mobile-icons** family, you would enter `Cart`.
 ...
 For lists of font family icons names, see the [Mobile icon reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-icon-reference.md).
