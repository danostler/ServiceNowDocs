...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-av-context-action.html
release: zurich
...
-   Delete
-   Script
-   MultiStep. For more information, see [Configure action steps within an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/configure-action-steps.md).
...
Select an input form screen to use for this action item. See [Configure an input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/parameter-screen-config.md).
...
Allows an action item to perform multiple processes.
 ...
 For more information, see [Configure action steps within an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/configure-action-steps.md).

</td></tr></tbody>
</table>6.  Select **Save**.


-   **[Create UI parameters for your Virtual Agent link](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-av-context-2.md)**  
...
-   **[Enable Virtual Agent for mobile applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-mobile-virtual-agent.md)**  
