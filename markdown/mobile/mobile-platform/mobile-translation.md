...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/mobile-translation.html
release: australia
...
The element on the table to be translated. Refer to [Translation values for mobile element](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-translation-reference.md) for the element names of each translatable element.
...
**Parent Topic:**[Server-side localization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/localization-server-side.md)
