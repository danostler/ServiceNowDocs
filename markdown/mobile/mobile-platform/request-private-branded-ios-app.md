...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/request-private-branded-ios-app.html
release: australia
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded iOS app for private distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/testpubnu-iosapp-privdist.md).
