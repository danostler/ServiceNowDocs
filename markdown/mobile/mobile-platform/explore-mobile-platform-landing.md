...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/explore-mobile-platform-landing.html
release: australia
...
[Now Mobile\[Omitted image "bus-mobile-phone.svg"\] Alt text: Use the Now Mobile app so employees can manage their tasks, records, incidents, and access company resources.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/now-mobile-app.md)

</td><td>

[Mobile Agent \[Omitted image "bus-work-order.svg"\] Alt text: Use the Mobile Agent app to support agents and help them work from anywhere with purpose-built mobile workflows.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-experience.md)
