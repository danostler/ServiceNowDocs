...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/configure-slider.html
release: zurich
...
You can add additional number input attributes to the ones listed. For a complete list, check the Number inputs section in [Input form screen attributes for inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/parameter-screen-var-attr.md).

To view how different types of sliders display, see [Slider types and their input attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/slider-input-attributes.md).
...
15. Add any additional input parameters that are applicable to the slider you want to create.
    ...
    For a list of the slider types, see [Slider types and their input attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/slider-input-attributes.md).

    **Note:** If you select the Decoration input attribute, which displays sections on the slider with corresponding labels, you must apply additional configuration. For more information, see [Configure a decorative slider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/decorative-slider.md).
