...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/sg-ui-section-config-navig.html
release: australia
...
To personalize your icon sections, see [Adding images to an icon section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/add-image-icon-section.md).
