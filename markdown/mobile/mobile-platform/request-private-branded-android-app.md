...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/request-private-branded-android-app.html
release: australia
 ...
 **Note:** Deep links can only be edited when you submit a new branded app request or when you update a branded app.
 ...
 To learn more about deep links, see [Deep linking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/deep-link-mobile.md).
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded Android app for private distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/testpubnu-andapp-privdist.md).
