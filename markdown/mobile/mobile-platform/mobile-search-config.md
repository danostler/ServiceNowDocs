...
-   **Zing** - The default search engine used to search ServiceNow AI Platform® record data. For more information, see [Zing text indexing and search engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/search-administration/c_ZingTextSearch.md).
...
-   For AI Search search engine, see the Now Mobile documentation [AI Search in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/now-mobile-employee-experience/text-search-advanced-now.md).
