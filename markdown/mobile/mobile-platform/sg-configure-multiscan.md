...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-configure-multiscan.html
release: zurich
...
-   **[Create UI parameters for your grouped input](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-configure-multiscan-2.md)**  
Create UI parameters to contain the values that your users scan in with your grouped input.
-   **[Configure your action item to use your grouped input UI parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-configure-multiscan-3.md)**  
Configure the action item on your button so that you can use the values that your users scan in.

**Parent Topic:**[Mobile barcode scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-mobile-scanning.md)
