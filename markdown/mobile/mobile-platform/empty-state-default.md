...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/empty-state-default.html
release: australia
...
-   Defined button actions from the Function \[sys\_sg\_button\] table. For more information, see [Configure a smart button](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-studio-config-smart-button.md).
...
-   [Configure an empty state for a list screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/empty-state-list-screen.md).
-   [Configure an empty state for an embedded list in a record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/empty-state-form-applet-embedded-list.md).
-   [Configure an empty state for search results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/empty-state-search-results.md).
