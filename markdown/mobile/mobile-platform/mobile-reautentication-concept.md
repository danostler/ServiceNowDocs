...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/mobile-reautentication-concept.html
release: zurich
...
To activate the re-authentication option, select `Re-authentication` in the **Preconditions** field within the Action functions table. See, [Configure an action function](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-studio-config-action-function.md).

-   **[Configure mobile re-authentication login method](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-reauthentication-login-method.md)**  
...
-   **[Configure mobile re-authentication SSO login](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-reauthentication-login-sso.md)**  
...
-   **[Configure mobile re-authentication logout option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-reauthentication-logout.md)**  
Configure this parameter to force your users to log out each time before they re-authenticate.
-   **[Configure mobile re-authentication for single or multiple use](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-reauthentication-usage-token.md)**  
...
-   **[Configure mobile re-authentication login timespan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-reauthentication-token-lifespan.md)**  
