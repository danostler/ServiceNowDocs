...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/launcher-screen-template.html
release: zurich
...
<table id="choicetable_e2v_z3s_s1c"><thead><tr><th align="left" id="d71981e92">

Method

</th><th align="left" id="d71981e95">

Procedure

</th></tr></thead><tbody><tr><td id="d71981e101">
...
Determine if this launcher section contains a header section. For more information, see [Configure a launcher screen header](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/create-alp-header.md).
...
Determine if this launcher section contains a search area. For more information, see [Global search for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-search-config.md).
...
Determine what UI sections are contained in this launcher screen. For more information, see [Launcher screen UI sections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/alp-ui-sections.md).
...
Determine if this launcher section contains any quick action functions. For more information, see [Quick actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-config-quick-actions.md).
...
Determine which user criteria can access this launcher screen. If you have not selected any user criteria, all user have access to the launcher screen.**Note:** This field is available when User criteria is selected in the **Access control type** field.
    ...
    You can add any of the following sections to a launcher screen, as detailed in these links: [Configure a launcher screen header](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/create-alp-header.md), [Global search for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-search-config.md), [Launcher screen UI sections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/alp-ui-sections.md), and [Quick actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-config-quick-actions.md).
