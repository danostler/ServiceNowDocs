...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/localization-server-side.html
release: zurich
...
You can customize translations that use server-side localization the same way you do on the desktop. Translate these elements using the translated name/field table on your instance. For more details on this table, see Translated Name / Field table
...
-   **[Create translation records for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-translation.md)**  
...
-   **[Translation values for mobile element](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-translation-reference.md)**  
Use this reference to find which values to use to translate your mobile elements.

**Parent Topic:**[Localization on mobile devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/localization-mobile-device.md)
