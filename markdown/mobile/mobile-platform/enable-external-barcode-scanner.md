...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/enable-external-barcode-scanner.html
release: australia
...
For more information, see [Mobile barcode scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-scanning.md).
