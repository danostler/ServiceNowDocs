...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-config-grouped-list.html
release: zurich
...
The function used within this function instance.
    ...
    For more information on mobile functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-studio-mobile-button-types.md).
