...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/create-mobile-ui-rule-action.html
release: australia
...
```
 ...
 You can also use color variables to change theming in your mobile UI rules. For details see [Color variable support for UI rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/color-var-ui-rule.md).

 **Note:**

-   `IconCode` must be replaced with a valid icon code. For a list of icon codes, see [Mobile icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-icon.md)
