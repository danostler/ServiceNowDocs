...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/config-chart-nav.html
release: zurich
...
8.  From the Destination screen field, select the chart screen you created in the topic [Create a chart screen for a data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/config-single-score-applet.md).
...
After you create a navigation link to the chart screen, you must associate this navigation function to the analytics preview. For details on this process, see [Add a navigation function to an analytics preview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/config-chart-nav-2.md).

-   **[Add a navigation function to an analytics preview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/config-chart-nav-2.md)**  
