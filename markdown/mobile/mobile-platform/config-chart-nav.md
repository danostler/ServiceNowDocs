...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/config-chart-nav.html
release: australia
...
8.  From the Destination screen field, select the chart screen you created in the topic [Create a chart screen for a data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/config-single-score-applet.md).
