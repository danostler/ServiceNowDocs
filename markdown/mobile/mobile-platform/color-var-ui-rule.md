...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/color-var-ui-rule.html
release: australia
...
-   `FontColorVariable` outside or within the `TextDecorator`
 ...
 For details on creating these UI rule actions, see [Create a mobile UI rule action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/create-mobile-ui-rule-action.md).
