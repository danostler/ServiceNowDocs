...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/config-font-type-icons.html
release: australia
...
Enter the code that identifies the icon in the font family you want to use. For example, `e903` is the code for the solid cart icon in the **now-mobile-icons-buttons** font family.
 ...
 For lists of font family icon codes, see the topic for the type of icon you want to use in the [Mobile icon reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-icon-reference.md).
...
Enter the name listed for the icon in the font family. For example, if you wanted to use the shopping cart icon in the **now-mobile-icons** font family, you should enter `Cart`.
 ...
 For lists of font family icon names, see the [Mobile icon reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-icon-reference.md).
