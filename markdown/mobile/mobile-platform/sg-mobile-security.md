...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/sg-mobile-security.html
release: australia
...
-   **[Components and architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-security-components-architecture.md)**  
...
-   **[Identity and access management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-ID-access-mgmt.md)**  
Learn about user authentication, third party authentication, and user session termination for mobile applications.
-   **[Mobile data flow for ServiceNow mobile apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-security-mobile-data-flow.md)**  
Data can be retrieved, downloaded from, and written back to a mobile device.
-   **[Internal mobile app distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-security-app-distro.md)**  
Internal distribution of ServiceNow mobile apps is supported through all major EMM vendors.
-   **[Data security for ServiceNow mobile apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-security-data.md)**  
...
-   **[Push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-security-push-notif.md)**  
Administrators create push notifications and users are able to receive them.
-   **[Mobile security practices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-security-practices.md)**  
...
-   **[Edge Encryption for ServiceNow mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-edge-encryption.md)**  
