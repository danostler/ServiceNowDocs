...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/input-actions-configure.html
release: zurich
...
**Note:** An *ElementIdentifier* attribute is also required. For more information, see [Data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/data-sources.md).
...
**Note:** A *DataSourceID* attribute is also required. For more information, see [Data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/data-sources.md).
...
<table id="choicetable_p4n_gxy_42c"><thead><tr><th align="left" id="d43926e487">

Input action type

</th><th align="left" id="d43926e490">

Procedure

</th></tr></thead><tbody><tr><td id="d43926e496">
...
6.  Select a preconfigured navigation type in the **Value** field. For more information on creating navigation buttons, see [Navigation functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-nav-functions.md).
