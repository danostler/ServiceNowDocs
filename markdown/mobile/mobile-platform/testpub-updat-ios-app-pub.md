...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/testpub-updat-ios-app-pub.html
release: australia
...
3.  Set up your branded iOS app for public distribution:
    ...
    -   Set up push notifications by downloading the Apple push certificate \(`p12` file\) and uploading it to your app's push application record:
        ...
        -   Configure your push applications. For instructions, see [Configure push applications for iOS branded apps using certificate based authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-push-setup-ios.md).
