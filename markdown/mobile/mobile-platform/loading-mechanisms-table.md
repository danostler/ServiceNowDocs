...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/loading-mechanisms-table.html
release: australia
...
-   For inputs, see [Input form screen attributes for inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/parameter-screen-var-attr.md).
-   For input actions, see [Configure input form actions in an input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/input-actions-configure.md).
-   For descriptive elements, see [Configure descriptive elements for input form screens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/descriptive-elements-script.md).
...
For configuration of mobile cards, see [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-card-builder.md).
