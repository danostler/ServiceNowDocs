...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/color-var-cardview-button.html
release: australia
...
-   **TextColorVariable**
 ...
 For more information on these attributes, see [Card template element attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mca-attributes.md).
