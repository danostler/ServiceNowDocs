...
For more information on configuring authentication for mobile devices, see [Set up OAuth](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/authentication/t_SettingUpOAuth.md).
