...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/mobile-authentication.html
release: australia
...
**Important:** ServiceNow mobile apps support platform authentication using OAuth 2.0. Authentication mechanisms include multi provider SSO, MFA, LDAP, Local DB, and Digest. For more information, see [Mobile security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-security-landing.md) and [Identity and access management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-ID-access-mgmt.md).

Follow the instructions for using a third-party OAuth provider.

-   **[Create a QR code for mobile login](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/create-qr-login.md)**  
Create and use a QR code containing JSON to provide a method for your users to log in with pre-defined parameters.
-   **[Configure mobile app token lifespan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/configure-mobile-app-timeout.md)**  
Configure the length of time it takes for the app to time out.
-   **[Force local login in mobile apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-force-local-login.md)**  
...
-   **[Mobile access to IP-restricted networks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mob-access-ip-restrictd-netwrks.md)**  
...
-   **[Configure mobile apps to use specific identity providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/config-mobapps2-use-specific-idps.md)**  
...
-   **[Configure an external authentication browser for ServiceNow mobile apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/config-ext-auth-browser-ios.md)**  
...
-   **[Securing your ServiceNow mobile instance with Zero Trust Access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/zero-trust-access-for-mobile.md)**  
