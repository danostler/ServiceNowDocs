...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/mobile-alerts-using.html
release: zurich
...
For information about configuring mobile alerts for a record screen, see [Configure a mobile alert for a record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/form-screen-alerts.md). You must be a member of the admin role to perform this configuration.
