...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/configure-form-browser-screen.html
release: australia
...
8.  Complete the mobile web screen form by using the instructions in [Configure a mobile web screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-configure-url-screen.md).
