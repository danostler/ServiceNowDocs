...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/config-mobile-list-filter.html
release: australia
...
For information about configuring map screens, see [Configure a map screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-configure-map-screen.md).
...
-   Display Type attributes, which determine how the data that is returned by the Operator attribute gets displayed in your mobile app.
 Select one of the Condition types from the drop-down list. See [Filter condition attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/filter-condition-attributes.md) where the default Operator and Display Type attributes are listed for each Condition type. The default values are marked with an asterisk \(\*\).
