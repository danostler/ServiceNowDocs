...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/config-advanced-app-allow.html
release: australia
...
3.  In the **Example** field, configure the two following properties:
    ...
    For an example of a completed script, see [Advanced app allowance example script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/adv-app-allow-sample-script.md).
