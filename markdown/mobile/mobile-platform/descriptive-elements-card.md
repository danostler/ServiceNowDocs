...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/descriptive-elements-card.html
release: australia
...
To use a mobile card within a descriptive element, a mobile card must be configured. For more information, see [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-card-builder.md).
