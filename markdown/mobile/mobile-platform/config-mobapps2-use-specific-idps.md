...
3.  In the **Login URL** field of the Application Registries page, enter the login URL you want to use for this mobile app.
    ...
    **Important:**
    ...
    For information about configuring an external IdP on your instance, see [Create an external identity provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/authentication/t_CreateUpdateIdentityProvider.md).
