...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/config-offline-properties-action-funct.html
release: zurich
...
-   **[Display and hide buttons in offline mode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/buttons-offline.md)**  
Define whether to show or hide buttons while users are in offline mode on their Mobile Agent app.
-   **[Trigger offline cache download](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/trigger-offline-cache-download.md)**  
