...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/sg-mobile-push-notifications.html
release: australia
...
Select **Mobile notifications** in the menu and then select the push notification you want to use. For more information about Mobile App Builder, see [Mobile App Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mab-concept.md).

-   **[Mobile push notification components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/configure-mobile-push-notifications.md)**  
Configure mobile push notifications to target a specific screen in one of the ServiceNow Mobile Platform applications.
-   **[Reuse push notifications across mobile apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/add-push-notifications-mobile-apps.md)**  
...
-   **[Configure push applications for iOS branded apps using certificate based authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-push-setup-ios.md)**  
Install an iOS push certificate to use push notifications on your branded ServiceNow mobile apps for iOS.
-   **[Configure push applications for iOS branded apps using a token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/config-push-ios-token.md)**  
Use push notifications on your branded ServiceNow mobile apps for iOS using token-based authentication.
-   **[Configure push applications for Android branded apps using HTTP v1](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/config-push-setup-android-httpv1.md)**  
...
-   **[Configure actionable push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/actionable-push-notification.md)**  
Include actions with your push notifications. Users can perform push notification actions without opening the app.
-   **[Configure notifications for mobile activity stream mentions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/notification-activity-stream.md)**  
...
-   **[Mobile critical alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-critical-alerts-create.md)**  
