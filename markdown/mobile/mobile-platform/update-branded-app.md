...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/update-branded-app.html
release: australia
...
To learn more about deep links and universal links, see [Mobile URLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-urls.md).
...
-   **[Test and publish an updated Android app for private distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/testpub-updat-and-app-priv.md)**  
...
-   **[Test and publish an updated iOS app for private distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/testpub-updat-ios-app-priv.md)**  
AFter you have requested an updated iOS app for private distribution, perform these steps to test and publish it.
-   **[Test and publish an updated Android app for public distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/testpub-updat-and-app-pub.md)**  
After you have requested an updated Android app for public distribution, perform these steps to test and publish it.
-   **[Test and publish an updated iOS app for public distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/testpub-updat-ios-app-pub.md)**  
