...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/sg-create-related-list-2.html
release: australia
...
11. In the **Data item** section, click **Choose**, and select the parametrized data item you created in [Create a parametrized data item for your related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-create-related-list.md).
