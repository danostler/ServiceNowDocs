...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-create-related-list-3.html
release: zurich
...
Choose an icon for the related list.
    ...
    In the next steps, you map a connection between this related list and the list screen that you created in the steps under [Create a list screen to use as a related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-create-related-list-2.md).
