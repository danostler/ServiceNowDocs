...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/empty-state-list-screen.html
release: australia
...
You should already have an empty state configured for list screens that do not contain any data. For more information, see [Configure an empty state](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/empty-state-default.md).
