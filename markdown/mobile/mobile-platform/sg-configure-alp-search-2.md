...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-configure-alp-search-2.html
release: zurich
...
Enable voice search so that your users can search using native speech recognition. For more details, see [Turn on voice search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/turn-on-voice-search.md)
