...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-mobile-add-screen-field.html
release: zurich
...
Type of screen field. For a list of types and a description of how they're used, see [Screen fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-screen-field-enhancements.md).**Note:**
