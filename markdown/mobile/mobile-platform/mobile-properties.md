...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/mobile-properties.html
release: australia
...
-   **[Turn on or turn off automatic app refresh](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/enable-disable-auto-app-refresh.md)**  
...
-   **[Enable external users to access attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/enable-ext-users-attach-access.md)**  
...
-   **[Switch the date/time fields between device time zone and UTC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/switch-date-time-timezone-utc.md)**  
...
-   **[Configure mobile apps to use the date/time format of mobile devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/config-apps2use-devicedatetimeform.md)**  
...
-   **[Hide seconds in date/time fields on mobile cards, record screen details pages, or activity streams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/hide-secs-mobcds-recscreen-actstrem.md)**  
...
-   **[Extend embedded web sessions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/extend-embedded-web-sessions.md)**  
Extend embedded web sessions to keep mobile users logged in until the mobile OAuth token expires.
-   **[Enable enhanced barcode scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/enable-enhanced-barcode-scan.md)**  
...
-   **[Enable barcode scanning with an external scanner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/enable-external-barcode-scanner.md)**  
...
-   **[Configure different mobile attachment capabilities on Android devices based on user roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mob-attachments-android.md)**  
...
-   **[Keep native apps active during authentication on Android devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/active-authentication-android.md)**  
...
-   **[Turn off the Zero Trust Access banner on mobile apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/turn-off-zta-banner.md)**  
Learn how to turn off the banner on mobile app screens where Zero Trust Access \(ZTA\) is enabled.
-   **[PIN timeout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/pin-timeout.md)**  
...
-   **[Asynchronous attachment uploads](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/asynchronous-attachment-uploads.md)**  
