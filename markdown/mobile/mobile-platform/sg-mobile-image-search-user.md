...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-mobile-image-search-user.html
release: zurich
...
**Note:** For details on how an administrator can configure photo search, see [Mobile photo search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-mobile-image-search.md).
