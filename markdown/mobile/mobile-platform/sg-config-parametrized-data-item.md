...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-config-parametrized-data-item.html
release: zurich
...
5.  Complete the Properties and Data sections as needed.
    ...
    For more information about creating a data item, see [Configure a standard data item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-studio-create-data-item.md). For example, create a data item for open incidents.
