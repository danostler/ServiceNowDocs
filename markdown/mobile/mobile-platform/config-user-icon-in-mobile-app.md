...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/config-user-icon-in-mobile-app.html
release: australia
 ...
 **Note:** Use a navigation function to navigate to a user profile record screen when you use a user type icon. For more information, see [Navigation functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-nav-functions.md).
