...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/mob-attachments-android.html
release: australia
...
1.  Set the system property **glide.sg.block\_mobile\_attachments\_external\_viewing** to `true`.
    ...
    For more information, see [Control whether users can view attachments in external applications on Android devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/vu-attach-extapp-android.md).

2.  Set the system property **glide.sg.block\_mobile\_attachments\_sharing** to `true`.

    For more information, see [Block users from downloading or sharing attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/block-users-download-shar-attach.md).
