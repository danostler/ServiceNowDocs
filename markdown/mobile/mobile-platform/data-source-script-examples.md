...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/data-source-script-examples.html
release: australia
...
**Note:** All the scripts listed in this topic are configured within the data source record. For more information, see [Configure data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/data-sources-config.md).
