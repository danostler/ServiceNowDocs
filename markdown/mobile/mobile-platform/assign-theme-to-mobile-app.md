...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/assign-theme-to-mobile-app.html
release: zurich
...
5.  Scroll down to locate the Client Theme section, select **Choose**, and then select the desired mobile app theme record.
    ...
    For information about creating a mobile theme, see [Create a theme for your mobile applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-configure-theme.md).
