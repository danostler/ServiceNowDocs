...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/using-now-assist-mobile.html
release: australia
...
-   **[Generate work order resolution notes on mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/generate-work-order-res-notes.md)**  
Generate resolution notes in your Mobile app that summarize your work order task record.
-   **[Using standard chat on mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/using-standard-chat-mobile.md)**  
...
-   **[Using enhanced chat on mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/using-enhanced-chat-mobile.md)**  
...
-   **[Using premium chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/using-premium-chat.md)**  
...
-   **[Using Now Assist web search on mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/using-na-web-search-mobile.md)**  
...
-   **[Generate a record summary on mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/generate-a-record-summary-on-mobile.md)**  
Generate a summary of a record in your Now mobile app using Now Assist.
-   **[Using the prominent action button](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/using-prominent-action-button.md)**  
Use the prominent action button to quickly access your Now Assist agent chat no matter where you're in the app.
-   **[Using Voice Input for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/na-using-voice-to-text.md)**  
...
-   **[Using People Genius results on mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/using-people-genius-results.md)**  
Search for people in your organization and view their profiles by entering their name into your search bar.
-   **[Using Mobile AI Voice Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/using-mobile-ai-voice-agent.md)**  
