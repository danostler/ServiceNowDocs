...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/add-android-airwatch.html
release: australia
...
5.  In the Source field, select **Search App Store** then search for **ServiceNow**.
    ...
    If the search cannot find the ServiceNow application, the app might not be approved for your organization. You can [approve the app in the Google Play store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/approve-app-google.md).
