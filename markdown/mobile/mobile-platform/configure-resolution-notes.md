...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/configure-resolution-notes.html
release: australia
...
4.  [Create a parameter action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/param-screen-config-actions.md).

5.  [Create a mobile UI rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/create-mobile-ui-rule.md) with the **onUserAction** trigger type.
...
6.  [Create a mobile UI rule action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/create-mobile-ui-rule-action.md) with the **Record Summarization** operation type.

7.  Add a delete action using the **ShowDeleteAll** input attribute.

    For more information, see [Input form screen attributes for inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/parameter-screen-var-attr.md).
