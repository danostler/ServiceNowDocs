...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/nav-chart-to-list-2.html
release: zurich
...
Assign your navigation function to your chart screen. For more information, see [Assign the navigation function to the chart screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/nav-chart-to-list-3.md).

**Parent Topic:**[Configure a navigation from a chart to a list screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/nav-chart-to-list.md)
