...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/form-screen-dynamic-segment.html
release: zurich
...
-   A record screen, used to include a dynamic screen segment within the segmented control. For more information, see [Configure a parameterized record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/configure-param-form-applet.md).
...
-   A corresponding list to be displayed when each screen segment is selected. This process should resemble the embedded list procedure, with the addition of using a target table to which you are referencing.
    ...
    For more information about embedded lists and the list to be displayed when a screen segment is selected, see [Embedded lists for a record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-embedded-list.md)
...
4.  In the Segmented Control area, select the height and width of the segment buttons.
    ...
    For a guide to the button sizes, see [Using dynamic segments to display data in a record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/dynamic-segment-form-screen.md).
...
Define the appearance of selected segment buttons. See, [Customize segment button colors in the segmented control area](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/dynamic-segmented-control-config.md).
