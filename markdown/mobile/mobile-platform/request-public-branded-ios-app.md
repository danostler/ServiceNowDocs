...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/request-public-branded-ios-app.html
release: zurich
...
To learn more about mobile deep links and universal links, see [Mobile URLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-urls.md).
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded iOS app for public distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/testpubnu-iosapp-pubdist.md).
