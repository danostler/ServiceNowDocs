...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/configure-signature-inputs.html
release: zurich
...
Signature inputs support both declarative and scripted writeback actions in action items. For information about action items, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-studio-create-action-item.md).
