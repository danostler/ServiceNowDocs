...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/param-screen-config-actions.html
release: australia
...
You must create an input form screen before you can create actions. For information about creating an input form screen, see [Configure an input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/parameter-screen-config.md).
...
Associate the **UserActionID** for this action to a UI rule. For more information, see [Create a mobile UI rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/create-mobile-ui-rule.md).
