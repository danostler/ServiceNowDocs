...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/now-assist-context-menu-mobile.html
release: australia
...
Write with Now Assist is supported on mobile input form screens for Now Assist skills such as task summarization. For more, see [Mobile resolution notes generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/ai-case-summarization.md).
