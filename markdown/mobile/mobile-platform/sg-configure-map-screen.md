...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-configure-map-screen.html
release: zurich
...
You can indicate to users, with the aid of a visual display, that the map does not contain any points of interest. For more information, see [Empty state display](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/empty-state-handling.md).
...
9.  Choose an existing data item or create a new data item. To create a new data item, see [Data items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-data-item.md).
...
You can add your map screen within a record section and an icon section. When a user taps on the relevant icon, they are navigated to the configured map screen. For more information, see [Configure a record UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-ui-section-config-item.md) and [Configure an icon UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-ui-section-config-navig.md).
