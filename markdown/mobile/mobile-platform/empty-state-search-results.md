...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/empty-state-search-results.html
release: australia
...
For more information, see [Configure an empty state](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/empty-state-default.md).
