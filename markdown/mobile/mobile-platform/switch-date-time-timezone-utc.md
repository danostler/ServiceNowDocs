...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/switch-date-time-timezone-utc.html
release: australia
...
Both [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-card-builder.md) and the following mobile screens support the **ShowDateTimeInUTC** property:

-   [Input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/parameter-input-screen.md)
-   [Record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/form-screen.md)
