...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/sg-studio-config-smart-button.html
release: australia
...
-   **used\_for\_deeplink**: When set to `true`, this button attribute specifies that the button is used for deep linking. For more information, see [Deep linking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/deep-link-mobile.md).
