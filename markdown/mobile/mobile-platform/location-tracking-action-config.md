...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/location-tracking-action-config.html
release: zurich
...
You must have a preconfigured action item before you can configure the action-based tracking option. For more information, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-studio-create-action-item.md).

You need preconfigured action functions for users to tap within their mobile device. For more information, see [Configure an action function](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-studio-config-action-function.md).
...
<table id="choicetable_tqp_sb1_fwb"><thead><tr><th align="left" id="d45019e154">

Location tracking action

</th><th align="left" id="d45019e157">

Description

</th></tr></thead><tbody><tr><td id="d45019e163">
