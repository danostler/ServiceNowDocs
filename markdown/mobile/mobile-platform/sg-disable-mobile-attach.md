...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/sg-disable-mobile-attach.html
release: zurich
...
-   You need to elevate to the **security\_admin** role to perform these steps. For details on this role, see [security\_admin role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/servicenow-ai-platform-security/security-admin-role.md).
