...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/input-form-screen-input-actions.html
release: zurich
...
For input actions script examples, refer to the following [Script code for storing user-selected attachments in the database](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/input-actions-script-attachments.md) and [Script code for comment type and updates for input actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/input-actions-script-comments.md).
