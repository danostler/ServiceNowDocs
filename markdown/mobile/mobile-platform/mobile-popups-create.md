...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/mobile-popups-create.html
release: zurich
...
-   Mobile cards are used in the display of pop-ups. You can either design one of your own mobile cards or use one of the template cards provided. For more information, see [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-card-builder.md).
-   Supported button types that trigger pop-ups are action item and navigation. For more information, see [Action functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-actions.md).
-   All button locations are supported. For example, swipe, top menu action, and footer function.
-   Buttons are supported in the following UI sections, record, icon, media, and content. For more information, see [Launcher screen UI sections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/alp-ui-sections.md).
...
The card to be used for the pop-up.
    ...
    For more information about creating cards, see [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-card-builder.md).
...
15. Assign configurable functions or predefined functions to a button on a mobile pop-up card.
    ...
    **Note:** For more information about configurable functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-studio-mobile-button-types.md) and [Configure a card action using Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/create-mca-with-mcb.md). Also, see the What to do next section in this topic.
...
For more information, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-studio-mobile-button-types.md) and [Configure a card action using Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/create-mca-with-mcb.md).

-   **[Assign predefined functions to mobile pop-ups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/popups-system-button.md)**  
...
**Parent Topic:**[Mobile pop-ups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile_popups.md)
