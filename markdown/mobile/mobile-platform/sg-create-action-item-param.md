...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/sg-create-action-item-param.html
release: australia
...
4.  In the **Action item** area of the form, select **New** and complete the fields for the action item as needed.
    ...
    For more information on creating an action item, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-studio-create-action-item.md).
