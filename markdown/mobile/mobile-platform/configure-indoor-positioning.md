...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/configure-indoor-positioning.html
release: australia
...
-   Configure Indoor Wayfinding. For more information, see [Indoor Wayfinding configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/indoor-wayfinding-config.md).
...
For information about the features this configuration enables for end users, see [Indoor positioning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/indoor-positioning-end-user.md).
...
**Parent Topic:**[Indoor Wayfinding configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/indoor-wayfinding-config.md)
