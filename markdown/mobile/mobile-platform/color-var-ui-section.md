...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/color-var-ui-section.html
release: australia
...
-   Icon section destination screen \[sys\_sg\_navigation\_section\_destination\_screen\]
 ...
 For details on creating these actions, see [Configure an icon UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-ui-section-config-navig.md).
