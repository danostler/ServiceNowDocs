...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/color-var-mobile-template.html
release: zurich
...
-   Onselect \(defined in root-view attribute JSON\): TextColorVariable and BackgroundColorVariable
 ...
 For details creating card templates, see [Create a card template with Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mcb-create-template.md).
