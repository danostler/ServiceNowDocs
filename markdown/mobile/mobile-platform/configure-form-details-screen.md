...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/configure-form-details-screen.html
release: australia
...
8.  Complete the following fields as needed.
    ...
    **Note:** The available fields that can be configured on a details screen form are determined by your organization's mobile UI rules. For more information, see [Mobile UI Rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-ui-rules.md).
...
-   **On-demand**: The app sends a network request to load the app only when end users navigate to it.
 For more information about fetch types, see [Mobile fetch types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/applet-fetch-types.md).
...
Sets the fields for the details screen. For information about setting these fields, see [Screen fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-screen-field-enhancements.md).
