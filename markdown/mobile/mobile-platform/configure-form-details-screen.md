...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/configure-form-details-screen.html
release: zurich
...
8.  Complete the following fields as needed.
    ...
    **Note:** The available fields that can be configured on a details screen form are determined by your organization's mobile UI rules. For more information, see [Mobile UI Rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-ui-rules.md).
...
Sets the fields for the details screen. For information about setting these fields, see [Screen fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/sg-screen-field-enhancements.md).
