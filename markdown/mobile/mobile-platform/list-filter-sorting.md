...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/list-filter-sorting.html
release: australia
...
3.  Repeat step 2 to display additional sorting options.
    ...
    **Note:** To change the sorting display attributes, see [Configure sorting display options for mobile filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/list-filter-sorting-attributes.md).
