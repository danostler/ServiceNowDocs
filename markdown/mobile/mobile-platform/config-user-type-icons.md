...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/config-user-type-icons.html
release: zurich
...
To use the user type icon, you must configure a header function in the launcher screen that enables users to navigate to an employee profile. For more information, see [Configure a launcher screen header](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/create-alp-header.md). To configure a mobile app to use a user icon, see [Configure using a user icon in a mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/config-user-icon-in-mobile-app.md).
