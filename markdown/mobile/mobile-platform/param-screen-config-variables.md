...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/param-screen-config-variables.html
release: australia
...
You must create an input form screen before you create variables and attributes. For information about creating an input form screen, see [Configure an input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/parameter-screen-config.md).
