...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-platform/additional-mobile-configuration.html
release: zurich
...
-   **[Require an app PIN for the mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/require-app-pin.md)**  
...
-   **[Configure mobile re-authentication system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-reautentication-concept.md)**  
...
-   **[Configure the blur app option to improve security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/t_BlurApp.md)**  
...
-   **[Configure the status for rooted and jailbroken devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/configure-rooted-jailbroken-devices.md)**  
...
-   **[Configure the mobile app to clear the copy/paste clipboard and block ability to share content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/configure-copy-paste.md)**  
...
-   **[Configure the maximum number of records returned for data items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/configure-data-item-row-count.md)**  
...
-   **[Configure pagination size for search lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/configure-pagination-size.md)**  
...
-   **[Configure the maximum number of records returned for list UI parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/configure-max-ui-param.md)**  
...
-   **[Configure a placeholder image for missing images in mobile apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/set-default-missing-image.md)**  
...
-   **[Configure which external apps are available for deep linking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/mobile-allow-deeplink.md)**  
...
-   **[Block users from downloading or sharing attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/block-users-download-shar-attach.md)**  
...
-   **[Configure group ACL for aggregation requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/config-grp-acl-4-aggreg-req.md)**  
...
-   **[Control whether users can view attachments in external applications on Android devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-platform/vu-attach-extapp-android.md)**  
