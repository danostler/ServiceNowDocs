...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/mobile-critical-alerts-create.html
release: australia
...
4.  From the **Record type** field, select Notification \[sysevent\_email\_action\] and then select an existing push notification event.
    ...
    **Note:** If you want to create a push notification from scratch, refer to [Mobile push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-push-notifications.md). You then must follow these subsequent steps to define the push notification as critical.
...
6.  Within the **Push message content** area, define and configure your critical alert.
    ...
    For information on how to configure a critical alert, see [Configure code for critical alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-citical-alert-code.md).
