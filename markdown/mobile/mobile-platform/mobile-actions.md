...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/mobile-actions.html
release: australia
...
Each action function includes an action item, which defines what the action function is and how it works. Learn more about action items at [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-studio-create-action-item.md).
...
Non-parametrized action function
 ...
 For details on configuring these actions, see [Configure an action function](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-studio-config-action-function.md).
...
Parametrized action function
 ...
 For details on configuring these actions, see [Create an action function with parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-studio-param-action-function.md).
...
Chat launcher action function
 ...
 For details on configuring these actions, see [Configure a contextual link to Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-av-context-action.md).
