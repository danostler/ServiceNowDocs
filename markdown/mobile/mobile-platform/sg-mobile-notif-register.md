...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/sg-mobile-notif-register.html
release: australia
...
8.  Click **Submit**.
    ...
    Your push message is rendered on mobile devices that it is registered to. To see how push notifications appear to end users, see [Mobile push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-push-notifications.md).
