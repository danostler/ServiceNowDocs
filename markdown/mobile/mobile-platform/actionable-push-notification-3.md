...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/actionable-push-notification-3.html
release: australia
...
3.  Create a new function for one of your push actions.
    ...
    -   URL
    -   Chat launcher
    For information on function types, and detailed steps for creating functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-studio-mobile-button-types.md).
...
**Parent Topic:**[Configure actionable push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/actionable-push-notification.md)
