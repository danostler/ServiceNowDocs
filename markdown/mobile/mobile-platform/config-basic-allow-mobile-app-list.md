...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/config-basic-allow-mobile-app-list.html
release: australia
...
7.  In the **Value** field, enter a comma-separated list of the iOS Bundle IDs and of the Android Package Names for the apps that can log in to your instance.
    ...
    For a list of iOS Bundle IDs and Android Package IDs, see [Bundle and Package IDs for ServiceNow mobile apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-package-ids.md).
