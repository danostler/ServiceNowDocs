...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/push-notif-sounds.html
release: australia
...
The following JSON is an example of how the sound parameter is defined for critical alerts. For more information about critical alerts, see [Mobile critical alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-critical-alerts-create.md).
