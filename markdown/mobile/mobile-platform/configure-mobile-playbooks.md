...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/configure-mobile-playbooks.html
release: australia
...
1.  Create the Now Experience Framework page in UI Builder.
    ...
    For instructions about how to create the page, see [Create a Now Experience Framework page in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mob-playbk-create-playbk-pg.md).

2.  Create the mobile web screen in MAB.

    For information about configuring a mobile web screen, see [Configure a mobile web screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-configure-url-screen.md).
...
-   **[Create a Now Experience Framework page in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mob-playbk-create-playbk-pg.md)**  
...
**Parent Topic:**[Mobile App Bridge](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/mobile-playbooks.md)
