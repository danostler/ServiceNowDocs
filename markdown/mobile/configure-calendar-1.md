...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/configure-calendar-1.html
release: zurich
topic_type: task
...
Control when the data is loaded onto the screen. Select the On-demand option for optimum load time performance. For more information, see [Mobile fetch types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/applet-fetch-types.md).
...
For more information, see [Quick actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-config-quick-actions.md).
...
Determine which user roles can access this screen. If you've selected no roles, users with any role will have access to the screen. 
    ...
    This icon represents the calendar screen in a launcher screen. For more information about creating icons, see [Mobile icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-icon.md).

7.  In the Quick action functions instance area, either select an existing function instance or create a new one.

    You can create more than one quick action function instance. For more information see, [Quick actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-config-quick-actions.md).
...
Determine what actions appear when a user taps on a list item.
 ...
 Select a navigation function or select **New** to create one. For more information about creating a navigation function, see [Navigation functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-nav-functions.md).
...
24. To customize elements and attributes of your card, do the following:
    ...
    2.  Make any required changes to your incident list card. For more information about working with Mobile Card Builder, see [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-card-builder.md).
    3.  Select **Save**.
25. Select **Save**.
