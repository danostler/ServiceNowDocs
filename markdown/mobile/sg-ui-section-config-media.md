...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-ui-section-config-media.html
release: zurich
topic_type: task
...
After creating media UI sections, you must associate the UI sections to a launcher screen so they're displayed. For more information, see [Add a UI section to the launcher screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/ui-section-to-launcher-screen.md).
