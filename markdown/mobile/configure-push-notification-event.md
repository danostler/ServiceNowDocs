...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/configure-push-notification-event.html
release: zurich
topic_type: task
...
You can add a push registration so that mobile users can receive this notification without requiring them to opt in. For more information, see [Register the standard push notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-notif-register.md).
