...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-assign-param-data-item-screen.html
release: zurich
topic_type: task
...
Make sure that you have configured a data item that has parameters. For more information, see [Configure a parametrized data item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-config-parametrized-data-item.md).
...
13. Complete any additional screen fields as needed. For more information on creating a screen, see [Create a screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-configure-applet-screens.md).
