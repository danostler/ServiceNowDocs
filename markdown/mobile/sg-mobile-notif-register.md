...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-mobile-notif-register.html
release: zurich
topic_type: task
...
8.  Click **Submit**.
    ...
    Your push message is rendered on mobile devices that it is registered to. To see how push notifications appear to end users, see [Mobile push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-push-notifications.md).
