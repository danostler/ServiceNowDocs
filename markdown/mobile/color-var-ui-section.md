...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/color-var-ui-section.html
release: zurich
...
-   Icon section destination screen \[sys\_sg\_navigation\_section\_destination\_screen\]
 ...
 For details on creating these actions, see [Configure an icon UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-ui-section-config-navig.md).
