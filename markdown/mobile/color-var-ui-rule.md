...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/color-var-ui-rule.html
release: zurich
...
-   `FontColorVariable` outside or within the `TextDecorator`
 ...
 For details on creating these UI rule actions, see [Create a mobile UI rule action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/create-mobile-ui-rule-action.md).
