...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-ui-rules.html
release: zurich
topic_type: concept
...
For more detail on the kinds of changes you can make with mobile UI rules, see the next section. For detailed steps on creating mobile UI rules and actions, see [Create a mobile UI rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/create-mobile-ui-rule.md).
