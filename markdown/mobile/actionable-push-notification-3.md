...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/actionable-push-notification-3.html
release: zurich
topic_type: task
...
3.  Create a new function for one of your push actions.
    ...
    -   URL
    -   Chat launcher
    For information on function types, and detailed steps for creating functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-mobile-button-types.md).
