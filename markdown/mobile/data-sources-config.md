...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/data-sources-config.html
release: zurich
topic_type: task
...
7.  Edit the script in the **Data source script** field as required.
    ...
    For examples of data source script, see [Data source script examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/data-source-script-examples.md).
