...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-ui-section-config-item-function.html
release: zurich
topic_type: task
...
To configure record section functions within a sections screen, at least one pre-configured record section must be created. For more information, see [Configure a record UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-ui-section-config-item.md).
