...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/configure-push-notification-message.html
release: zurich
topic_type: task
