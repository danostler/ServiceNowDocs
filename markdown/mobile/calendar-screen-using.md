...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/calendar-screen-using.html
release: zurich
...
Filter button. Use the filter option to help you search for specific content in the calendar. For more information about filtering, see [Filtering and sorting results in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/filter-sort-results-using.md).
