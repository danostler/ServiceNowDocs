...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-create-custom-search.html
release: zurich
topic_type: concept
...
-   **[Create a search source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-create-search-source.md)**  
Create a search source to define what records can be found in your search bar.
-   **[Create a search configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-search-e2e.md)**  
Create a search configuration. This record connects your launcher screen with the other records used to configure search.
-   **[Add your search configuration to a launcher screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-search-alp-config.md)**  
