...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/nav-chart-to-list-1.html
release: zurich
topic_type: task
...
Configure the List item config for your list screen to choose the cards and fields that will appear on this list. For more information, see [List screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/list-screen.md).

If you're adding an analytics preview to the launcher screen UI section. See, [Configure an analytics UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-ui-section-config-reports.md).
