...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/update-branded-app.html
release: zurich
topic_type: task
...
To learn more about deep links and universal links, see [Mobile URLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-urls.md).
...
-   Don’t select this option if you’re using AppConfig to preconfigure a default instance URL through an EMM suite or an embedded MAM SDK app. For more information, see [AppConfig for Mobile Apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/appconfig.md).
...
-   **[Test and publish an updated Android app for private distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/testpub-updat-and-app-priv.md)**  
...
-   **[Test and publish an updated iOS app for private distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/testpub-updat-ios-app-priv.md)**  
AFter you have requested an updated iOS app for private distribution, perform these steps to test and publish it.
-   **[Test and publish an updated Android app for public distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/testpub-updat-and-app-pub.md)**  
After you have requested an updated Android app for public distribution, perform these steps to test and publish it.
-   **[Test and publish an updated iOS app for public distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/testpub-updat-ios-app-pub.md)**  
