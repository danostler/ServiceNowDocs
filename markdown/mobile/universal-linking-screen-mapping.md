...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/universal-linking-screen-mapping.html
release: zurich
topic_type: task
...
When creating universal links, you define the screen type and the data the user sees after they tap the mobile banner. See, [Create path segment records and supported URL records for universal linking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/universal-linking-web-banner.md). Also there is an option to create a screen mapping for universal links. Users click these links to see a preconfigured screen based on a defined table.
