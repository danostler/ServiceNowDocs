...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-mobile-smart-button.html
release: zurich
topic_type: concept
...
For examples of configuring smart buttons, see [Configure a smart button](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-config-smart-button.md).
