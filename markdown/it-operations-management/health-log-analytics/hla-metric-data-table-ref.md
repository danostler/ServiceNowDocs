...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/health-log-analytics/hla-metric-data-table-ref.html
release: zurich
...
For more information about using the Metric Data table, see [View log anomaly metrics in Health Log Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/health-log-analytics/hla-metric-data-table.md).
