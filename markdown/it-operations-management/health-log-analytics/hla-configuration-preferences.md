...
-   Maximum Java heap size for MID Server: 8,192 MB
    ...
    For general information, see: [MID Server system requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/r_MIDServerSystemRequirements.md).
