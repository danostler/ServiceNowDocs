...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/health-log-analytics/hla-source-types.html
release: zurich
...
6.  Exclude a global keyword for this source type
    ...
    2.  From the **Actions on selected rows** list at the bottom of the page, select **Exclude keyword**.
    **Note:** You can delete global keywords from the [Lexical Keywords page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/health-log-analytics/hla-lexical-keywords-admin.md).
