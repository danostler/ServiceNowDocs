...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/health-log-analytics/il-connector-hla-edgedelta-rest-fields.html
release: zurich
...
For the Edge Delta REST integration setup procedure, see [Set up an Edge Delta REST integration for Health Log Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/health-log-analytics/il-connector-hla-edgedelta-rest.md).
