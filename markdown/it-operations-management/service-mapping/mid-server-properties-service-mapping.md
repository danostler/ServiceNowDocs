...
-   **Type**: string
-   **Location:** This property is not available in the base system. You can add the property as described in [Create a MID Server property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/r_MIDServerProperties.md).
...
-   **Type**: string
-   **Location:** This property is available under specific MID Server parameters as described in [Add a MID Server parameter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/mid-server-parameters.md).
