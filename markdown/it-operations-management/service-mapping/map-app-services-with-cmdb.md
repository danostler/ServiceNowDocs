...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/map-app-services-with-cmdb.html
release: zurich
...
Verify that the necessary tables are populated with data according to the process explained in [CMDB-based mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/cmdb-based-mapping.md).
