...
You can access these parameters in the **Configuration Parameters** related list of a MID Server. To add and set any of these parameter, see [Add a MID Server parameter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/mid-server-parameters.md).
