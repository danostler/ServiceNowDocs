...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/agent-client-collector/acc-linux-upgrade.html
release: zurich
...
2.  Download the .rpm/.deb agent package and signature files, as described in [Install Agent Client Collector on a Linux system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/install-acc-linux.md).
