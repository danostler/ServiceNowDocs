...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/agent-client-collector/hla-acc-data-input-log-policies.html
release: zurich
...
-   Define a new log policy when no policy exists for the CI that you want Agent Client Collector to monitor.
    ...
    For more information, see [Create an Agent Client Collector log policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/hla-acc-log-policies.md). For a general explanation of Agent Client Collector policies, see [Checks and policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/checks-policies.md).
