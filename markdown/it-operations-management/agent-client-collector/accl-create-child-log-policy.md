...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/agent-client-collector/accl-create-child-log-policy.html
release: zurich
...
4.  Customize the child policy's parameters.
    ...
    For a description of the parameters, see [Create an Agent Client Collector log policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/hla-acc-log-policies.md).
