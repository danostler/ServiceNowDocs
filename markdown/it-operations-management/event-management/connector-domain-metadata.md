...
**Note:** For information on connector parameters, see [Personalize domains for push connector events to use in event creation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/personalize-domain-separation-push-connectors.md).
