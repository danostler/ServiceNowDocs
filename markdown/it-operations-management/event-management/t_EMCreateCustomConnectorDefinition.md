...
-   Send events to the Event \[em\_event\] table using a web service API. See [REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/rest-api-explorer/c_RESTAPI.md).
