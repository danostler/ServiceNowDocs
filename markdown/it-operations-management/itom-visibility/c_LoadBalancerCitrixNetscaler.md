...
-   Configure [SNMP credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/connections-and-credentials/c_SNMPCredentials.md). The SNMP community string requires read-only access to the Citrix NetScaler MIB \(`1.3.6.1.4.1.5951`\).
...
-   Use [basic authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/connections-and-credentials/r_BasicAuthCredentialsForm.md) credentials for discovery via REST. Configure the credential as a [credential alias](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/connections-and-credentials/discovery-credential-alias.md). The NITRO API user requires read-only access to the following resources:
    -   `lbvserver`
    -   `csvserver`
    -   `service`
    -   `servicegroup`
