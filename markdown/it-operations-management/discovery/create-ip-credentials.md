...
3.  From the **Credential type** drop-down list, select a credential type.
    ...
    |[SNMP Community Credentials \(Password Only\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/connections-and-credentials/c_SNMPCredentials.md)|Credentials that use an SNMP community string for network devices.|
