...
**Note:** The Shazzam payload is controlled by the following [MID Server properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/r_MIDServerProperties.md). These properties do not need to be added to the MID Server. The Shazzam probe will fall back on their default values.
