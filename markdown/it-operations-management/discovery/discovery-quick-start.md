...
Before using Discovery Quick Start, install and validate MID Servers. See [MID Server installation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/mid-server-installation.md) for details.
