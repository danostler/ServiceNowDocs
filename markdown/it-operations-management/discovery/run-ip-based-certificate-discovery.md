...
3.  Create an IP-Based Certificate **Quick Discovery** for immediate discovery \(optional\).
    ...
    3.  Enter your Target IP into the **Target IP** field.
        ...
        **Warning:** Make sure that your IP address is accessible to the MID Server you’re using. If it doesn’t, you have to set [Credential aliases for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/connections-and-credentials/discovery-credential-alias.md).
