...
-   Verify that the Linux MID Server has the following requirements:
    ...
    -   MID Server **Capability** configured to **Scan Container Images**. For more information on configuring capabilities, see [MID Server capabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/orchestration/mid-server-capabilities.md).
