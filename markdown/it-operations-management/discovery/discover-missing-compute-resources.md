...
2.  Run a quick discovery for a resource.
    ...
    4.  In the **MID Selection Method** and **MID Server** fields, select the preferred options.
        ...
        For more information, see [MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/c_MIDServerSelector.md).
