...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/modify-a-probe.html
release: zurich
product: Discovery
...
-   [**CIM Probe**](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/r_CIMProbe.md): Select this probe type to query a CIM server using WBEM protocols.
...
-   [**SNMP Probe**](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/c_SNMPProbe.md): Select this probe type for network devices, such as routers.
-   [**WMI Probe**](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/r_WMIRunnerProbe.md): Select this probe type for Windows devices.
...
5.  Modify these related lists if necessary.
    ...
    |------------|-----------|
    |Probe Parameters|Parameters that control the functionality of the probe. See [Set probe parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/t_SetProbeParameters.md) for instructions.|
...
9.  [Check the ECC Queue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/r_DiscoveryStatusECCQueue.md) for the MID Server to see the results.


## What to do next

Add the probe to the **Triggers Probe** related list on the appropriate classifier. See [Create a Discovery CI classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/create-discovery-ci-classification.md) for a description of the fields and related lists on the classifier form.
