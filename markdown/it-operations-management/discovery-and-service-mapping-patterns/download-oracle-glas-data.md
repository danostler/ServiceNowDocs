...
</table>If you receive an SSH timeout error, you must create and set the following properties. See "Create a MID Server property" in [MID Server Properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/r_MIDServerProperties.md) for details.
