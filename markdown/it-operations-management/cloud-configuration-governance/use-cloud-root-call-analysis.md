...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/cloud-configuration-governance/use-cloud-root-call-analysis.html
release: zurich
...
1.  In the Cloud Admin Portal, navigate to **Operate** &gt; **Root Cause Analysis Dashboard**.
    ...
    See [The Cloud Orchestration Trail](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/cloud-configuration-governance/cloud-orch-trail.md) for a list of possible steps.
...
3.  Click any Cloud Orchestration API **Number** to view that specific record.
    ...
    See [The Cloud Orchestration Trail](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/cloud-configuration-governance/cloud-orch-trail.md) for field descriptions.
...
5.  Click any the data in the graphs to open the matching Cloud API Trail records.
    ...
    See [The Cloud API Trail](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/cloud-configuration-governance/cloud-api-trail.md) for descriptions of the Cloud API Trail form fields.
