...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/create-sold-product-covered.html
release: zurich
topic_type: task
...
-   You can add a sold product, if it isn't listed. Select **New** in the Install Base Item window. For more information, see [Create a sold product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/create-sold-item.md).
...
-   You can add an install base item if it isn't listed. Select **New** in the Install Base Item window. For more information, see [Create an install base item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/mco-create-install-base-item.md).
