...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/manufacturing-commercial-operations/mco-approve-sp-claim.html
release: zurich
...
1.  Navigate to **Workspaces** &gt; **CSM/FSM Configurable Workspace** &gt; **Lists** &gt; **Sales promotion**.
    ...
    **Note:** To create and navigate to the Review &amp; approve form, see [Create a sales promotion claim case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/manufacturing-commercial-operations/mco-create-sls-pro-claim-case.md).

2.  From the Activities menu, select **Review &amp; approve**.

3.  Select the check icon \(\[Omitted image "check-outline-24.svg"\] Alt text: Check icon.\).
