...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/manufacturing/manufacturing-commercial-operations/mco-create-install-base-item.html
release: australia
...
3.  On the Install based item form, fill in the fields.
    ...
    For a description of the field values, see [Install based item form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/manufacturing/manufacturing-commercial-operations/install-based-item-form.md).
