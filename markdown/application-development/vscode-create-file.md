...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/vscode-create-file.html
release: zurich
topic_type: task
...
[Import an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/vscode-import-application.md) in your VS Code project to create a file within your project.
...
5.  Enter a name for the file in the Create New File dialog box.
    ...
    The extension creates a file in your application on your local file system. The new file is added to your instance when you [synchronize](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/synchronize-files.md) your workspace.
