...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-ide-family-release/tutorial-clone-application-ide.html
release: zurich
...
Complete [Tutorial part 4: Install and use a third-party library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-ide-family-release/tutorial-install-third-party-library-ide.md).
...
Continue to [Tutorial part 6: Learn more about the ServiceNow IDE](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-ide-family-release/tutorial-next-steps-ide.md).
