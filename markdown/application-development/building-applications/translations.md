...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/building-applications/translations.html
release: zurich
...
To implement a new language, activate the plugin for the new language. Then export the existing values from any of the [Translation tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/system-localization/r_TranslationTables.md).
...
For more information, see [Language Internationalization Support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/system-localization/c_LangInternationalizationSupport.md)
