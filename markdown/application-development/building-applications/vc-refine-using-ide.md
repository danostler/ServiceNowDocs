...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/building-applications/vc-refine-using-ide.html
release: australia
...
7.  Use Build Agent to generate and run Automated Test Framework. For more information, see [Testing what you built](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/build-agent-testing.md).
