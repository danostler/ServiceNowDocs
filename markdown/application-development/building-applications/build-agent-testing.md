...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/building-applications/build-agent-testing.html
release: australia
...
For complete documentation on using Test Agent, see [Test Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/test-agent-landing-page.md).
