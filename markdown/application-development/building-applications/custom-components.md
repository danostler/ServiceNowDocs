...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/building-applications/custom-components.html
release: australia
...
-   **[Develop a component for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/va-components.md)**  
Create a custom Virtual Agent component to gather input or display information in the Virtual Agent client interface.
-   **[Add a component to Agent Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/workspace-component.md)**  
