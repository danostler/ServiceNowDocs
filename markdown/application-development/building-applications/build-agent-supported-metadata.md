...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/building-applications/build-agent-supported-metadata.html
release: australia
...
|Custom AI agents|AI agents scoped to application data models, roles, and ACLs. For more information, see [Create agentic workflows, agents, and skills](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/create-custom-ai-agent.md).|
