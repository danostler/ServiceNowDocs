...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/building-applications/vscode-create-file.html
release: australia
...
[Import an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/vscode-import-application.md) in your VS Code project to create a file within your project.
...
5.  Enter a name for the file in the Create New File dialog box.
    ...
    The extension creates a file in your application on your local file system. The new file is added to your instance when you [synchronize](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/synchronize-files.md) your workspace.
