...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/app-engine-studio/use-flow-template.html
release: zurich
...
You can edit the flow to tailor it to your business needs. For more information on working with automation, see [Modify a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/edit-flow.md).
