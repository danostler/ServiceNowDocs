...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/app-engine-studio/use-app-template.html
release: zurich
...
8.  From the app home, review the data, experience, logic and automation, and security that was created with the template.
    ...
    To tailor the application to your business needs, you can edit these predefined items or add your own. For more information, see [Enhance your app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/customize-application.md).


## What to do next

After you've finished building your application, submit the application for approval to get it reviewed and deployed by an administrator. For more information, see [Submit your app for approval and publishing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/submit-for-approval.md).

-   **[Available templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/template-library.md)**  
...
-   **[Build a custom template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/build-custom-template.md)**  
...
-   **[Update custom template contents and properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/manage-custom-template.md)**  
Improve the effectiveness of your custom template by updating its contents or properties in App Engine Studio \(AES\).
-   **[Manage template activation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/manage-template-activation.md)**  
...
-   **[App template sharing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/app-template-sharing.md)**  
Specify which users and groups have access to predefined and custom templates in App Engine Studio \(AES\).

**Parent Topic:**[Create your app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-studio/create-application.md)
