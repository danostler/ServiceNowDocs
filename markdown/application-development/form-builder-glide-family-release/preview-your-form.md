...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/form-builder-glide-family-release/preview-your-form.html
release: zurich
...
1.  Access Table Builder.
    ...
    -   For information on viewing forms, see [Launching Table Builder from UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/form-builder-glide-family-release/accessing-form-builder.md).
