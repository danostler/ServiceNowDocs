...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/automated-test-framework-atf/atf-run-suite.html
release: zurich
...
5.  Choose among any currently running test clients, or start a new runner.
    ...
    For more information, review [Browser recommendations for all tests and suites](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/automated-test-framework-atf/atf-test-runners.md).
