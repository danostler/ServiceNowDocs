...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/automated-test-framework-atf/atf-config-desc-script.html
release: zurich
...
For an example showing how where the description generated by this script appears, see [Description generation script example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/automated-test-framework-atf/atf-step-config-xmpls.md).
