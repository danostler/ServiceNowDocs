...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/automated-test-framework-atf/atf-active-manual-runners-module.html
release: zurich
...
When you start a manual [client test runner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/automated-test-framework-atf/atf-test-runners.md), the system registers that runner in the Test Runners table as active.
