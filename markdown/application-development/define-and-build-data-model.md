...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/define-and-build-data-model.html
release: zurich
topic_type: concept
...
-   **[Build the data model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/build-data-model.md)**  
Create tables and fields on the tables to support the application’s data model.
-   **[Secure data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/secure-data.md)**  
...
-   **[Manage data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/manage-data.md)**  
