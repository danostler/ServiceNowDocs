...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/understanding\_pdis.html
release: zurich
topic_type: concept
...
If your PDI is not on the latest release, follow the steps for [upgrading your PDI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/upgrading_your_pdi.md) to get the latest release.
