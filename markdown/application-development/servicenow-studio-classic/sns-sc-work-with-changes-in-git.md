...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-studio-classic/sns-sc-work-with-changes-in-git.html
release: zurich
...
-   **[Pull changes from a repository](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-studio-classic/sns-sc-pull-changes-from-repository.md)**  
...
-   **[Commit changes to a repository](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-studio-classic/sns-sc-commit-changes-to-repository.md)**  
...
-   **[Stash local changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-studio-classic/sns-sc-stash-local-changes.md)**  
...
-   **[Manage stashed changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-studio-classic/sns-sc-manage-stashed-changes.md)**  
App developers can apply or delete stashed changes from ServiceNow Studio.
-   **[Resolve conflicts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-studio-classic/sns-sc-resolving-conflicts.md)**  
