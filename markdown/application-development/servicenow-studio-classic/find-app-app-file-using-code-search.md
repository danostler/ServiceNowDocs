...
7.  Expand the type of script that you want to review for the code snippet.
    ...
    For a list of types of scripts, see [Available script types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/scripts/r_17Scripts.md).
