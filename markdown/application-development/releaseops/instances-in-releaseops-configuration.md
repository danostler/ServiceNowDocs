...
For more information about multi-instance management, see [Cross-instance application trust configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/grant-access-v2.md). To see a complete list of managed instances, you can navigate to **All** &gt; **Multi-instance management** &gt; **Managed instances**.
