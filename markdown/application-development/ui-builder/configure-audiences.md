...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/configure-audiences.html
release: zurich
product: UI Builder
...
4.  Next to the page variant that you want to edit, select the Open settings icon \[Omitted image "gear-icon.png"\] Alt text: Gear icon.
...
-   **[Enable the user criteria property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/enable-user-criteria-property.md)**  
