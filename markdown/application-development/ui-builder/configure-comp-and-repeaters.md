...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/configure-comp-and-repeaters.html
release: zurich
product: UI Builder
...
-   **[Add repeaters to components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/repeaters.md)**  
In UI Builder, use repeaters to repeat one or more components with results from a data resource.
-   **[Optimize page loading performance \(Advanced Feature\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/performance-settings.md)**  
