...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/add-viewport-modal.html
release: zurich
product: UI Builder
...
11. Select a page collection or create a new one.
    ...
    For more information, see [Create a page collection across multiple UI pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/create-page-collection.md).
