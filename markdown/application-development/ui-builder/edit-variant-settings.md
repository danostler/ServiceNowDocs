...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/edit-variant-settings.html
release: zurich
product: UI Builder
...
Set the rules for when your pages are shown. For more information, see [Control the conditions for a page variant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/control-conditions-for-your-variant.md).
...
Add or remove audiences for the page variant. For more information, see [Learn about audiences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/add-audiences.md).
