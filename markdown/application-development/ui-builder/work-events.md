...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/work-events.html
release: zurich
product: UI Builder
...
For more information about event mapping, see [Define map events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/event-mapping.md).
...
Add to a component, such as a button component, to open a viewport. For more information, see [Add a viewport component to your page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/work-with-viewport-components.md).
...
For more information, see [Bind an event to a page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/bind-event-page.md).
...
For more information, see [Bind an event to a declarative action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/bind-event-declarative-action.md).

-   **[Define map events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/event-mapping.md)**  
...
-   **[Event payloads in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/event-payloads.md)**  
Use event payloads to link data to an action.
-   **[Configure an event handler manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/event-handler.md)**  
...
-   **[Configure an event handler with Now Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/configure-an-event-handler-with-now-assist.md)**  
...
-   **[Bind events to add actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/bind-events.md)**  
...
-   **[Disable component preset event mappings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/disable-preset-event-mappings.md)**  
You can disable event mappings that are automatically created by a component preset.
-   **[Delete an event handler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/delete-event-handler.md)**  
Delete an event handler that you no longer need in UI Builder.
-   **[Delete an event mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/delete-event-mapping.md)**  
Delete an event mapping that you no longer need in UI Builder.
-   **[Add events to track components with unsaved changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/dirty-state-event.md)**  
