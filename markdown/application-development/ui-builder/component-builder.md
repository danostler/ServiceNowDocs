...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/component-builder.html
release: zurich
product: UI Builder
...
\[Omitted image "cb-test-values.png"\] Alt text: The alt text modal displays when test values is selected.
