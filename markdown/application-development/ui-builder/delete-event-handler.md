...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/delete-event-handler.html
release: zurich
product: UI Builder
...
9.  The event handler is removed from the associated event mapping.
    ...
    If you would like to delete the event mapping, see [Delete an event mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/ui-builder/delete-event-mapping.md).
