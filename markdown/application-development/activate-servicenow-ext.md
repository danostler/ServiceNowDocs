...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/activate-servicenow-ext.html
release: zurich
topic_type: task
...
2.  Choose **Now: Activate Now Extension** from the list.
    ...
    The **Setup Workspace** link appears at the bottom of the VS Code IDE. After the extension is activated, [Set up your workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/setup-workspace.md) in VS Code to begin editing ServiceNow applications.
