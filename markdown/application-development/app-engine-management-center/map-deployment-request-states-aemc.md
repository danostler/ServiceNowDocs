...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/app-engine-management-center/map-deployment-request-states-aemc.html
release: zurich
