...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/application-repository-self-hosted/install-customizations-from-app-repo.html
release: zurich
