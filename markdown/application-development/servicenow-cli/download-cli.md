...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-cli/download-cli.html
release: zurich
...
-   **[Install the ServiceNow CLI on Mac](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-cli/install-mac.md)**  
Install ServiceNow CLI on a Mac OS using the installer.
-   **[Install the ServiceNow CLI on Windows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-cli/install-windows.md)**  
Install ServiceNow CLI on a Windows OS using the installer.
-   **[Install the ServiceNow CLI on Linux](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-cli/install-linux.md)**  
