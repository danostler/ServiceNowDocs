...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-cli/manage-records.html
release: zurich
...
-   **[Create a record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-cli/create-record.md)**  
Inserts a single record in a specified table.
-   **[Delete a record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-cli/delete-record.md)**  
Deletes the specified record from the specified table.
-   **[Get a record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-cli/get-record.md)**  
Retrieves a single record based on the specified sys\_id from the specified table.
-   **[Query records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-cli/query-record.md)**  
Retrieves multiple records from a specified table.
-   **[Update a record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-cli/update-record.md)**  
