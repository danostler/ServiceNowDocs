...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/creator-studio/managing-creator-studio-deployments.html
release: zurich
...
Find details on deploying apps in [App Engine Management Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-management-center/app-engine-management-center.md).
...
For example, you can use AEMC to monitor apps. For more information, see [Managing custom apps using AEMC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/app-engine-management-center/manage-custom-apps-using-aemc.md).
