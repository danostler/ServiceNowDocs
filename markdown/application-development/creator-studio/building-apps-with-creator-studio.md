...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/creator-studio/building-apps-with-creator-studio.html
release: zurich
...
1.  Select one of the available [catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-glossary.md) templates.
2.  Customize a [form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-glossary.md) to be included in the catalog using a WYSIWYG editor.
...
-   **[Find existing apps in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/view-apps-creator-studio-home-page.md)**  
...
-   **[Work with bookmarked apps in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/crs-work-with-bookmarked-apps.md)**  
Bookmark an app to quickly find it in Creator Studio, as well as ServiceNow Studio.
-   **[Change your development experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/crs-change-dev-experience.md)**  
...
-   **[App creation in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-creating-apps.md)**  
...
-   **[Collaborating with others to build apps in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-collaboration-roles.md)**  
...
-   **[Working with forms in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-work-with-forms.md)**  
To add items or services to your catalog, you must create a different form for each thing being requested.
-   **[Working with automation in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-working-with-automations.md)**  
...
-   **[Configuring workspace lists and records for form submissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-form-submissions-workspace-about.md)**  
...
-   **[Testing and previewing Creator Studio apps and records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-testing-apps.md)**  
...
-   **[Deploying your Creator Studio app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-publishing-apps.md)**  
...
-   **[I've built my app in Creator Studio, now what?](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-made-your-app-now-what.md)**  
