...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/configure-ms-azure-portal-using-defender-endpoint-api.html
release: zurich
