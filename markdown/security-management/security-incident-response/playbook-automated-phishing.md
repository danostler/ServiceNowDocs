...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/playbook-automated-phishing.html
release: zurich
...
-   **[Create processes for Automated Phishing in PAD](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/create-process-automated-phishing.md)**  
Use these steps to create processes for Automated Phishing in the Process Automation Designer \(PAD\).
-   **[Using the Automated Phishing playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/using-automated-phishing-playbook.md)**  
