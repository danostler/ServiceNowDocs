...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/rate-limit-configuration-ms-defender-endpoint.html
release: zurich
