...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/playbook-deleting-bash-history.html
release: zurich
...
-   **[Set up the User Deleting Bash History playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/playbook-setup-deleting-bash-history.md)**  
Use the following steps to set up the User Deleting Bash History playbook.
-   **[Use the User Deleting Bash History playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/playbook-using-deleting-bash-history.md)**  
