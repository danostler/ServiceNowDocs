...
Verify that you have activated the Omni-Experience Standard Feature Set plugin. For more information, see [Installing Sidebar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/sidebar/install-sidebar.md).
...
7.  You can perform additional configuration like quick actions.
    ...
    To limit the action usage, you can use the **Apply to group** field on the quick action page. For more information, see [Creating a quick action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/agent-chat/ci-quick-actions-overview.md).
