...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/view-sir-premium-kpis-dashboard.html
release: zurich
...
4.  View the Security Incident Response Premium KPIs dashboard for further action.
    ...
    For detailed information on Security Incident Response Premium KPIs dashboard, see [Security Incident Management Premium dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/si-mgmt-premium-dashboard.md)
