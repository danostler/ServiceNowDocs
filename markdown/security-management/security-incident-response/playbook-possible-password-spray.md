...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/playbook-possible-password-spray.html
release: zurich
...
-   **[Set up the Possible Password Spray playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/playbook-setup-possible-password-spray.md)**  
Use the following steps to set up the Possible Password Spray playbook.
-   **[Use the Possible Password Spray playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/playbook-using-possible-password-spray.md)**  
