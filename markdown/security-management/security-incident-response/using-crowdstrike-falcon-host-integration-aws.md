...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/using-crowdstrike-falcon-host-integration-aws.html
release: zurich
