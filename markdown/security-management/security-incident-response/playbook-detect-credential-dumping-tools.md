...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/playbook-detect-credential-dumping-tools.html
release: zurich
...
-   **[Set up the T1003 - Detect Credential Dumping Tools playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/playbook-setup-detect-credential-dumping.md)**  
Use the following steps to set up the T1003 - Detect Credential Dumping Tools playbook.
-   **[Use the T1003 - Detect Credential Dumping Tools playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/playbook-using-detect-credential-dumping.md)**  
