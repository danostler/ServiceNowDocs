...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/activate-configure-arcsight-inc-enrich.html
release: zurich
...
**Parent Topic:**[HPE ArcSight Logger - Incident Enrichment integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/arcsight-logger-landing-page.md)
