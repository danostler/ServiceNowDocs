...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/playbook-modsec-bruteforce-ip.html
release: zurich
...
-   **[Set up the ModSec Brute force by IP Burst playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/playbook-setup-modsec-bruteforce.md)**  
Use the following steps to set up the ModSec Brute force by IP Burst playbook.
-   **[Use the ModSec Brute force by IP Burst playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/using-modsec-bruteforce-ip-playbook.md)**  
