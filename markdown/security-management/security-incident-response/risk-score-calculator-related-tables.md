...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/risk-score-calculator-related-tables.html
release: zurich
...
**Parent Topic:**[Define the new Risk Score Calculator Rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/define-risk-score-calculator-rules-sir.md)
