...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sightings-searches-in-misp.html
release: zurich
topic_type: concept
...
Verify that the [Sightings Search Configuration profile for MISP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/configure-sightings-search.md) is active.
...
3.  Review the work notes after new observables have been associated with the security incident.
    ...
    A work note is posted when the [Security Operations Integration - Sightings Search workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/secops-integration-sightings-search-workflow.md) has triggered.
