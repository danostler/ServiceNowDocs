...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-updating-class-cloud-resource-hybrid-assets.html
release: zurich
topic_type: concept
...
**Parent Topic:**[Creating CIs using the Identification and Reconciliation engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-ci-creation-using-IRE.md)
