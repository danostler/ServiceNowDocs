...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/configuration-compliance/create-test-result-group-module.html
release: zurich
...
Initially **Open**, is the remediation state of the remediation task. For more information, see [Configuration Compliance states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/configuration-compliance/vuln-config-compl-states.md).
