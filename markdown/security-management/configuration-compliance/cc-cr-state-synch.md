...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/configuration-compliance/cc-cr-state-synch.html
release: zurich
...
For more information about remediation task states and what you can do in each state, see [Configuration Compliance states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/configuration-compliance/vuln-config-compl-states.md).
