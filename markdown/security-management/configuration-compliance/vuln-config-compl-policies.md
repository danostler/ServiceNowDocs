...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/configuration-compliance/vuln-config-compl-policies.html
release: zurich
...
For more information about supported integrations, see [Configuration Compliance integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/configuration-compliance/vuln-config-compl-integrations.md).
