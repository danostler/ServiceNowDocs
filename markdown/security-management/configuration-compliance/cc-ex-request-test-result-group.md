...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/configuration-compliance/cc-ex-request-test-result-group.html
release: zurich
...
-   Other
To see how to add new reason choices, see [Define policy reason mappings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/configuration-compliance/define-policy-reason-mappings.md).
