...
Use an [agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/ai-security-exposure-use-agent.md)AI to automate the deferral of findings that have mitigations or guardrails and create exception rules to auto-defer future findings.
