...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-create-rev16.html
release: zurich
topic_type: task
...
5.  Alternatively, you can [Create a recurring remediation effort in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-create-recurringRE-steal-VI.md).
