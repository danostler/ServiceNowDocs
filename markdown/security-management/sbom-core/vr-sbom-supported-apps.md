...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sbom-core/vr-sbom-supported-apps.html
release: zurich
product: SBOM Core
...
See [Veracode Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/application-vulnerability-response/veracode-vuln-integration.md) for more information.
