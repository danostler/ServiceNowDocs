...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/vr-unified-CISO-dashboard.html
release: australia
...
Shows the set target to cover for a metric.
 ...
 See [Set targets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/set-targets-cybersecurity-dashboard.md) for more information.
...
-   Global benchmark: Average of metrics from the peers in the global market
 ...
 See [Opt-in for benchmark scores](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/vr-retrieve-benchmark-results.md) on how to view the benchmark scores.
