...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/ai-security-exposure-install-config.html
release: zurich
...
10. Assign the following AISEC roles:
    ...
    See [Viewing AI Exposures](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/ai-security-exposure-home.md) for more information about the AI Security Exposure Management tables.
