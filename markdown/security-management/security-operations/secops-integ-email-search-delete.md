...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/secops-integ-email-search-delete.html
release: zurich
...
-   **[Execution Tracking Begin \(Mail Search\) action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/execution-tracking-begins-mail-search-activity.md)**  
...
**Parent Topic:**[Security Operations Integration- Email Search and Delete capability](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/email-search-capability.md)
