...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/sem-import-security-tag-rules.html
release: australia
...
2.  Choose or [create a security tag](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/create-class-group-and-tags.md).
...
**Parent Topic:**[Set up security tag groups and tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-create-class-group-and-tags.md)
