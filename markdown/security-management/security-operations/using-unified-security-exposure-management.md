...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/using-unified-security-exposure-management.html
release: zurich
...
-   **[Create a dashboard in the Findings view page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-create-dashboard.md)**  
...
-   **[Evaluate vulnerability exposure data with Security Exposure 360](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/now-assist-review-vulnerability-exposure-data.md)**  
...
-   **[Exploring AI Security Exposure Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/exploring-ai-security-exposure.md)**  
...
-   **[Generate vulnerability insights with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-insights-skill.md)**  
...
-   **[Retrieve Vulnerability and exposure data with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/retrieve-vr-data.md)**  
...
-   **[Assess your vulnerability exposure with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/assess-exposure-vr-aiagent.md)**  
...
-   **[Identify duplicate vulnerable items with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/dedupe-host-vi-now-assist-vulnerability-response.md)**  
...
-   **[Approval recommendations using generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/now-assist-vr-generating-approvals.md)**  
...
-   **[Suggest vulnerability solutions with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/solutions-now-assist-vulnerability-response.md)**  
...
-   **[Analyze vulnerability remediation status with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sla-targets-vr-aiagent.md)**  
Chat with an AI agent to help you gain insights into your monthly remediation compliance metrics for vulnerable items.
-   **[Creating an API connector with generative ai](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/using-now-assist-api-connector.md)**  
...
-   **[Reclassify unclassed hardware](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-reclassify-unclassed-hardware.md)**  
Reclassify unclassed hardware by updating the lookup rules.
-   **[Bulk edit in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-workspace-bulk-edit-overview.md)**  
...
-   **[Use the List view in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-ws-list-view.md)**  
...
-   **[Create a remediation task manually in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-create-remediation-task.md)**  
...
-   **[Enable or disable the import of test results for a Qualys test group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-enable-disable-imports-qualys.md)**  
...
-   **[Modify the severity for a CVE or TPE](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-modify-reset-severity.md)**  
...
-   **[Use Remediation Effort records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-ws-remed-eff-rcd.md)**  
...
-   **[Approve or reject requests in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-approve-requests.md)**  
Approve or reject requests that are submitted by remediation owners.
-   **[Add a compensating control to the library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-create-compensatory-control.md)**  
...
-   **[Examples for remediation task creation in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-create-remediation-task-examples.md)**  
...
-   **[Exception Management Overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-exception-management-overview.md)**  
...
-   **[Unified Approvals View](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-approval-view.md)**  
...
-   **[Employee service center for Vulnerability Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/employee-center-vr-overview.md)**  
...
-   **[Unified Approval Rules Overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-approval-rules-overiew.md)**  
...
-   **[Create a change request in the Remediation view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-ws-CRs.md)**  
