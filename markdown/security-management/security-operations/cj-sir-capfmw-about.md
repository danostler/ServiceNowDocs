...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/cj-sir-capfmw-about.html
release: australia
...
-   Role required: sn\_si.admin, flow\_designer, action\_designer
-   Install one of the supported integrations \(see [Supported integrations and components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/cj-sir-capfmw-about.md)\)
