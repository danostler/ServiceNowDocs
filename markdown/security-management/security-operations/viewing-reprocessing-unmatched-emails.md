...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/viewing-reprocessing-unmatched-emails.html
release: australia
...
3.  To reprocess this email, create an email record or edit an existing email record to match the information in this email.
    ...
    See [Create email parsers in Security Operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/parsing-emails.md).
...
**Parent Topic:**[Unmatched Security Operations email events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/umatched-emails.md)
