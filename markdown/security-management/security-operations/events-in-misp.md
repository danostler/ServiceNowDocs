...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/events-in-misp.html
release: australia
...
-   **Global \(Tags\):**The selected tags will be added as global tags to the MISP event.
    ...
    -   In the [Associated MISP Events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/associated-misp-events.md) related list, you can view the event in relation to the security incident and the MISP resources.
...
-   [Review the MISP user role and permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/misp-user-roles-and-permissions.md) required for using the MISP bi-directional features.
