...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/install-non-core-apps.html
release: zurich
...
4.  If the integration has any core application dependencies, such as Security Incident Response, to which your company is not yet entitled:
    ...
    1.  [Follow these instructions to obtain entitlements, download dependency plugins, and activate the applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/download-app-first-time.md).
