...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/sem-automating-prioritization-triaging.html
release: zurich
...
-   **[Associating finding with a configuration item using lookup rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-associate-finding-configuration-item-using-lookup-rules.md)**  
...
-   **[Categorizing findings and discovered items using classification rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-categorizing-findings-discovered-items.md)**  
...
-   **[Prioritizing vulnerabilities and other findings using roll-up calculators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-prioritizing-vulnerabilities-other-findings.md)**  
...
-   **[Assigning findings to remediation teams using assignment rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-assigning-findings-to-remediation-teams.md)**  
...
-   **[Removing assignments from findings and remediation tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-unassigning-findings.md)**  
...
-   **[Defining your own service level agreements \(SLAs\) using remediation target rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-defining-your-own-sla.md)**  
...
-   **[Deferring findings automatically without manual intervention using exception rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-exception-rules-overview.md)**  
...
-   **[Grouping multiple findings as remediation tasks for easy processing using remediation task rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-grouping-multiple-findings-remediation-tasks-processing.md)**  
...
-   **[Closing stale detections and findings automatically using auto-close rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-closing-stale-findings-automatically.md)**  
...
-   **[Deleting stale findings automatically using auto-delete rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-deleting-stale-findings-automatically.md)**  
...
-   **[Controlling the ingestion volume with automatic exclusion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-controlling-ingestion-volume-automatic-exclusion.md)**  
...
-   **[Severity mapping for Unified Security Exposure Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-severity-mapping.md)**  
...
-   **[Creating CIs using the Identification and Reconciliation engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-ci-creation-using-IRE.md)**  
