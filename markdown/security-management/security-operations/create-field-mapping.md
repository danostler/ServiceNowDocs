...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/create-field-mapping.html
release: zurich
...
Governs how to handle source records that would generate a duplicate record. For more information, see [Shared data transformation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/shared-data-transformation.md).
...
<table id="choicetable_w4v_gmy_tz"><tbody><tr><td id="d142015e240">
...
**Parent Topic:**[Security Operations field mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/field-mapping.md)
