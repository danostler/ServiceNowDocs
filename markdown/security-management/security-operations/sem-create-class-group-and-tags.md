...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/sem-create-class-group-and-tags.html
release: australia
...
-   **[Create security tag rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-create-security-tag-rules.md)**  
Security tag rules provide filtering for security tag access.
-   **[Import security tag rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-import-security-tag-rules.md)**  
