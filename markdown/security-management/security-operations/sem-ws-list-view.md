...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/sem-ws-list-view.html
release: zurich
...
3.  Select **My Lists** to create a list.
    ...
    For more information on how to create a list, see [Create a customized list of records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-create-custom-list.md).
...
-   **[Create a customized list of records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-create-custom-list.md)**  
