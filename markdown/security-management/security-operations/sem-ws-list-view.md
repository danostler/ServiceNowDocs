...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/sem-ws-list-view.html
release: australia
...
3.  Select **My Lists** to create a list.
    ...
    For more information on how to create a list, see [Create a customized list of records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-create-custom-list.md).
...
-   **[Create a customized list of records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-create-custom-list.md)**  
