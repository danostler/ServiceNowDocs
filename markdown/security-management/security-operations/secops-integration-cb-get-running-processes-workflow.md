...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/secops-integration-cb-get-running-processes-workflow.html
release: australia
...
-   **[Collect Carbon Black Configurations Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/collect-cb-config-activity.md)**  
The Collect Carbon Black Configurations flow action gathers configuration information to use in the flow.
-   **[Check MID Server Status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/check-mid-server-status.md)**  
...
-   **[Get Sensor ID Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/get-sensor-id-activity.md)**  
The Get Sensor ID flow action gathers sensor identifiers to use in the flow.
-   **[Create Session Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/create-session-activity.md)**  
The Create Session flow action establishes a Carbon Black session to use in the flow.
-   **[Check Session Status Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/check-session-status-activity.md)**  
Determines the status of a Carbon Black session within the flow.
-   **[Create Command Process Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/create-command-process-activity.md)**  
The Create Command Process flow action create a Carbon Black command process to use in the flow .
-   **[Check Command Status and Get Process Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/check-command-status-get-process-activity.md)**  
Checks the Carbon Black command status and retrieves processes to use in the flow.
-   **[Map Processes Data Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/map-processes-data-activity.md)**  
...
-   **[Close Session Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/close-session-activity.md)**  
