...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/create-class-group-and-tags.html
release: zurich
...
-   **[Create security tag rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/create-security-tag-rules.md)**  
Security tag rules provide filtering for security tag access.
-   **[Import security tag rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/import-security-tag-rules.md)**  
