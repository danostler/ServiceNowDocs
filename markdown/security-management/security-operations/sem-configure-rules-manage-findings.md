...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/sem-configure-rules-manage-findings.html
release: zurich
...
-   **[Configuring lookup rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-lookup-rules.md)**  
...
-   **[Configuring classification rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-classification-rules.md)**  
...
-   **[Configuring roll-up calculator rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-risk-rules.md)**  
...
-   **[Configuring assignment rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-assignment-rules.md)**  
...
-   **[Configuring remediation target rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-remediation-target-rules.md)**  
...
-   **[Configuring an exception rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-exception-rule.md)**  
...
-   **[Define fields and weights for the risk rule for Unified Security Exposure Management risk calculators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-vuln-calc-define-risk-rule-fields.md)**  
...
-   **[Configuring remediation task rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-remediation-task-rules.md)**  
By configuring remediation task rules, you can automatically group findings based on filter conditions.
-   **[Configuring auto-close rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-auto-close-rules.md)**  
...
-   **[Configuring auto-delete rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-auto-delete-rules.md)**  
By configuring auto-delete rules, you can automate the process of deleting older findings and remediation tasks.
-   **[Configuring exclusion rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-configure-exclusion-rules.md)**  
...
-   **[Approve or reject an unassign request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-approve-unassign-requests.md)**  
...
-   **[Approval workflow configurations for unassign request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-unassign-approval-rules.md)**  
