...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/sem-ci-identifier-rules-impl-test.html
release: australia
...
**Parent Topic:**[Associating finding with a configuration item using lookup rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-associate-finding-configuration-item-using-lookup-rules.md)
