...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/secops-integration-cb-isolate-host-workflow.html
release: australia
...
-   [Execution Tracking - Begin \(CIs\) Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/execution-tracking-begins-cis-activity.md)
-   [Get IP from CI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/get-ip-from-ci-activity.md)
-   [Collect Carbon Black configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/collect-cb-config-activity.md)
...
-   [Get Sensor ID](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/get-sensor-id-activity.md)
-   [Set Network Isolation Enabled activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown)
-   [Update Sensor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/update-sensor-activity.md) - returns Isolate Host result.
...
-   **[Update Sensor activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/update-sensor-activity.md)**  
