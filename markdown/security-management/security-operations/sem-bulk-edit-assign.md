...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/sem-bulk-edit-assign.html
release: zurich
...
3.  Perform one of the following:
    ...
    -   Select the check box next to each item if you want to use the **Only Selected Items** option in the [Record selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/vulnerability-manager-workspace/vmws-bulk-edit-assign.md) field.
