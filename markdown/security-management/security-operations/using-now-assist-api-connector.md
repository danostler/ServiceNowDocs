...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/using-now-assist-api-connector.html
release: australia
...
See [Create an API connector with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/select-api-template.md) for the steps in the Connector builder that use Now Assist for Vulnerability Response.

-   **[Create an API connector with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/select-api-template.md)**  
