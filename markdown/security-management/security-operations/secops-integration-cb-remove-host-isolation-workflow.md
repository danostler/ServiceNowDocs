...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/secops-integration-cb-remove-host-isolation-workflow.html
release: zurich
...
-   If successful- [Collect Carbon Black Configurations Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/collect-cb-config-activity.md)
...
-   [Update Sensor activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/update-sensor-activity.md)- returns Isolate Host result.
