...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/common-wf-activities.html
release: zurich
...
-   **[Execution Tracking - Begin Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/execution-tracking-begin.md)**  
...
-   **[Capability - Determine CIs activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/determine-cis-activity.md)**  
The Capability - Determine CIs workflow activity determines which configuration items \(CIs\) to include in the workflow.
-   **[Create Enrichment Data records Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/create-enrich-data-records.md)**  
The **Create enrichment data records** flow action creates or updates enrichment records to use in the flow.
-   **[Get Configuration Item FQDN Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/get-config-FQDN-activity.md)**  
...
-   **[Determine Observables activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/determine-observables-activity.md)**  
...
-   **[Get Network Statistics via netstat Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/get-network-stats-netstat-activity.md)**  
...
-   **[Get running processes via WMI activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/get-running-process-WMI-activity.md)**  
...
-   **[Update Task Worknotes activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/update-task-worknotes-activity.md)**  
...
-   **[Roll up lookup info to security incident activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/r_RollUpScanInfoSI.md)**  
...
-   **[Update security incident with lookup results workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/t_UpdateSecIncScanResults.md)**  
The **Update security incident with lookup results** workflow updates existing security incidents with lookup results.
-   **[Filter Allowlisted Observables activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/filter-whitelisted-observables-activity.md)**  
...
-   **[Write content to record as attachment activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/write-content-record-attachment-activity.md)**  
This activity writes the content passed in from an input and creates a designated attachment to a given record.
-   **[Get IP from CI activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/get-ip-from-ci-activity.md)**  
