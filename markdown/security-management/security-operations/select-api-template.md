...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/select-api-template.html
release: zurich
...
**Parent Topic:**[Creating an API connector with generative ai](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/using-now-assist-api-connector.md)
