...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/edit-an-integration-sir.html
release: australia
...
-   After making API updates, select the **Save changes** button. You have to create API endpoint details, generate the parsing and invocation scripts. For more details, see [Add APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/add-apis.md).
