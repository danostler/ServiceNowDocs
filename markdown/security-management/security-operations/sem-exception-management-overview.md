...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/sem-exception-management-overview.html
release: australia
...
-   **[Approver roles required for Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-approve-or-reject-request.md)**  
You can see the required roles for the approvers in the Security Exposure Management Workspace.
-   **[Questionnaire support in Exception Management via Smart Assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-smart-assessment-exp-management.md)**  
...
-   **[Defer a Remediation task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-defer-rem-task.md)**  
...
-   **[Request an extension for a deferred remediation task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-extend-defer-rem.md)**  
...
-   **[Request a false positive for a vulnerable item or remediate task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/sem-falsepst-reqst.md)**  
