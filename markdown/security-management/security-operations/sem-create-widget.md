...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-operations/sem-create-widget.html
release: zurich
...
3.  On the new Visualization widget form, enter the required details.
    ...
    For a full description of each field, see [Visualization widget fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-operations/sem-vis-widget-fields.md).
