...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/r\_ThreatRespAdmin.html
release: australia
...
|-----------|-----------|
|Properties|Threat Intelligence [properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/c_GetStartedWithThreatIntel.md) allow you to control how different aspects of the system function, including the setting of API keys.|
