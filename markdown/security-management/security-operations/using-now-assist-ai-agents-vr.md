...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/security-operations/using-now-assist-ai-agents-vr.html
release: australia
...
[Assess your vulnerability exposure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/assess-exposure-vr-aiagent.md)-   Determine if your configuration items \(CIs\) and business services are exposed to known vulnerabilities.
...
-   See [Configure an agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/security-management/security-operations/now-assist-vr-acticvate-agentic-workflow.md) for more information.
