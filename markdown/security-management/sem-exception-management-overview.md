...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-exception-management-overview.html
release: zurich
topic_type: concept
...
-   **[Approver roles required for Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-approve-or-reject-request.md)**  
You can see the required roles for the approvers in the Security Exposure Management Workspace.
-   **[Questionnaire support in Exception Management via Smart Assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-smart-assessment-exp-management.md)**  
...
-   **[Defer a Remediation task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-defer-rem-task.md)**  
...
-   **[Request an extension for a deferred remediation task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-extend-defer-rem.md)**  
...
-   **[Request a false positive for a vulnerable item or remediate task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-falsepst-reqst.md)**  
