...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/secops-integration-cb-remove-host-isolation-workflow.html
release: zurich
topic_type: task
...
-   If successful- [Collect Carbon Black Configurations Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/collect-cb-config-activity.md)
-   [Get Sensor ID Flow Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/get-sensor-id-activity.md)[Get Sensor ID](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/get-sensor-id-activity.md)
-   If- Device supports isolation- and device is not isolated to disabled.
-   [Update Sensor activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/update-sensor-activity.md)- returns Isolate Host result.
