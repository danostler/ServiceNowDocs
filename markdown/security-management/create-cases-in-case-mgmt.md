...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/create-cases-in-case-mgmt.html
release: zurich
topic_type: task
...
6.  Click **Submit**.
    ...
    After the record has been saved, you can click the **Case Artifacts** tab and [add artifacts to the case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/add-records-to-cases.md).


-   **[Add artifacts to a case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/add-records-to-cases.md)**  
