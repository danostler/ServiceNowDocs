...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-approval-view.html
release: zurich
topic_type: concept
...
Approvers can approve or reject requests directly within the same record. See [Reviewing an Approval Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-review-approval-request.md).
...
-   **[Add an approver](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-add-false-positive-approver.md)**  
...
-   **[Configure Approval List and Form View](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-configure-approval-view.md)**  
...
-   **[Reviewing an Approval Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-review-approval-request.md)**  
Review an approval request form to perform the required action according to the role assigned to you.
-   **[Review questionnaire to approve or reject requets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-smart-assessment-flow.md)**  
