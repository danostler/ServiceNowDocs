...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/observable-enrichment-in-misp.html
release: zurich
topic_type: concept
...
3.  Review the work notes after new observables have been associated with the security incident.
    ...
    The following example shows that a work note posts when the [Security Operations Integration - Enrich Observable flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/secops-integration-enrich-observ-wf.md) triggers.
