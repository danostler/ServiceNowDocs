...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/data-loss-prevention/execute-smart-response-rules.html
release: zurich
...
You need to configure the Smart Response Rules by following procedure explained here in this section, [Configure Smart Response Rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/data-loss-prevention/config-smart-response-rules.md).
