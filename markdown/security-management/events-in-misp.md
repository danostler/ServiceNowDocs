...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/events-in-misp.html
release: zurich
topic_type: concept
...
**Parent Topic:**[Using MISP to investigate and analyze threats](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/using-misp-to-detect-and-analyze-threats.md)
...
-   Click the [Associated MISP Events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/associated-misp-events.md) related list. Here, you can view the event in relation to the security incident and the MISP resources as shown in the following example.
...
-   [Review the MISP user role and permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/misp-user-roles-and-permissions.md) for using the MISP bi-directional features.
...
-   **Global \(Tags\):**The selected tags will be added as global tags to the MISP event.
    ...
    -   In the [Associated MISP Events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/associated-misp-events.md) related list, you can view the event in relation to the security incident and the MISP resources.
...
-   [Review the MISP user role and permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/misp-user-roles-and-permissions.md) required for using the MISP bi-directional features.
