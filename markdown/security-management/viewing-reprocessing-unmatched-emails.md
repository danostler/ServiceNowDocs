...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/viewing-reprocessing-unmatched-emails.html
release: zurich
topic_type: task
...
3.  To reprocess this email, create an email record or edit an existing email record to match the information in this email.
    ...
    See [Create email parsers in Security Operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/parsing-emails.md).
...
**Parent Topic:**[Unmatched Security Operations email events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/umatched-emails.md)
