...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/test-activate-desktop-action-ad.html
release: zurich
topic_type: task
...
5.  After a successful completion of the desktop action test and when you're satisfied with the result, select **Activate** to publish the desktop action in AI Agent Studio.
    ...
    **Important:** If you recorded the desktop action using [Record with AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/record-with-ai-ad.md), an alert appears if any screens have failed anchors. Resolve the issues before activating to verify reliable automation at runtime.
...
If you get en error that the file size is beyond 10 MB, you can increase the file size in a payload by creating system properties in the ServiceNow instance. For more information, see [Increase payload limit through system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/increase-payload-limit-ad.md).

## What to do next

Create an AI agent. For more information, see [Creating AI agents for AI Desktop Actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/create-ai-agents-ad.md).
