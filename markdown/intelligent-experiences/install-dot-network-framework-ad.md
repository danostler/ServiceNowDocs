...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/install-dot-network-framework-ad.html
release: zurich
topic_type: task
...
Ensure that you have installed the AI Desktop Actions MSI. For more information, see [Download AI Desktop Actions installer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/download-agentic-desktop-installer.md).
