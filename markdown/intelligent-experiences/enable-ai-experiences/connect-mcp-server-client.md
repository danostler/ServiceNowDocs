...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/connect-mcp-server-client.html
release: zurich
...
1.  [Create an OAuth inbound integration for an MCP client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/connect-mcp-server-client.md)
2.  [Configure an MCP client to connect to an MCP server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/connect-mcp-server-client.md)
...
1.  On the server instance, create an OAuth inbound integration for the ServiceNow Model Context Protocol Client.
    ...
    For more information, see [Create an OAuth inbound integration for an MCP client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/connect-mcp-server-client.md).
...
5.  Add the Quickstart Server.
    ...
    For more information about this step, see [Add an MCP server with OAuth 2.1](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/add-an-oauth-2-1-mcp-server.md).
...
7.  Add tools from the Quickstart Server to an AI agent.
    ...
    For more information about this step, see [Add an MCP server tool to an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/add-mcp-server-tool.md).

    1.  In AI Agent Studio, select the **Create and manage** tab.
    2.  From the AI agents tab, select an existing agent or create one.

        For information about creating an agent, see [Create an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/configure-next-best-action-agent.md).
...
8.  Test the AI agent.
    ...
    For more information about this step, see [Test an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/test-ai-agent-mcp.md).
