...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/modify-aia-use-case.html
release: zurich
...
3.  Modify the fields in the different sections of the guided setup, making changes to the fields for your own requirements.
    ...
    -   [Define the AI agent's specialty](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/define-key-requirements.md).
    -   [Define the AI agent security controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/define-sec-controls-aw.md).
    -   [\(Optional\) Add a trigger to automatically invoke your AI agent if a specified event occurs.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/add-trigger-aw.md).
    -   [Determine the channels to invoke your agentic workflow.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/channels-access-aw.md).
