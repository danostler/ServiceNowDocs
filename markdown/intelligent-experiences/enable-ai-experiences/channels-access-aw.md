...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/channels-access-aw.html
release: zurich
...
2.  Add a UI action to your agentic workflow.
    ...
    3.  Select a table where the UI action can be used.
        ...
        Users who are accessing a record on the selected table can view the UI action in the Core UI and workspaces. See [In-product agentic AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/in-product-agentic-ai.md) for more information about the AI Workflows panel.
