...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/sn-ai-impl-kb-readiness.html
release: zurich
...
-   **1. Review existing KB articles and knowledge bases**
    ...
    See: [Knowledge Management Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/knowledge-management/km-overview-dash.md)
...
-   **2. Review the structural formatting of KB articles**
    ...
    -   [Knowledge article templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/knowledge-management/knowledge-article-templates.md)
    -   [Activate the Knowledge Management Advanced plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/knowledge-management/activate-knowledge-advanced-plugin.md)
-   **3. Ensure metadata completeness in KB articles**
    ...
    -   [Create a knowledge article](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/knowledge-management/create-knowledge-article.md)
...
-   **4. Perform maintenance audits**
    ...
    -   [Knowledge Management Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/knowledge-management/km-overview-dash.md)
    -   [Retire a knowledge article](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/knowledge-management/c_RetiredKnowledgeArticles.md)
    -   [Identify and review duplicate Knowledge articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/now-assist-in-knowledge-management/Now-Assist-identify-and-review-duplicate-articles.md) \(requires Now Assist in Knowledge Management\)
-   **5. Review top searched queries**
    ...
    See: [Knowledge Management dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/knowledge-management/knowledge-management-dashboard.md)
