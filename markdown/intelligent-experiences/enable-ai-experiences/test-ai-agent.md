...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/intelligent-experiences/enable-ai-experiences/test-ai-agent.html
release: australia
...
2.  Select **Start manual test**.
    ...
    If you want to start an automated test, see [Evaluate an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/execute-aia-eval.md) for more details on that process.
