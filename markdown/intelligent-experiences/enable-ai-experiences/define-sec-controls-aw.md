...
3.  Define the user identity of the agentic workflow to determine what data it has access to.
    ...
    If you don't have an AI user but want to use the **AI user** identity, you need to create record on the User table. See Create a user. Select **AI user** as the identity type.
