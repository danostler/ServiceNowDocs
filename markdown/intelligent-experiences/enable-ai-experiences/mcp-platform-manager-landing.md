...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/intelligent-experiences/enable-ai-experiences/mcp-platform-manager-landing.html
release: australia
...
[Explore\[Omitted image "bus-explore.svg"\] Alt text:Learn about MCP Server Console.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/exploring-mcp-server-console.md)

</td><td>

[Configure\[Omitted image "bus-sdlc.svg"\] Alt text:Create an MCP server and configure its tools.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/configuring-mcp-server-console.md)

</td></tr><tr><td>

[Connect\[Omitted image "bus-integration-and-apis.svg"\] Alt text:Call an MCP server from an MCP client.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/connect-mcp-server-client.md)

</td><td>

[Reference\[Omitted image "bus-learn.svg"\] Alt text:Get details about components installed with MCP Server Console.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/mcp-server-console-reference.md)
