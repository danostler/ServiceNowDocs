...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/aia-kill-switch.html
release: zurich
...
-   **kill\_switch.mode**: Default value: **warn\_only**. For the different operating modes the property contains, see [Operating modes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/aia-kill-switch.md).
