...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/sn-ai-impl-app-readiness.html
release: zurich
...
-   [Knowledge Base readiness for Now Assist on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/sn-ai-impl-kb-readiness.md)
-   [Service Catalog readiness for Now Assist on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/sn-ai-impl-srvc-catalog.md)
-   [AI Search readiness for Now Assist on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/sn-ai-impl-ai-search.md)
-   [Now Assist in Virtual Agent readiness on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/sn-ai-impl-nava.md)

After ensuring that your AI policy, your data, and your applications are ready, you can begin to implement Now Assist.

1.  Ensure entitlement for at least one Now Assist application. For a list of available applications, see [Exploring Now Assist Admin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/exploring-now-assist-platform.md).
...
2.  In the ServiceNow Store, check version compatibilities and dependencies for Now Assist apps.
    ...
    For more information, see [Evaluating version requirements and dependencies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/versions-dependencies.md).

3.  Install Now Assist products from the Now Assist Admin console.

    For more information, see [Install Now Assist plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/install-now-assist-feature-plugins.md).
