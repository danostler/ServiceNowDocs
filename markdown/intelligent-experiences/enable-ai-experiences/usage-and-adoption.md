...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/usage-and-adoption.html
release: zurich
...
The indicators on the Usage and adoption dashboard page provide the following insights. See [Now Assist Analytics dashboard indicator details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/now-assist-analytics-dashboard-indicators.md) for information on data source and calculations behind each indicator on the page.
