...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/example-shipping-magmt-concept-ad.html
release: zurich
...
7.  Capture screens.
    ...
    2.  Select **Manual capture**.
        ...
        You can also extend the desktop action logic using the **Record with AI \(Recommended\)** or **Auto capture with recorder** options. For more information, see [Automate repetitive tasks by recording steps with AI in AI Desktop Actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/record-with-ai-ad.md) and [Automate repetitive tasks by auto-capturing steps in AI Desktop Actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/auto-create-desktop-action-ad.md).
...
For more information, see [Example: Use AI agents to automatically enter data into the shipping management app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/example-use-shipping-ai-agent-ad.md).
