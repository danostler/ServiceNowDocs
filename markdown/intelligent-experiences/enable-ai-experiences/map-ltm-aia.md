...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/intelligent-experiences/enable-ai-experiences/map-ltm-aia.html
release: australia
...
3.  In the manage long-term memory section, select categories that you want to map to your AI agent.\[Omitted image "map-ltm-category.png"\] Alt text: Select your LTM categories to map to the AI agent.
    ...
    You will see the list of categories that were created in the AI Agent Memory Categories page. For more information, see [Create long-term memory category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/create-ltm-category.md).
