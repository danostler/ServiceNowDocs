...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/goal-framework/configure-assigned-entity.html
release: zurich
...
3.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Goal Assigned Entity Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/goal-framework/goal-assigned-entity-configuration-form.md).
