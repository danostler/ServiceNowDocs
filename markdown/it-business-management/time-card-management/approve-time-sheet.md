...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/time-card-management/approve-time-sheet.html
release: zurich
...
-   If any time cards in the time sheet are pending approval by one of the approvers as defined by the [time sheet policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/create-time-sheet-policy.md), the time sheet remains in the Submitted state.
