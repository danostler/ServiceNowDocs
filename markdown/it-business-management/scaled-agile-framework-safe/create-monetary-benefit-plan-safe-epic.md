...
Non-monetary benefit that is associated to this monetary benefit plan.
    ...
    |Functional currency|Currency that is obtained from the [**glide.system.locale** property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/currency-administration/currency-properties.md).|
