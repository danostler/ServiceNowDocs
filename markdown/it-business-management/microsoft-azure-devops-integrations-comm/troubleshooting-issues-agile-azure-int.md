...
Ensure that the **Can Delete** field in the Application access of the respective tables is set to **true**.
 ...
 For details, see [Table design and runtime settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/r_TableApplicationAccessFields.md).
