...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/rate-model/rate-model.html
release: zurich
product: Rate Model
...
3.  Returns the rate if one or more rate lines match the request.
    ...
    If no rate lines match the request, then the request uses the [default rate card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/r_InstalledWithCostManagement.md).


-   **[Create or modify a rate model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/rate-model/create-rate-model.md)**  
...
-   **[Define criteria of a rate model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/rate-model/define-rate-model-criteria.md)**  
...
-   **[Create a rate line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/rate-model/create-rate-line.md)**  
In a rate model, create a rate line to define an hourly rate based on a set of criteria for a given date range.
-   **[Export rate lines to a file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/rate-model/export-rate-lines.md)**  
...
-   **[Import rate lines into a rate model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/rate-model/import-rate-lines.md)**  
