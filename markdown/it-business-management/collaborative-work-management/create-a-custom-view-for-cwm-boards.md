...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/collaborative-work-management/create-a-custom-view-for-cwm-boards.html
release: zurich
...
3.  Modify the display preferences of the Board data using the personalization settings, sorting, filtering, and adding custom columns.
    ...
    For more information, see [Personalize List, Gantt and Kanban display for CWM Boards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/collaborative-work-management/personalize-cwm-board-views.md).
