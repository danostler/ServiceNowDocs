...
3.  Create Planning Intervals for ART.
    ...
    After the PI is created, you can edit this name according to your naming convention. See [Update iteration details in EAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/enterprise-agile-planning/edit-pi-sprint-iteration-details-in-eap.md).
...
4.  Create Sprints for Agile Teams.
    ...
    After the Sprint is created, you can edit this name according to your naming convention. See [Update iteration details in EAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/enterprise-agile-planning/edit-pi-sprint-iteration-details-in-eap.md).
