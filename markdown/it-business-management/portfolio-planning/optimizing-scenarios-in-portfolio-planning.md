...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/portfolio-planning/optimizing-scenarios-in-portfolio-planning.html
release: zurich
...
|Feature|Description|
|-------|-----------|
|[Create a scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/portfolio-planning/create-a-scenario-in-portfolio-planning.md)|Create a scenario from the current plan, or another scenario, in a simulated environment to compare the scenario with the live plan and other scenarios.|
|[Compare scenarios](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/portfolio-planning/compare-scenarios-in-portfolio-planning.md)|Compare scenarios and the live plan side by side to review tradeoffs and items added or removed from the plans.|
|[Approve a scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/portfolio-planning/approve-a-scenario-in-portfolio-planning.md)|Approve the best scenario.|
|[Manage scenarios](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/portfolio-planning/manage-scenarios-in-portfolio-planning.md)|View list of scenarios, rename scenarios, and delete scenarios.|
