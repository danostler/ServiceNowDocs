...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/cost-management/r\_CostManagement.html
release: zurich
...
-   **[Cost Management Demo Data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/c_CostManagementDemoData.md)**  
The demo data available with Cost Management provides samples of the data types to illustrate its use.
-   **[Cost overview module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/c_CostOverviewModule.md)**  
The Cost Overview module displays various cost management reports.
-   **[CI rate cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/c_CIRateCards.md)**  
...
-   **[Task and labor rate cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/c_TaskAndLaborRateCards.md)**  
...
-   **[Using distribution costs and rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/r_UsingDistributionCostsAndRules.md)**  
Distribution Costs are costs which can be divided among a group of records.
-   **[Use business services with expenses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/c_UseBusinessServicesWithExpenses.md)**  
Manage the relationships between business services and their expenses with allocation units and cost centers.
-   **[Cost sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/c_CostSources.md)**  
There are a several ways to generate expense lines for objects in the system.
-   **[CI relationships](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/t_CIRelationships.md)**  
...
-   **[Allocating expenses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/c_AllocatingExpenses.md)**  
Expenses can also be allocated to a business entity that is responsible for the expense.
-   **[Budget related records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/c_BudgetRelatedRecords.md)**  
Budgets are related to additional records, displayed as related lists on its form.
-   **[Domain separation and Cost Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/cost-management/domain-separation-cost-management.md)**  
