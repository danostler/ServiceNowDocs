...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/ppm-collaboration/t\_SDLCPPSCreateStories.html
release: zurich
...
3.  From the Stories related list, select one of the following:
    ...
    -   **New** to create a story and add it to this project.
        ...
        For information on the form fields, see the descriptions in [Story form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/create-a-story.md).
...
-   Create scrum tasks for this story. See [Create a scrum task for Agile Development 2.0 stories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/create-a-scrum-task.md).
