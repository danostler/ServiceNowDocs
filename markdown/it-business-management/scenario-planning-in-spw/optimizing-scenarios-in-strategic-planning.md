...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/scenario-planning-in-spw/optimizing-scenarios-in-strategic-planning.html
release: zurich
...
|Feature|Description|
|-------|-----------|
|[Create a scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/create-a-scenario-in-strategic-planning.md)|Create a scenario from the current plan, or another scenario, in a simulated environment to compare the scenario with the live plan and other scenarios.|
|[Compare scenarios](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/compare-scenarios-in-strategic-planning.md)|Compare scenarios and the live plan side by side to review tradeoffs and items added or removed from the plans.|
|[Approve a scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/approve-a-scenario-in-strategic-planning.md)|Approve the best scenario.|
|[Manage scenarios](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/manage-scenarios-in-strategic-planning.md)|View list of scenarios, rename scenarios, and delete scenarios.|
