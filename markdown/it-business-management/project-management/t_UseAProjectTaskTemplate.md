...
You must have a template from an existing project task that has the required field values. See [Templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/c_Templates.md) for more information on this platform feature.
