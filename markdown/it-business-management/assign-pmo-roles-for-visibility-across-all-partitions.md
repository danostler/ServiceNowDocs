...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/assign-pmo-roles-for-visibility-across-all-partitions.html
release: zurich
topic_type: task
...
For more information on roles installed with Enterprise-Wide Deployment, see the Roles table in [Components installed with Enterprise-Wide Deployment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/components-installed-with-ewd.md).
