...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/platform-encryption/module\_access\_policy\_overview.html
release: zurich
...
-   Resource Exchange
    ...
    **Note:** See [Key Management Framework Resource Exchange](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/platform-encryption/resource-exchange.md) for details.
...
Refer to [Create a module access policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/platform-encryption/create-module-access-policy.md) for setup.
