...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/use-vault-guided-setup.html
release: zurich
topic_type: task
...
7.  You can select **Available** to begin applying that columns respective application data protection policy, review [Vault tools and metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/vault-tools.md) for more information.
...
The select application now has classified data and protection policies. As well, it will now report relevant metrics to the [ServiceNow Vault console dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/vault-dashboard.md).

**Parent Topic:**[Configuring ServiceNow Vault](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/configuring-servicenow-vault.md)
