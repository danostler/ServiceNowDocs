...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/sa-code-signing-tool.html
release: zurich
topic_type: concept
...
-   **[Using the Signing Tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/use-sa-signing-tool.md)**  
Learn how to use the Signing Tool to sign supported records in ServiceNow applications.
-   **[Signing Tool arguments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/sa-signing-tool-reference.md)**  
