...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/cse-upload-cs-config.html
release: zurich
topic_type: task
...
You also need the configuration file generated in the steps detailed in [Configure Code Signing Enterprise on your trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/cse-turn-on-cse.md).
