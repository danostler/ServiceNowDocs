...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/sign-specific-records.html
release: zurich
topic_type: concept
...
2.  In the trusted instance, create a signing job to sign the record. This process is detailed in [Create a job to sign specific records or attachments on a trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/sign-files-nonprod.md).
...
-   **[Create a job to sign specific records or attachments on a trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/sign-files-nonprod.md)**  
Sign a specific record, or group of records you define on a trusted instance.

**Parent Topic:**[Using Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/using-code-signing.md)
