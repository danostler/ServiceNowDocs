...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/data-discovery/dds-create-granular-job.html
release: zurich
...
A granular scan is scheduled to run on the target table and column, after it executes you can [review the scan findings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/data-discovery/dds-review-granular-findings.md).
