...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/data-discovery/dds-create-new-data-pattern.html
release: zurich
...
The new data pattern must be set as active to be used in discovery jobs. See [Select active data patterns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/data-discovery/dds-active-data-patterns.md) for more information.
