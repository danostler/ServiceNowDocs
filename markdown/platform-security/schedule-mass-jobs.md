...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/schedule-mass-jobs.html
release: zurich
topic_type: task
...
Mass encryption and decryption is also available from the Encrypted Field Configurations form. See [Run mass encryption or decryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/mass-enc-dec.md) for instructions.
