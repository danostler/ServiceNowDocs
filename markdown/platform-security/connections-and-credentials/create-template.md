...
<table id="choicetable_brl_cpl_1jb"><thead><tr><th align="left" id="d55023e77">

Configuration type

</th><th align="left" id="d55023e80">

Description

</th></tr></thead><tbody><tr><td id="d55023e86">
...
```
 ...
 For more information on how to use dot-walking, see [Dot-walking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/c_DotWalking.md).
