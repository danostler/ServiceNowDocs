...
For more information about building custom Workflow Studio actions, see [Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/workflow-studio/actions.md).
...
4.  Define the attribute label and field type.
    ...
    For a list of field types, see [field types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/r_FieldTypes.md).

5.  Click the Advanced view related link to set advanced dictionary preferences for the attribute.

    For example, to create an attribute with a dynamically calculated value. See [Dictionary entry form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/table-administration-and-data-management/r_DictionaryEntryForm.md).
