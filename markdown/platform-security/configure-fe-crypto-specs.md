...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/configure-fe-crypto-specs.html
release: zurich
topic_type: task
...
For customer-supplied key configuration, see [Configure Customer-supplied keys for Field Encryption Enterprise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/fe-config-customer-supplied-keys.md).
...
For information on using a customer supplied key, see [Configure Customer-supplied keys for Field Encryption Enterprise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/fe-config-customer-supplied-keys.md).
