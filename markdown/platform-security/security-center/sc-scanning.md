...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/security-center/sc-scanning.html
release: zurich
...
-   **[Scan findings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/security-center/scan-findings.md)**  
...
-   **[Security scan comparison](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/security-center/score-comparison.md)**  
...
-   **[Auditor suite findings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/security-center/sc-auditor-finding.md)**  
Review Security Center Auditor suite findings over time.
-   **[Scan checks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/security-center/scan-checks.md)**  
Use checks to detect anomalies within an instance, running against tables, records, or metadata.
-   **[Scan suites](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/security-center/sec-center-suites.md)**  
Review details on the scan suites available on your instance.
-   **[Scan results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/security-center/scan-results.md)**  
