...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/wrap-your-customer-supplied-key.html
release: zurich
...
2.  Open a field encryption module that you’ve previously created.
    ...
    **Note:** If you haven't created a field encryption module yet, you can create one using the steps in [Configure Field Encryption modules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/configure-fe-modules.md).
...
5.  Verify that the **Origin** field has a value of **Upload customer supplied key**.
    ...
    If that value can't be selected, refer to steps 3–5 in [Configure Customer-supplied keys for Field Encryption Enterprise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/fe-config-customer-supplied-keys.md).
...
Now that your key is wrapped, you can upload it to your instance using the procedure in [Upload your customer-supplied key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/upload-your-customer-supplied-key.md).
