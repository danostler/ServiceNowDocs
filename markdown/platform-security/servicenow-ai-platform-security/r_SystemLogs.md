...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/r\_SystemLogs.html
release: zurich
...
The severity classification of the message. Levels indicate the nature of the event, not necessarily whether action is required. Messages are generated by the ServiceNow platform, installed applications, and custom scripts. The levels are Debug, Error, Warning, and Information. -   Debug: Detailed diagnostic information, typically used during development or active troubleshooting.
