...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/instance-sec-center-export-metrics.html
release: zurich
...
-   **[Export metrics settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/isc-export-metrics-settings.md)**  
Use the configuration options in the Settings tab to narrow down reporting results.

**Parent Topic:**[Monitor instance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/monitoring-user-email-antivirus-metrics.md)
