...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/cs-rest-soap.html
release: zurich
...
-   **[Sign the existing REST and SOAP messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/rest-soap-code-sign.md)**  
Sign and validate the existing REST and SOAP messages by enabling the Code Signing in protected and trusted instances.
-   **[Sign new REST and SOAP messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/cs-new-rest-soap.md)**  
