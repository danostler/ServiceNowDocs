...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/multi-module-fe-config.html
release: zurich
...
2.  Confirm that you have the field encryption modules you want to use created.
    ...
    If you have not done so, see [Configure Field Encryption modules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/configure-fe-modules.md).

3.  Confirm that each of your modules has a module access policy.

    If you have not done so, see [Configure module access policies for field encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/maps-for-fe.md).
