...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/isc-export-metrics-settings.html
release: zurich
...
For more detail on data classifications, see [Data classifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/data-classification/data-classification.md)
...
**Parent Topic:**[Export metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/instance-sec-center-export-metrics.md)
