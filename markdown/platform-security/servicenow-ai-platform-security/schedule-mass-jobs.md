...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/servicenow-ai-platform-security/schedule-mass-jobs.html
release: australia
...
Mass encryption and decryption is also available from the Encrypted Field Configurations form. See [Run mass encryption or decryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/servicenow-ai-platform-security/mass-enc-dec.md) for instructions.
