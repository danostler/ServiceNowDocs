...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/t\_ConSysTablDelAud.html
release: zurich
...
4.  Select **Save**.
    ...
    **Note:** For more information about auditing, see [Understanding the sys audit Table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/c_UnderstandingTheSysAuditTable.md).
