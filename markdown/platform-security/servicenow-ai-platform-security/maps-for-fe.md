...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/maps-for-fe.html
release: zurich
...
You must have a published field encryption module to use this process. If you have not done so, see [Configure Field Encryption modules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/configure-fe-modules.md).
...
MAPs are separate from access control lists \(ACL\), but can be used in combination with them. See [Exploring Field Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/exploring-fe.md) for more information about the purpose behind MAPs.
...
For more information on how these different types of MAP work, see [Exploring Field Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-ai-platform-security/exploring-fe.md).
