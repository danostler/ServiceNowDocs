...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/servicenow-ai-platform-security/column-level-encryption-enterprise-walkthrough-2.html
release: australia
