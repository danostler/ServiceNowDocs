...
Inbound emails are scanned for viruses by the system [email filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/c_EmailFilters.md), not by Antivirus Scanning.
