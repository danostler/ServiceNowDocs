...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/servicenow-ai-platform-security/configure-idp-session-access.html
release: zurich
...
3.  For removing any role for the user, on the form, fill the fields:
    ...
    3.  Choose the **Policy**.
        ...
        To know more on how to create policy using different filter criteria using Adaptive Authentication policy creation, see [Filter criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/authentication/adaptive-auth-filter-criteria.md).
    ...
    5.  In the Policy Input, create the Policy Input and Policy Condition.
        ...
        For more information on how to create Post Authentication Context's Policy with Policy inputs and Condition, see [Post-authentication context](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/authentication/post-auth-context.md).
