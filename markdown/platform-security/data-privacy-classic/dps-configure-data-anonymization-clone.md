...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/data-privacy-classic/dps-configure-data-anonymization-clone.html
release: zurich
...
The data privacy PostClone script is installed with the activation of the data privacy plugin \(sn\_dp\_store\_app\). See [Activate data privacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/data-privacy-classic/dps-activate-data-privacy.md) for details.
...
4.  Select **Create new policy**.
    ...
    See [Create anonymization policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/data-privacy-classic/dps-create-anonymization-policies.md) for details.
...
13. Schedule the anonymization job.
    ...
    See [Create anonymization job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/data-privacy-classic/dps-create-anonymization-job.md)for details.
