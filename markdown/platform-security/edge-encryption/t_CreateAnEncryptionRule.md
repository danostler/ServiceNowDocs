...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/edge-encryption/t\_CreateAnEncryptionRule.html
release: zurich
...
Before creating an encryption rule, you must [Inspect the client request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/request-type.md) to determine the format.
