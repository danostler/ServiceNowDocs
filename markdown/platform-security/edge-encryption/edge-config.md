...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/edge-encryption/edge-config.html
release: zurich
...
You must complete all the steps in [Installing Edge Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/c_InstallEdgeEncryptionProxy.md) before creating encryption configurations and encryption patterns on the instance.
...
-   **[Rotate encryption keys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/c_EncryptionKeyRotation.md)**  
...
-   **[Encrypt attachments using standard encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/c_EncryptingAttachments.md)**  
You can encrypt attachments for specific tables.
-   **[Change a field or attachment's encryption type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/t_ChangeAFieldsEncryptionType.md)**  
...
-   **[Repair or recover order-preserving encrypted data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/c_EdgeEncryptionJobs.md)**  
...
-   **[Configure the IP address deny list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/deny-list-IPs.md)**  
Prevent an IP address in your network from sending requests to your instance
-   **[Encrypt data from a record producer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/record-producers-edge.md)**  
...
-   **[Define a custom encryption rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/c_EncryptionRules.md)**  
...
-   **[Edge Encryption dictionary attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/r_EdgeEncryptionDictAttributes.md)**  
Add dictionary attributes to tables and fields to control how they work with Edge Encryption.
-   **[Domain separation and Edge Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/edge-encryption-domain-separation.md)**  
...
-   **[Data integration with Edge Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/data-integration.md)**  
...
-   **[Edge Encryption diagnostics and performance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/edge-stats.md)**  
...
-   **[Increase debug logging for the Edge Encryption proxy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/edge-debug-logging.md)**  
