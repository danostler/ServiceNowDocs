...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/edge-encryption/install-proxy.html
release: zurich
...
1.  [Download the Edge Encryption proxy server installer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/t_DownloadtheProxy.md).
...
**Previous topic:**[Install the Edge Encryption proxy server using the interactive installer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/proxy-installer.md)

**Next topic:**[Configure CyberArk properties protection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/edge-encryption/configure-cyberark-prop-protection.md)
