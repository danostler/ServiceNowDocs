...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/upload-your-customer-supplied-key.html
release: zurich
topic_type: task
...
**Note:** If you don't want to supply your own key, you can use the steps in [Configure Field Encryption modules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/configure-fe-modules.md) to use a ServiceNow. You cannot revoke a customer supplied key.
...
5.  Verify that the **Origin** field has a value of **Upload customer supplied key**.
    ...
    If it doesn’t, and you don’t can choose that value, please refer to steps 3–5 in [Configure Customer-supplied keys for Field Encryption Enterprise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/fe-config-customer-supplied-keys.md).
