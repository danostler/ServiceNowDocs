...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/les-multi-topics-v2.html
release: zurich
topic_type: task
...
**Parent Topic:**[Create a log source configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/les-create-source-configuration.md)
