...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/bp-domain-sep-recommended.html
release: zurich
...
-   **[Domain separation explained](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-what-is-domain-separation.md)**  
...
-   **[Domain separation hierarchies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-sep-hierarchies.md)**  
...
-   **[Segregating and securing data with domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-segregate-secure.md)**  
You can segregate and secure data on the ServiceNow platform in multiple ways, depending on your customer's needs. 
-   **[Alternatives to domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-separation-alternatives.md)**  
...
-   **[Evaluating the need for domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-evaluation-dom-sep.md)**  
...
-   **[Benefits of domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-advantages-dom-sep.md)**  
...
-   **[How a database query works with domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-db-query-with-ds.md)**  
...
-   **[Domain separation levels of support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-levels.md)**  
...
-   **[Domain separation terms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-terms-conditions.md)**  
...
-   **[Domain-separate a custom table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-ds-custom-table.md)**  
...
-   **[Customizing domain properties and themes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-prop-themes.md)**  
...
-   **[Managing domain separation for specific uses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-emails-catalog-users.md)**  
...
-   **[Configuring domain separation with the domain picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-picker-config-process.md)**  
...
-   **[Domain separation performance considerations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-performance-considerations.md)**  
...
-   **[Setting up domain hierarchies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-hierarchy.md)**  
...
-   **[Checking domain logs for errors and warnings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-logs.md)**  
Check the domain logs to find errors or warnings in your domain path processes and hierarchy configurations.
-   **[Importance of the Default domain](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-default-domain.md)**  
...
-   **[Domain paths query method](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-query-method.md)**  
You can create effective queries with domain paths.
-   **[Slow queries and SQL debugging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-debug-sql.md)**  
Debugging SQL and slow queries can help you resolve slowness issues in an instance.
-   **[Before Query business rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-before-query-business-rules.md)**  
...
-   **[Avoiding domain path in scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-no-domain-path-in-scripts.md)**  
Domain paths can cause the values of your script to change or even break, so don't use them in scripts.
-   **[Domain assignments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-assignment.md)**  
...
-   **[Domain separation and the Customer Service Management \(CSM\) plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-ds-and-csm.md)**  
