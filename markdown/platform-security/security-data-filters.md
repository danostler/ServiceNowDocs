...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/security-data-filters.html
release: zurich
topic_type: concept
...
**Note:** Pair security data filters with [Deny-Unless ACL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/access-control/acl-denial-behavior.md) to ensure consistent security
...
-   Security data filters are not checked by `canRead`. See [When to use security data filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/security-data-filters.md) for more details
