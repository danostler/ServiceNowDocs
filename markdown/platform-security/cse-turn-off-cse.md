...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/cse-turn-off-cse.html
release: zurich
topic_type: task
...
8.  Upload your configuration files using the steps in [Upload your Code Signing configuration file to your protected instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/cse-upload-cs-config.md).
