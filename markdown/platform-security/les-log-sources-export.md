...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/les-log-sources-export.html
release: zurich
topic_type: concept
...
See [System logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/system-logs.md) to learn more about the schema and purpose for the above log sources.
...
**Parent Topic:**[Exploring Log Export Service \(LES\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/les-landing-page.md)
