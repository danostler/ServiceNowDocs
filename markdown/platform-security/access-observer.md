...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/access-observer.html
release: zurich
topic_type: concept
...
-   **[Configure access observation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/config-access-observation.md)**  
Create an access observation record to review access to a data column during a specified time window.
-   **[Review Access Observer logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/review-access-obs-logs.md)**  
