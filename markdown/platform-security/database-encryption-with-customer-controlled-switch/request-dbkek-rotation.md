...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/database-encryption-with-customer-controlled-switch/request-dbkek-rotation.html
release: zurich
