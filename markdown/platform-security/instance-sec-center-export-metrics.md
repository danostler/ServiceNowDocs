...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/instance-sec-center-export-metrics.html
release: zurich
topic_type: concept
...
-   **[Export metrics settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/isc-export-metrics-settings.md)**  
