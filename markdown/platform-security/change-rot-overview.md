...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/change-rot-overview.html
release: zurich
topic_type: concept
...
Learn more about these steps in [Migrate signatures to use a customer certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/migrate-sigs-customer-rot.md) and [Disable ServiceNow Root of Trust](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/disable-sn-rot.md).
...
-   **[Migrate signatures to use a customer certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/migrate-sigs-customer-rot.md)**  
Run a signing job to migrate your signatures to a customer Root of Trust \(ROT\).
-   **[Disable ServiceNow Root of Trust](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/disable-sn-rot.md)**  
