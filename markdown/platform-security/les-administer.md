...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/les-administer.html
release: zurich
topic_type: concept
...
-   **[Create a log source configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/les-create-source-configuration.md)**  
Regulate and set filters on the logs to be forwarded by creating a log source configuration.
-   **[Update system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/update-system-property.md)**  
