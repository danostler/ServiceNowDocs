...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/isc-export-metrics-settings.html
release: zurich
topic_type: concept
...
**Parent Topic:**[Export metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/instance-sec-center-export-metrics.md)
