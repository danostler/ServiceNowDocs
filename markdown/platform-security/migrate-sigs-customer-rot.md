...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/migrate-sigs-customer-rot.html
release: zurich
topic_type: task
...
To continue the Root of Trust configuration process, see [Disable ServiceNow Root of Trust](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/disable-sn-rot.md).
