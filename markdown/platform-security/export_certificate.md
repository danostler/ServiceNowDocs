...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/export\_certificate.html
release: zurich
topic_type: task
...
The export process downloads an XML file to your local machine for use in the steps detailed in [Configure Code Signing Enterprise on your protected instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/cse-ppi-config.md).

**Parent Topic:**[Quorum Controlled Certificate Revocation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/certificate-revocation.md)
