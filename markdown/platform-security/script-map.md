...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/script-map.html
release: zurich
topic_type: concept
...
-   **[Configure script access to encrypted data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/configure-script-encryption.md)**  
