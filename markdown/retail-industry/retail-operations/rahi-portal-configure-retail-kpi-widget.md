...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/retail-industry/retail-operations/rahi-portal-configure-retail-kpi-widget.html
release: australia
...
The Retail Core \[com.sn\_retail\_core\] plugin must be activated. For more information, see [Activate Retail Core](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/retail-industry/retail-operations/rahi-retail-operations-install.md).
...
11. On the instance options page, in the  **Data ** field, paste the following JSON code to configure the lists.
    ...
    **Note:**
    ...
    For more information, see [Retail KPI JSON parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/retail-industry/retail-operations/retail-kpi-json-parameters.md).
