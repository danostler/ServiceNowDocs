...
The Notify \(com.snc.notify\) plugin requires a separate subscription. For additional information on activating the Notify plugin, see [Activate Notify](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/notify/t_ActivateNotify.md).
