...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/event\_open-api.html
release: zurich
product: REST APIs
