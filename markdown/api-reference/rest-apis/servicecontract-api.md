...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/servicecontract-api.html
release: zurich
product: REST APIs
...
Before using this API, you should have associated data in the following tables. For additional information, see [Create service contracts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/create-csm-service-contracts.md).
...
List of install base items covered under the service contract.For more information on Install Base Items [Configure Install base](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/configure-install-base.md).
