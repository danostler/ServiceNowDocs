...
For additional information on snapshots, see [View snapshots](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-service-management/devops-family/cdm-snapshots-view-list.md).
...
Flag that indicates whether to follow the variables. For information on following the variables, see [Validating and correcting configuration data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-service-management/devops-family/cdm-validating-cfg-data.md).Valid values:
