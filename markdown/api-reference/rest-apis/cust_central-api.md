...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/cust\_central-api.html
release: zurich
product: REST APIs
...
For additional information, see [Customer Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/customer-central.md).
...
You must define any additional configuration records that you need through the Customer Central interface. For details, see [Configure customer central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/configure-customer-central.md).
