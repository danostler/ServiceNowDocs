...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/api-implementation-reference.html
release: zurich
topic_type: concept
...
[API implementation \[Omitted image "bus-integration-and-apis.svg"\] Alt text: Set up Web Services to access ServiceNow APIs.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/api-implementation.md)

</td><td>

[API reference \[Omitted image "bus-learn.svg"\] Alt text: Find reference documentation for Client, Server, and REST APIs.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/api-reference.md)

</td><td>

[Developer guides \[Omitted image "bus-application-developer.svg"\] Alt text: Explore program resources for learning, building, and developing.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/developer-guides/developer-guides.md)
