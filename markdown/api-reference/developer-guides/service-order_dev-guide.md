...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/developer-guides/service-order\_dev-guide.html
release: zurich
...
This developer guide provides information on how to extend the [Service Order Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/service-order-open-api.md) to make various customizations.
