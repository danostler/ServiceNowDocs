...
1.  If not already configured, configure your ServiceNow instance as an OAuth JWT provider.
    ...
    For details, see [Create an OAuth JWT API endpoint for external clients \(machine to machine integration\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/authentication/create-jwt-endpoint.md).
...
3.  Select **New** and then create a new public certificate as shown in the following image.
    ...
    For details on creating this certificate, see [Update your X.509 certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/security-management/security-operations/update-cert-whois.md).
