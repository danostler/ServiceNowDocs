...
1.  Navigate to the Mobile SDK page on the ServiceNow Store web site.
    ...
    For details, see [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/t_InstallApplications.md).
