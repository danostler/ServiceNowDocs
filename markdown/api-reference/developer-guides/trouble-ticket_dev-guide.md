...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/developer-guides/trouble-ticket\_dev-guide.html
release: zurich
...
This developer guide provides information on how to extend the [Trouble Ticket Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/trouble-ticket-open-api.md) to make various customizations.
