...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/cllent-mobile-api-reference/NowChatServiceDelegateiOSProtocol.html
release: zurich
...
|----|----|-----------|
|chatService|[NowChatService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/cllent-mobile-api-reference/NowChatServiceiOSAPI.md)|NowChatService object making the request.|
...
|Name|Type|Description|
|----|----|-----------|
|chatService|[NowChatService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/cllent-mobile-api-reference/NowChatServiceiOSAPI.md)|NowChatService object whose view controller was dismissed.|
