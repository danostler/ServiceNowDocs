...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/server-api-reference/ProducerScopedAPI.html
release: zurich
...
**Note:** This API is deprecated and replaced by the [ProducerV2 - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/server-api-reference/ProducerV2ScopedAPI.md) API.
