...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/server-api-reference/c\_DiscoveryAPIScopedAPI.html
release: zurich
...
|Type|Description|
|----|-----------|
|array|JavaScript array of immutable [ReportCiStatusOutputJS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/server-api-reference/c_ReportCiStatusOutputJSScopedAPI.md) objects.|
