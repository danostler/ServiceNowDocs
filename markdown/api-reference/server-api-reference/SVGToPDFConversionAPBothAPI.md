...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/server-api-reference/SVGToPDFConversionAPBothAPI.html
release: zurich
...
See also [PDFGenerationAPI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/server-api-reference/PDFGenerationAPIBothAPI.md).
