...
Enables generating objects at the start of a workflow in a **pending** state. For related information, see [Generate workflow activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/workflow-activities/r_Generate.md).
