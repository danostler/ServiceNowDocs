...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/server-api-reference/CSBScratchpadUtilScopedAPI.html
release: zurich
