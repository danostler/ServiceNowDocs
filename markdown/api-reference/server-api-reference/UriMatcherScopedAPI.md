...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/server-api-reference/UriMatcherScopedAPI.html
release: zurich
...
|----|-----------|
|[UriMatcherResponse](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/server-api-reference/UriMatcherResponseScopedAPI.md)|UriMatcherResponse object with methods for returning detailed information about the match.|
