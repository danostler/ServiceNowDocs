...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/server-api-reference/NotifyJsTelephonyDriverAPI.html
release: zurich
...
For additional information on scripted extension points, see [Using extension points to extend application functionality point](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/extension-points.md).
...
|Name|Type|Description|
|----|----|-----------|
|participantRecord|[GlideRecord - Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/server-api-reference/c_GlideRecordAPI.md)|GlideRecord object containing the Notify Participant \[notify\_participant\] record of the caller to mute in the conference call.|
