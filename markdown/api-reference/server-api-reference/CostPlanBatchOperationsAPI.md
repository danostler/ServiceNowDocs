...
Once processed, the cost plans are inserted into the specified project or demand. You can then view and modify them within your instance. For additional information, see [Create a project cost plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-business-management/project-management/t_CreateAProjectCostPlan.md) and [Create a demand cost plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-business-management/demand-management/t_CreateADemandCostPlan.md).
