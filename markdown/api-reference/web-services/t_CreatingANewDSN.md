...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/t\_CreatingANewDSN.html
release: zurich
...
Instead of creating a new DSN, you can [Specify a connection string](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/specify-connection-string.md) to connect with different instance URLs.
