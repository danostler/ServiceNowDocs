...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/c\_OAuthProviderAndScope.html
release: zurich
...
|`oauth_provider_profile`|The sys\_id of the OAuth profile record that is the default \(see [Specify an OAuth profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/t_SpecifyAnOAuthProfile.md)\).|
...
-   **[Specify an OAuth profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/t_SpecifyAnOAuthProfile.md)**  
...
-   **[Specify an OAuth scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/t_SpecifyAnOAuthScope.md)**  
...
**Parent Topic:**[Use a third-party OAuth provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/t_UseAThirdPartyOAuthProvider.md)
