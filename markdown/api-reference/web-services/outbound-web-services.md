...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/outbound-web-services.html
release: zurich
...
-   **[Outbound web services: Logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/outbound-request-logging.md)**  
Log requests and responses for outbound web services such as REST and SOAP.
-   **[Outbound web service mutual authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_OutboundWebServicesMutualAuth.md)**  
