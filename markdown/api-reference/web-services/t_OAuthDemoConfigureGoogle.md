...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/t\_OAuthDemoConfigureGoogle.html
release: zurich
...
**Parent Topic:**[Outbound REST with OAuth 2.0 profile tutorial - integrating with Google Contacts API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_OAuth2ProfileTutorialGoogle.md)

**Previous topic:**[Outbound REST with OAuth 2.0 profile tutorial - integrating with Google Contacts API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_OAuth2ProfileTutorialGoogle.md)

**Next topic:**[OAuth 2.0 tutorial - create an OAuth provider and profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/t_OAuthDemoCreateProvider.md)
