...
-   Role required: admin
-   [Uploading a certificate to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/servicenow-ai-platform-security/t_UploadACertificateToAnInstance.md) to authenticate the client certificate of the instance.
-   [Uploading a trusted server certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/servicenow-ai-platform-security/t_UploadATrustedServerCertificate.md) to authenticate the server certificate of the web service provider.
