...
[Explore \[Omitted image "bus-explore.svg"\] Alt text: Learn about SQL API feature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/getting-started-with-servicenow-sql-api.md)

</td><td>

[Configure \[Omitted image "bus-sdlc.svg"\] Alt text: Install and setup SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/configuring-sql-api.md)

</td></tr><tr><td>

[Integrate \[Omitted image "bus-integration-and-apis.svg"\] Alt text: Integrate SQL API drivers with external business intelligence and database tools](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/configure-drivers-bi-tools.md)

</td><td>

[Reference \[Omitted image "bus-learn.svg"\] Alt text: Get reference information about SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/troubleshooting.md)

</td></tr></tbody>
</table>-   **[Getting started with ServiceNow SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/getting-started-with-servicenow-sql-api.md)**  
...
-   **[Integrate SQL API Drivers with third-party BI tools](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/configure-drivers-bi-tools.md)**  
