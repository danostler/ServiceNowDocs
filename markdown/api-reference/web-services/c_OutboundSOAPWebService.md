...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/c\_OutboundSOAPWebService.html
release: zurich
...
-   **[Outbound SOAP video tutorial](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/r_OutboundSOAPVideoTutorial.md)**  
...
-   **[SOAP message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_SOAPMessage.md)**  
Information needed to send SOAP requests is stored in SOAP message records.
-   **[Connectivity details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_ConnectivityDetails.md)**  
...
-   **[Outbound SOAP security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_OutboundSOAPSecurity.md)**  
You can authenticate outbound SOAP messages using several different security protocols.
-   **[Configure SOAP with a proxy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/r_ConfigureSOAPWithAProxy.md)**  
Certain properties provide support for SOAP requests to use a web proxy server.
-   **[Scripting outbound SOAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/r_ScriptingOutboundSOAP.md)**  
