...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/c\_JAAWbSrvcsClntEx.html
release: zurich
...
-   **[Java Apache Axis2 web services client examples insert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_JAAWbSrvcsClntExInst.md)**  
An example class to insert an incident record.
-   **[Java Apache Axis2 web services client examples update](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_JAAWbSrvcsClntExUpdt.md)**  
...
-   **[Java Apache Axis2 web services client examples advanced](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_JAAWbSrvcsClntExAdv.md)**  
