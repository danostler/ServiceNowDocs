...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/scripted-extension-points.html
release: zurich
...
**Note:** For an example of a scripted extension point and to learn more about this process, see [Using extension points to extend application functionality](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/extension-points.md).
