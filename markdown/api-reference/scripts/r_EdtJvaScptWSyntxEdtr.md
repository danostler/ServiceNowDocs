...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/scripts/r\_EdtJvaScptWSyntxEdtr.html
release: zurich
product: Scripts
...
-   **[Syntax editor keyboard shortcuts and actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/r_SyntxEdtrKybrdSrtctsActn.md)**  
The syntax editor offers keyboard shortcuts and actions to assist in writing code.
-   **[JavaScript syntax editor macros](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/r_SyntaxEditorMacros.md)**  
...
-   **[Context menu in the syntax editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/context-menu-syntax-editor.md)**  
View the context menu for script includes, Glide APIs, and tables in the JavaScript syntax editor.
-   **[Syntax errors and warnings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_ScriptSyntaxErrorChecking.md)**  
