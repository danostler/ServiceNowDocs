...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/healthcare-and-life-sciences/ctwm-task-plan-templates-understand.html
release: zurich
...
For information about how task plan templates work, see [Task Plan Templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/task-plan-templates.md).
...
For more information, see [Create a task plan template configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/task_plan_template_configurations.md).

You can create one or more template items, such as a task or record, for a task plan template. When the task plan template is applied, these records are automatically created. For more information, see [Create a template item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/create-task-plan-template-item.md).
