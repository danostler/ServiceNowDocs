...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/healthcare-and-life-sciences/cto-mobile-asset-scan.html
release: zurich
...
For more detailed information on scanning an asset to create a support request, see [Scan an asset to create a support request in Care Team Mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences/cto-mobile-create-request-asset-scan.md).
