...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/healthcare-and-life-sciences/hco-example-create-hospital.html
release: zurich
...
3.  Fill in the following fields.
    ...
    -   Parent organization - Enter the parent organization created in [Example - Create a parent organization \(HQ\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences/hco-example-create-parent-organization.md). **Alectri Health**.
4.  Select **Submit**.
