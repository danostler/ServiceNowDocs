...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/healthcare-and-life-sciences/hco-example-create-department.html
release: zurich
...
3.  Fill in the following fields.
    ...
    -   Parent organization - Select the parent hospital created in [Example - Create a hospital](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences/hco-example-create-hospital.md), **Alectri Santa Clara**.
4.  Select **Submit**.
