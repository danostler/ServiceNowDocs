...
Alternatively, you can create a checklist using the Checklist formatter. For more information, see [Create a checklist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/t_CreateAChecklist.md).
