...
-   Add the user who is conducting the training task to the Nurse Training Support assignment group.
    ...
    For more information, see [Assign a role to a group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/user-administration/t_AssignRoleToGroup.md).
