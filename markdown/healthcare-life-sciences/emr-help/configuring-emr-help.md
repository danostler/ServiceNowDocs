...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/emr-help/configuring-emr-help.html
release: zurich
product: EMR Help
...
-   [Install EMR Help](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/install-emr-help.md).

    Install the EMR Help application to integrate your ServiceNow instance with an EMR system.

-   [Configure the data table for a request type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/emr-config-example.md).
    ...
    For more information, see [EMR Help data model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/emr-data-model.md).

-   [Configure request parameters for EMR systems](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/configure-emr-help-req-parm.md).

    Configure the remote request parameters for an EMR system.

-   [Configure request definitions for EMR systems](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/configure-emr-help-req-def.md).
...
-   [Assign roles for EMR Help users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/assign-emr-help-roles.md).

    Assign roles to control access to features, capabilities, and data in the EMR Help application.

-   [Configure healthcare case types for EMR Help](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/configure-hcls-case-types-for-emr-help.md).
...
-   [Configure digest token authentication for EMR Help](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/configure-digest-token-authentication-for-emr-help.md).

    Configure ServiceNow single sign-on with Epic utilizing digest token authentication.

-   [Configure iFrame support for EMR Help in ServiceNow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/configure-iframe-support.md)

    Configure EMR Help to launch within a frame in Epic Hyperspace and Hyperdrive.

-   [Configure the EMR session info contextual sidebar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/configure-the-emr-session-info-contextual-sidebar.md).

    Configure the EMR session info contextual sidebar in Workspace to manage the fields that display there.

-   [Configuring the EMR Help service portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/config-emr-help-sp.md).

    As an administrator, you can set up the EMR Help service portal for submitting IT service requests from an EMR system.

-   [Set up the IT service request fulfillment process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/emr-help-remote-req-fulfillment.md)
...
-   \(Optional\) [Implement encryption in EMR Help](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/emr-help-encryption-support.md).

    Encrypt fields, attachments, or both to secure your EMR system data.

-   \(Optional\) [Customize the URL and REST API task parameters for EMR systems](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/emr-help/emr-help-custom.md).
