...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.html
release: zurich
...
-   [Dosage specifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.md)
-   [Dosage characteristics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.md)
-   [Dosage characteristic groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.md)

To learn about how dosage components are linked to each other, see [Dosage characteristics mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.md).

## Dosage specifications

A dosage specification consists of diagnosis details and dosage characteristics of a medication product associated with a program. For more information, see [Dosage specification table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-spec-table.md).

**Note:** When you add a dosage specification for a medication product, an equivalent dosage definition entry is added in the application. A dosage definition models a dosage specification for use as a request definition parameter. For more information, see [Dosage definition table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-defn-table.md).
