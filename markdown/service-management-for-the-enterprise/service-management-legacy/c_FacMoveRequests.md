...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/service-management-for-the-enterprise/service-management-legacy/c\_FacMoveRequests.html
release: zurich
...
-   **[Create a move request through the facilities catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-management-for-the-enterprise/service-management-legacy/t_CreateAMoveReqThruFacCatalog.md)**  
Users can submit move requests by selecting from the categories of the Facilities catalog.
-   **[Create a move request with the move request form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-management-for-the-enterprise/service-management-legacy/t_CreateMoveReqWFacReqForm.md)**  
Facilities staff members can create move requests using the move request form.

**Parent Topic:**[Facilities move management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-management-for-the-enterprise/service-management-legacy/c_FacMoveMgmt.md)
