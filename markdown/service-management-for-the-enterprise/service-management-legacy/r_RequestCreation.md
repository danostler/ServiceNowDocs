...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/service-management-for-the-enterprise/service-management-legacy/r\_RequestCreation.html
release: australia
...
-   **[Create a request through a catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/service-management-for-the-enterprise/service-management-legacy/t_CreateARequestThroughTheCatalog.md)**  
The catalog provides several different categories so users can choose the one that closely relates to their request.
-   **[Request creation using inbound email actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/service-management-for-the-enterprise/service-management-legacy/r_ReqCreateUseInboundEmailAct.md)**  
