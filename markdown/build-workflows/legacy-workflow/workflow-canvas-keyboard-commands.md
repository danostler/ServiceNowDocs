...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/legacy-workflow/workflow-canvas-keyboard-commands.html
release: zurich
...
2.  Press **Enter** to open [Workflow Properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/r_WorkflowProperties.md).
