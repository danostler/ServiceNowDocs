...
2.  Create an event.
3.  Navigate to **System Policy** &gt; **Templates** and create an [Email templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/c_EmailTemplates.md).
4.  Navigate to **System Policy** &gt; **Email** &gt; **Notifications**.
5.  [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/t_CreateANotification.md) that is triggered by the event you created and sends the template you created.
