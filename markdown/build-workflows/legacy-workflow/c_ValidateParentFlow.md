...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/legacy-workflow/c\_ValidateParentFlow.html
release: zurich
...
-   Changing the data types of [input variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/c_UsingVariablesInAWorkflow.md). Verify that all parent workflows cited in this validation report can pass the correct value type.
