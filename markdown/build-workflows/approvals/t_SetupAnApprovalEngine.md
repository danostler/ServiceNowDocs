...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/approvals/t\_SetupAnApprovalEngine.html
release: zurich
product: Approvals
...
2.  Select the [approval engine option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/approvals/c_ApprovalEngines.md) for each Task table from the choice list.
