...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-activities/t\_ViewActivityDescriptions.html
release: zurich
...
1.  To view an activity description in the [Workflow Editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/workflow-editor.md), point to the icon for the activity in the palette.
...
Determines which transition the activity follows after completing. See [Manage workflow activity conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-activities/t_ManageActivityConditions.md) for more information.
