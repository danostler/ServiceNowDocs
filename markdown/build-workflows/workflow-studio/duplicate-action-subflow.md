...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/duplicate-action-subflow.html
release: zurich
...
Your selected action or subflow duplicates directly under itself. All configurations, including [transform functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/transform-functions.md), are copied over to the duplicated action or subflow.
