...
1.  If not already present, create a stage field on the table that triggers the flow.
    ...
    To add a field to a table, see [Add and customize a field in a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/t_CreatingNewFields.md).
