...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/subflow-history.html
release: zurich
...
-   **[Add an annotation to a subflow history entry](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/add-annotation-to-subflow-history-entry.md)**  
...
-   **[Delete a subflow's flow history entry](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/delete-subflow-history-entry.md)**  
Delete a subflow's flow history entry from the flow history list.
-   **[Restore a subflow to a previous flow history entry](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/restore-subflow-to-previous-flow-history-entry.md)**  
Restore a subflow to a previous configuration. Create a new flow history entry for the restore operation.
-   **[Save a copy of a subflow's flow history entry](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/save-copy-subflow-history-entry.md)**  
