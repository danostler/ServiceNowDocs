...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/steps.html
release: zurich
...
-   **[Ask for Approval step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/ask-approval-action-designer.md)**  
...
-   **[Call Now Assist Skill step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/call-now-assist-skill-step.md)**  
...
-   **[Create Record step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/create-record-action-designer.md)**  
Creates a record on any table. You can dynamically add and configure fields for the record.
-   **[Create or Update Record step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/create-update-record-step.md)**  
...
-   **[Create Task step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/create-task-action-designer.md)**  
...
-   **[Delete Multiple Records step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/delete-multiple-records-action-designer.md)**  
...
-   **[Delete Record step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/delete-record-action-designer.md)**  
Deletes a record on any table.
-   **[Get Connection Info step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/get-connection-info-action-designer.md)**  
Provide the connection and credential details from another step, such as a REST step, to other steps in your action.
-   **[Get Latest Response Text From Email step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/get-latest-response-text-from-email-action-designer.md)**  
Provide the most recent reply or forward message in an e-mail chain to other steps in your action.
-   **[JDBC step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/jdbc-step.md)**  
Create a reusable action to send SQL commands to a relational database.
-   **[JSON Builder step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/json-build-step-action-designer.md)**  
...
-   **[Kafka Producer step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/kafka-producer-action-designer.md)**  
Create an action that publishes events to a topic in your Kafka environment.
-   **[Log step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/log-message-action-designer.md)**  
Logs a message in the Workflow Studio log table sys\_flow\_log.
-   **[Look Up Record step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/lookup-record-action-designer.md)**  
Look up a record from any table based on defined conditions.
-   **[Look Up Records step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/lookup-records-action-designer.md)**  
Look up multiple records on any table using defined conditions.
-   **[Notification step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/trigger-notification-action-designer.md)**  
...
-   **[Payload Builder step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/payload-build-step-action-designer.md)**  
Enable action designers to easily create name-value pairs in JSON and XML payloads using dynamic data.
-   **[PowerShell step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/powershell-step-action-designer.md)**  
Run PowerShell scripts on remote machines from your ServiceNow instance through a MID Server.
-   **[REST step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/rest-request-action-designer.md)**  
Send an outbound REST web service request to an external system.
-   **[Script step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/javascript-step-action-designer.md)**  
...
-   **[Send Email step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/send-email-action.md)**  
Send an email to specified users or groups as an action in a flow.
-   **[SFTP step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/sftp-step.md)**  
...
-   **[SSH step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/ssh-step-action-designer.md)**  
...
-   **[SOAP step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/soap-step-action-designer.md)**  
Enable action designers to send outbound SOAP web service requests to external systems.
-   **[Update Multiple Records step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/update-multiple-records-action-designer.md)**  
...
-   **[Update Record step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/update-record-action-designer.md)**  
...
-   **[Wait For Condition step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/wait-for-condition-action-designer.md)**  
Pause an action until record values match a specific set of conditions.
-   **[ZIP step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/zip-step.md)**  
