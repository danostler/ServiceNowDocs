...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/flow-priority.html
release: zurich
...
-   **[Show flow priority field](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/show-flow-priority-field.md)**  
Configure the Setting list and form to show the Flow Priority field.
-   **[Set flow priority](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/set-flow-priority.md)**  
