...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/config-archive-settings-process-contexts.html
release: zurich
...
If you want to turn off automated archiving instead, see [Turn off automated archiving](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/turn-off-automated-archiving.md).
