...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/test-action.html
release: zurich
...
-   [Create an action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/create-action.md) and save it.
...
Click `Action has been executed. To view the action, click here` to view the action execution details. See [Flow execution details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/flow-execution-details.md) for information about the executions.
