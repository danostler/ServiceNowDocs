...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/impact/accelerator-and-initiative-list/request-accelerator.html
release: zurich
...
5.  Complete the form and select **Complete Setup**.
    ...
    The Set up initiative form displays. The Accelerator in progress updates the status on the tile and displays in the [Initiatives and Accelerators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/accelerator-and-initiative-list/impact-initiatives.md) list.

    **Note:** An Impact Permissions Authorizer will grant or deny the request to start the initiative. See [Manage Initiative and Accelerator permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/accelerator-and-initiative-list/grant-ide-permissions.md) for additional information.
