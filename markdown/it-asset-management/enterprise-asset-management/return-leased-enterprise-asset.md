...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/return-leased-enterprise-asset.html
release: zurich
...
Notes about the task that are visible to all users within your organization.
        ...
        -   If you changed your lease action to an enterprise asset buyout, proceed to [Buy out a leased enterprise asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/enterprise-asset-management/buy-out-leased-enterprise-asset.md).
        -   If you changed your lease action to a lease contract extension, proceed to [Extend the lease contract for an enterprise asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/enterprise-asset-management/extend-enterprise-asset-lease-contract.md).
