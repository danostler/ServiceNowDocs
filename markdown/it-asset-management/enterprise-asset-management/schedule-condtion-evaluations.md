...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/schedule-condtion-evaluations.html
release: zurich
...
3.  Select **Asset condition work order** in the **Template** field.
    ...
    For more details on creating a work order, see [Create a work order for an enterprise asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/enterprise-asset-management/create-eam-work-order.md).
