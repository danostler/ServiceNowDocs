...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/remediate-unsuccessful-enterprise-asset-calibration.html
release: zurich
...
9.  Fill out any additional fields in the Create New Work Order form and then select **Save**.
    ...
    See [Create a work order for an enterprise asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/enterprise-asset-management/create-eam-work-order.md) for a detailed description of each field.
