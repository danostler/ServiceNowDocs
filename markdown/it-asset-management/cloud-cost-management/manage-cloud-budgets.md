...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/cloud-cost-management/manage-cloud-budgets.html
release: zurich
...
3.  On the Budget policy creation form, fill in the fields.
    ...
    For a description of the field values, see [List of Budget policy creation fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/cloud-cost-management/budget-policy-fields.md).
