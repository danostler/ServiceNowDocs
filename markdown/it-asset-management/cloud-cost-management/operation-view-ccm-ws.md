...
-   **Cost usage tags**: Associate resource usage with particular business entities. For more information, see [Tags and tag categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/cloud-cost-management/tags-overview.md).

    -   **Tag categories**: Create and update tag categories.
    -   **Tag names**: Create tag names for the tag categories.
    For more information, see [Create and update a tag category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/cloud-cost-management/tag-category-crud-cloudin.md).
