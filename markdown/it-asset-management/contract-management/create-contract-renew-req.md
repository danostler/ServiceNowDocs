...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/contract-management/create-contract-renew-req.html
release: zurich
...
If the parent contract doesn't have child contracts, select the [Build renewal task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/contract-management/fill-cont-renew-info.md).

If the parent contract has child contracts, select the [Contract selection task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/contract-management/select-contract.md).
