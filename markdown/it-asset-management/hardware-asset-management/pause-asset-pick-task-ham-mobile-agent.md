...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/pause-asset-pick-task-ham-mobile-agent.html
release: zurich
...
**Parent Topic:**[Record time worked on a hardware asset pick task using the Mobile Agent application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/record-time-pick-task-mobile-agent-ham.md)
