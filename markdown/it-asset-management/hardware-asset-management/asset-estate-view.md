...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/asset-estate-view.html
release: zurich
...
To create hardware, software, consumable, bundle, pallet, mobile, and facility assets, select **New asset**. For more details, see [Create assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/asset-management/t_CreatingAssets.md).
