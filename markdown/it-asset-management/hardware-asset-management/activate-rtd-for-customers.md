...
The Service Exchange application must be installed on your instance. For more information, see [Install Service Bridge for customers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/service-exchange/install-service-bridge-v2-customer.md).
