...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/readily-available-dec-tables-ham.html
release: zurich
...
Update the associated Decision table entries to trigger the new flow. For more information, see [Update associated Decision tables for HAM flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/trigger-flow-ham.md).

For the list of readily available decision tables and the associated Hardware Asset Management features that you can update, see [Decision tables for Hardware Asset Management flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/ham-decision-table.md).
