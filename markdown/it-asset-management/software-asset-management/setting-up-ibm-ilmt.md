...
2.  From your ServiceNow instance, navigate to **System Definition** &gt; **Certificates** and create a [certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/servicenow-ai-platform-security/t_UploadACertificateToAnInstance.md) \(Trust Store Cert, PEM format\).
