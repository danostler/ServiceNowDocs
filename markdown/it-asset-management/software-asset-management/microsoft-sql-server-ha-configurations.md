...
For more information on Microsoft SQL Server licensing, see [Microsoft Per Core licensing rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/microsoft-sw-license-metrics.md). For more information on Always On availability group discovery, see .
