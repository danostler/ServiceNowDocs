...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/ibm-user-based-licensing.html
release: zurich
...
For more information on client access records in the Software Asset Workspace, see [Create a software client access record in workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/create-clientaccess-workspace.md). For more information on client access records in the Software Asset Management classic application, see [Add a software client access record in Software Asset Management classic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/t_AddAClientAccessRec.md).
...
</table>**Parent Topic:**[Supported IBM license types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/supported-ibm-license-types.md)
