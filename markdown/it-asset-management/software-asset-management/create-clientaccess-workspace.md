...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/create-clientaccess-workspace.html
release: zurich
...
</table>License metrics are set on the [software entitlement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/create-entitlements-workspace.md) form and can be accessed from the **Metric Attributes** related list on the [software model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/create-swmodels-workspace.md) form.
...
If you select this option, you can assign the associated User CALs to specific users. See [step 7](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/create-clientaccess-workspace.md) for more details.
...
If you select this option, you can assign the associated Device CALs to specific devices. See [step 7](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/create-clientaccess-workspace.md) for more details.
...
If you select this option, you can assign the associated User and Device CALs to specific users and devices. See [step 7](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/create-clientaccess-workspace.md) for more details.
...
After you create a client access record, reconciliation runs on the associated server software as a scheduled job or on-demand. You can view your reconciliation results in the [License usage view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/sam-workspace-workbench.md). Use these results to determine your license compliance position and to remediate any non-compliance.
