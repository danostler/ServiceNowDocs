...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/integrating-ilmt-bigfix-v1-apis.html
release: zurich
...
-   **[Transform maps for IBM License Metric Tool \(ILMT\) and BigFix Inventory integration v1 APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/ibm-transform-maps.md)**  
