...
-   **Notify**
    ...
    Provides support for enabling and configuring customer SMS and email notifications For more information about activating Notify, see [Notify](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/notify/notify-landing-page.md).
