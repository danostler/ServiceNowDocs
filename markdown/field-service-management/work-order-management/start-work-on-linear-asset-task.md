...
-   Enable location tracking from your mobile device to record your location in the geo history table. For more information, see [Using location tracking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/mobile/mobile-platform/mobile-location.md).
