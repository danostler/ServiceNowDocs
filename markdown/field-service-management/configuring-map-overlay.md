...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/field-service-management/configuring-map-overlay.html
release: zurich
...
-   [Create a marker layer overlay](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md)
...
-   [Create a shape layer overlay](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md)
...
-   [Create a heatmap](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md)
...
-   [Create map marker icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md)
...
-   [Create info window field set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md)
...
-   [Create a map overlay definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md)
...
-   [Link overlay group and overlay definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md)
...
Address information associated with the marker. For example, location of an agent. This field appears when the **Advanced** field isn’t selected.
    ...
    For more information, see [Create map marker icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md).
...
5.  Configure an info window field set to determine the fields that you want to display in a card when a map marker icon is selected.
    ...
    For more information, see [Create info window field set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md).
...
**Note:** This field appears only for the heatmap and only when the **Advanced** field isn’t selected.
    ...
    For more information, see [Extension points in Field Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/extension-points-field-service.md).

5.  Change the opacity level and the radius that influence the data point in the heatmap.

    For more information, see [Field Service Territory Planning console properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/territory-planning-components-fsm.md).
...
Link the map marker icons to the overlay definition. For more information, see [Create a map overlay definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md).
...
Contains meta data for overlays. For example, stockroom related data. For more information, see [Create a marker layer overlay](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md).
...
4.  On the form, fill in the fields.
    ...
    |Application|Global|
    |Overlay|Select the map overlay definition. For more information, see [Create a map overlay definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/configuring-map-overlay.md).|
