...
Ensure Indoor Maps are set up. For more information, see [Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/indoor-mapping/Indoor-mapping.md).
