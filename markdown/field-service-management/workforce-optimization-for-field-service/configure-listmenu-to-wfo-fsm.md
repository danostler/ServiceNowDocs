...
Set the map application scope to **Coaching With Learning**. For more information, see [Set map application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/set-map-application-scope.md).
