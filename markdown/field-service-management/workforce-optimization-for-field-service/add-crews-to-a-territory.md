...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/field-service-management/workforce-optimization-for-field-service/add-crews-to-a-territory.html
release: zurich
...
Dispatchers can assign crews to work order tasks. For more information, see [Assign work order tasks to crews](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/field-service-manager-workforce/assign-wot-crew-operations.md).
