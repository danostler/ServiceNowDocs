...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/field-service-management/configure-filter-options.html
release: zurich
...
2.  Select one of the tables.
    ...
    For a list of tables, see [Advanced resource filter tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/advanced-filter-tables.md).
