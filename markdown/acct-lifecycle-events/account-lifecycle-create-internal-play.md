...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/account-lifecycle-create-internal-play.html
release: zurich
topic_type: task
...
-   Create internal play tasks to define tasks that should be performed when an internal play is launched. See [Create an internal play task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-create-internal-play-task.md)
...
-   **[Create an internal play task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-create-internal-play-task.md)**  
