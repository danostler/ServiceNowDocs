...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/customer-success-management/account-lifecycle-config-zoom-sum.html
release: zurich
...
1.  To configure the Zoom spoke, follow the steps listed in [Set up the Zoom spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/integration-hub/setup-zoom.md).
...
Name of the webhook registry.
    ...
    For more details on configuring the webhook, see [Set up a bi-directional webhook for Zoom spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/integration-hub/setup-webhook-zoom-spoke.md).
...
-   **[Generate summary for Zoom meetings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/customer-success-management/account-lifecycle-zoom-meeting-summary.md)**  
Generate the meeting summary for virtual meetings conducted using Zoom.

**Parent Topic:**[Touchpoint home page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/customer-success-management/account-lifecycle-touchpoint-home.md)
