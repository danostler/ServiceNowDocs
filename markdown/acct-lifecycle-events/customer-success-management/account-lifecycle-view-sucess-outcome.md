...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/acct-lifecycle-events/customer-success-management/account-lifecycle-view-sucess-outcome.html
release: australia
...
When you create a success blueprint for an engagement, you can define success objectives and outcomes for each objective. See [Create a success blueprint](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/acct-lifecycle-events/customer-success-management/account-lifecycle-create-success-blueprint.md) for details. You can view this page either by navigating from the Engagement record page or by following these steps:
...
-   Details: See [Add a primary success outcome](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/acct-lifecycle-events/customer-success-management/account-lifecycle-create-outcome.md) for a detailed description of the fields.
