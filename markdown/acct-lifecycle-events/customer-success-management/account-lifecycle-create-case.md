...
description: Create an onboarding case for an existing customer account.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/customer-success-management/account-lifecycle-create-case.html
release: zurich
