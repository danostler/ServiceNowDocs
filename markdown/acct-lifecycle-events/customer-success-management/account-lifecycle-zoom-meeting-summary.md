...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/customer-success-management/account-lifecycle-zoom-meeting-summary.html
release: zurich
...
4.  Follow the steps described in the [Meetings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/customer-success-management/account-lifecycle-touchpoint-home.md) section to schedule a Zoom meeting.
...
**Parent Topic:**[Configure Zoom to create a touchpoint meeting summary](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/customer-success-management/account-lifecycle-config-zoom-sum.md)
