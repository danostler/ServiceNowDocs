...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/acct-lifecycle-events/customer-success-management/account-lifecycle-setup-health-defn.html
release: australia
...
-   Data source and data context engine mapping must be setup. See [Data Context Engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/acct-lifecycle-events/customer-success-management/account-lifecycle-setup-metric-data.md).
...
Create visualization using the newly created data source. See [Configure DCE Visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/acct-lifecycle-events/customer-success-management/account-lifecycle-configure-dce-visual.md) for details. When the next data collection occurs, the health score is calculated and published on the Engagement page.
