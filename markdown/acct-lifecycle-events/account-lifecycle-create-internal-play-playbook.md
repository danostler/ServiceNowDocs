...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/account-lifecycle-create-internal-play-playbook.html
release: zurich
topic_type: task
...
4.  In the `Assist` phase, you can perform the following activities:
    ...
    -   Related work: Click **Create task** to create an internal play task. See [Create an internal play task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-create-internal-play-task.md) for a detailed description of this form.
...
-   **[Create an internal play playbook record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-create-internal-play.md)**  
Create an internal play to define a planned or unplanned activity during the engagement lifecycle.
-   **[Close or cancel an internal play](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-cancel-internal-play.md)**  
