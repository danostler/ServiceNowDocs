...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/configuration-mapping-overview.html
release: zurich
topic_type: concept
...
-   [Use case: Configuration line item to quote line flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/use-case-configuration-line-item-to-quote-line-flow.md) \(if your Logik Extension for Salesforce CPQ Package is version 1.8 or later\)
