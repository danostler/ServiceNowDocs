...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/sales-and-order-management/configure-inflight-order-change-mgt.html
release: zurich
...
-   **[Create additional inflight order change types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/sales-and-order-management/define-inflight-order-change-types.md)**  
...
-   **[Configuring order tasks to respond to inflight revision and cancellation requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/sales-and-order-management/configuring-order-tasks-respond-to-inflight-revision-cancellation-requests.md)**  
