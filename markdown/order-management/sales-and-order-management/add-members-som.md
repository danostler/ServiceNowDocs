...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/sales-and-order-management/add-members-som.html
release: zurich
...
-   Price Band Approver
However, more roles can be configured. For more information, see [Create related party configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/adding-related-party-config-to-case.md).
