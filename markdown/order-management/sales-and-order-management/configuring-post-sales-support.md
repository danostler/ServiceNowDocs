...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/order-management/sales-and-order-management/configuring-post-sales-support.html
release: australia
...
[Contracts and Entitlement Workflows​](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/order-management/sales-and-order-management/configure-cont-ent-workflows-csm.md)\[com.sn\_contract\_ent\_wf\]
...
For more information on the installed roles and tables, see [Components installed with Customer Contracts and Entitlements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/order-management/sales-and-order-management/components-installed-pss.md).
