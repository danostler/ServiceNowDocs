...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/order-management/sales-and-order-management/enable-manage-order-operations-ai-agent.html
release: australia
...
Customize the subject, content, or formatting of the default email templates for order cases. For more information, see [Email notifications for order cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/order-management/sales-and-order-management/order-case-email-notifications.md).
