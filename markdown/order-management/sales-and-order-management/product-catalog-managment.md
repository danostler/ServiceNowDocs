...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/order-management/sales-and-order-management/product-catalog-managment.html
release: australia
...
To learn more about setting up product offering catalogs, see [Configuring product offerings and catalogs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/order-management/sales-and-order-management/som-managing-product-catalogs.md).
...
-   Browse and search product offerings by using keywords, descriptions, and industry codes​.
    ...
    Product catalog admins or managers can also [configure AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/order-management/sales-and-order-management/configure-ai-search-prod-catalog.md) in the product catalog interface, enabling agents and customers to find relevant product offerings or service specifications by using semantic queries.
