...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/order-management/sales-and-order-management/transaction-manager-use-case-document-generation-with-google-docs.html
release: australia
