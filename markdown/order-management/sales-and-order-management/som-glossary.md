...
To learn more about using the business portal, see [Using the Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/use-the-business-portal.md).
