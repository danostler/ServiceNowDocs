...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/create-entity-configuration.html
release: zurich
topic_type: task
...
3.  On the form, in the **Name** field, enter the entity name and in the **Config ID** field, enter the entity ID.
    ...
    For a description of the field values, see [Entity configuration and mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/entity-configuration-and-mapping.md).
