...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/staggered-decomposition.html
release: zurich
topic_type: concept
...
To understand staggered decomposition with the help of an example, see [Customer order decomposition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/customer-order-decomposition.md).
