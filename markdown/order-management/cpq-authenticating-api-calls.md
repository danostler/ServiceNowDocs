...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/cpq-authenticating-api-calls.html
release: zurich
topic_type: concept
...
For more information on ServiceNow CPQ runtime calls, see [Intro to runtime API calls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/intro_to_runtime_api_calls.md).
