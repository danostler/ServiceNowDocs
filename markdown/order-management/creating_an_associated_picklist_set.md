...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/creating\_an\_associated\_picklist\_set.html
release: zurich
topic_type: concept
...
**Note:** Be sure to read about product pickers and their functionality before building associated picklists, as they may be better suited to your use case. See [Product pickers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/product_picker_overview.md).
