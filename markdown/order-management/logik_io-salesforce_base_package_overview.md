...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/logik\_io-salesforce\_base\_package\_overview.html
release: zurich
topic_type: concept
...
-   Access ServiceNow CPQ admin APIs using Salesforce tokens. For detailed steps, see [Admin APIs: Authentication using a Salesforce-connected app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/admin-apis-authentication-via-salesforce-connected-app.md).
