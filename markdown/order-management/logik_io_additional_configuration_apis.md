...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/logik\_io\_additional\_configuration\_apis.html
release: zurich
topic_type: concept
...
This article is a followup to [Runtime APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/logik_io_runtime_apis.md). For more information on authentication and setup,see that article.
