...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/defining-products-with-ramps.html
release: zurich
topic_type: concept
...
**Note:** Products that can have ramps must have the **Price method** set to Recurring and the **Enable ramps** option selected. Your product catalog admin sets these options when [creating a product offering](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-create-product-offering.md).
...
[Enable ramps in product offerings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-create-product-offering.md)
