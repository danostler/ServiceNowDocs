...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/som-activate-location-filter.html
release: zurich
topic_type: task
...
Define the [product eligibility rule filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-create-rule-entity-filter.md) and [matrices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-define-eligibility-rules.md) that control the product offerings displayed by location.

**Parent Topic:**[Configuring location-based product transactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/config-location-transaction.md)
