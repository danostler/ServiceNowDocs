...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/table\_queries.html
release: zurich
topic_type: concept
...
For more information on what is supported in a query, see [The lookup function: commands and syntax](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-the-lookup-function-commands-and-syntax.md).
