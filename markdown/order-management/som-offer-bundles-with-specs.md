...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/som-offer-bundles-with-specs.html
release: zurich
topic_type: concept
...
To learn more about product offerings, see [Create product offerings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-create-product-offering.md).
