...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/logik\_io-salesforce\_managed\_packages.html
release: zurich
topic_type: concept
...
-   Support embedding the ServiceNow CPQ UI in Salesforce applications outside of CPQ using Visualforce. See [Use case: Embed ServiceNow CPQ UI in a Salesforce VisualForce page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/use_case_embed_logik_io_ui_in_salesforce_visualforce_page.md).
-   Call ServiceNow CPQ admin APIs using Salesforce Tokens. For detailed steps, see [Admin APIs: Authentication using a Salesforce-connected app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/admin-apis-authentication-via-salesforce-connected-app.md).
...
-   [Flightpath](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-flightpath.md): allows the administrator to understand how the rules engine responds to end-user inputs by presenting a visual interaction between inputs and triggered rule actions.
