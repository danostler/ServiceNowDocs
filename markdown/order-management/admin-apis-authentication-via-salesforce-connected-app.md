...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/admin-apis-authentication-via-salesforce-connected-app.html
release: zurich
topic_type: concept
...
-   The release of admin API Keys has made this setup unnecessary and is now the recommended method of authentication of admin API calls. See [Intro to admin API keys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-admin-api-keys.md).
