...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/post-upgrade-task-business-portal.html
release: zurich
topic_type: task
...
Ensure that the Sales Cart application has been installed. For more information, see [Install Sales Cart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/install-sales-cart-plugin.md).
