...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/government-industry/public-sector-digital-services/psds-using-grants-management-playbook.html
release: australia
...
For more information on using the Reviewer Service Portal as an external merit reviewer, see [Using the Reviewer Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/government-industry/public-sector-digital-services/psds-gmp-using-merit-review-portal-agent.md).
