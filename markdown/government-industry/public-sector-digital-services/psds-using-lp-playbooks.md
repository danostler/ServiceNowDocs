...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/government-industry/public-sector-digital-services/psds-using-lp-playbooks.html
release: australia
...
-   Includes the tabs that you can use to display the following types of information:
    ...
    -   Dynamic related records. For more information, see [Dynamic related records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/government-industry/public-sector-digital-services/psds-playbook-viewing-rel-records.md).
