...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/government-industry/public-sector-digital-services/psds-using-mobile-agent.html
release: australia
...
For more information on the agent tasks in the Mobile Agent app, see [Using the Mobile Agent to perform agent tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/government-industry/public-sector-digital-services/psds-mobile-playbooks-perform-agent-manager-tasks.md).
...
For more information on the agent tasks in the Mobile Agent, see [Using the Mobile Agent to perform agent tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/government-industry/public-sector-digital-services/psds-mobile-playbooks-perform-agent-manager-tasks.md).
