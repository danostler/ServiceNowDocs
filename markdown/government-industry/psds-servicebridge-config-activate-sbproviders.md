...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/psds-servicebridge-config-activate-sbproviders.html
release: zurich
topic_type: concept
...
See [Install Service Exchange for Public Sector Digital Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/government-industry/psds-servicebridge-config-install-prov.md).
...
See [Customize the Government Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/government-industry/customize-government-service-portal.md).
...
See [Connect a provider instance to a consumer instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/government-industry/psds-servicebridge-config-connect-prov-consu.md).
