...
You can access the OT extension classes by installing the CMDB CI Class Models application. For more information about installation, see [CMDB CI Class Models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/cmdb-ci-class-models/cmdb-ci-class-models.md).
