...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/operational-technology-incident-management/create-a-child-ot-incident.html
release: zurich
...
-   Enable the Create child incident feature \(**com.snc.incident.create.child.enable**\) property. For more information, see [Set the system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/operational-technology/operational-technology-incident-management/configure-ot-incident-management-properties.md).
