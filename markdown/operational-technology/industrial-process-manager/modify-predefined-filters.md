...
4.  Modify the Configuration Types, CI Filters, and Relationship Types related lists as needed.
    ...
    For more information about how to modify these related lists, see [Create a predefined filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/dependency-views/create-predefined-filter.md).
