...
1.  To access the Industrial services page, assign the **cmdb\_ot\_viewer** role.
    ...
    For more information about how to assign roles, see [Assign a role to a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/user-administration/t_AssignARoleToAUser.md).
