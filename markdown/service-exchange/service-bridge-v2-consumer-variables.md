...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/service-exchange/service-bridge-v2-consumer-variables.html
release: zurich
...
-   You have added the necessary variables to a variable set. For more details, see [Using variable sets with Remote Record Producers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-exchange/service-bridge-v2-variable-sets.md).
