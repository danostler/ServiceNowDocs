...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/service-exchange/service-bridge-v2-remote-catalog.html
release: zurich
...
1.  Create a remote record producer in a remote catalog. See [Create a remote record producers in a remote catalog in Service Exchange for Providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-exchange/service-bridge-v2-create-remote-rec-prod.md).
2.  Create variables for remote record producers. See [Create variables for remote record producers in Service Exchange for Providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-exchange/service-bridge-v2-assign-variables-ser-defn.md).
