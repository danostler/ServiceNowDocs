...
6.  Click **Continue** to open the Execution Command form, then fill out the **Execution Command** step based on the corresponding execution templates:
    ...
    -   [Create a SOAP web service activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/orchestration/t_CreateASOAPWebServiceActivity.md)
...
<table id="choicetable_lh4_h3j_4y"><tbody><tr><td id="d96833e339">
