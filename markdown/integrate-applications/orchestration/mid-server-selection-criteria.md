...
-   The **Default MID Server** field on the Orchestration application record. See [Configure a default MID Server for each application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/t_SpecifyMIDServerApplications.md) for instructions.
