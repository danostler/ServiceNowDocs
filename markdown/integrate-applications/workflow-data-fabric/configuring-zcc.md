...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/configuring-zcc.html
release: australia
...
-   **[Activate Zero Copy Connector Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/activate-zcc-hub.md)**  
Access the Zero Copy Connector Hub on your instance by activating the Zero Copy Connector Hub plugin \(sn\_data\_fabric\).
-   **[Request Zero Copy Connectors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/request-zcc.md)**  
...
-   **[Create a connection administrator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/create-connection-admin-zcc.md)**  
Create a connection admin who can create zero copy connections in Zero Copy Connector Hub.
-   **[Enabling access to a data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/enabling-access-data-source-zcc.md)**  
