...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/t\_BreakUpALargeExport.html
release: australia
...
1.  Create a filtered list of records that you want to export by following the steps in [Export directly from a URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/t_ExportDirectlyFromTheURL.md).
