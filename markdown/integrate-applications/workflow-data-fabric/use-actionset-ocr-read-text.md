...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/use-actionset-ocr-read-text.html
release: australia
...
You can configure the properties for the OCR Read Text component. For more information about these properties, see [ActionSet OCR Read Text properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/actionset-actions-properties.md).
