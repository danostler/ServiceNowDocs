...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/use-utilities-http-post.html
release: australia
...
You can configure the properties for the Post component. For more information about these properties, see [Properties of the HTTP components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/properties-http-components.md).
