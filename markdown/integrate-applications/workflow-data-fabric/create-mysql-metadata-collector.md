...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/create-mysql-metadata-collector.html
release: australia
...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the MySQL collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/prepare-to-run-mysql-collector.md).
