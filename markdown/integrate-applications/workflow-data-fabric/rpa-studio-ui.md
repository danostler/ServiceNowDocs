...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/rpa-studio-ui.html
release: australia
...
For more information, see [Use sample automations in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/use-sample-automation.md) and [Sample automations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/sample-automations-rpa-studio.md).
...
Launches connection manager window. For more details, see [Connect to an RPA Hub instance from RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/connect-studio-instance-rpa.md).You cannot connect to a different instance after the RPA Desktop Design Studio is launched.
...
-   **Sample automations**- View the list of all sample automations by selecting **View all**.
    ...
    For more information, see [Use sample automations in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/use-sample-automation.md).
...
For more information, see [Build an automation with Now Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/build-automation-now-assist.md).
