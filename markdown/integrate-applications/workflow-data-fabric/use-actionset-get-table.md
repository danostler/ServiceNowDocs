...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/use-actionset-get-table.html
release: australia
...
You can configure the properties for the Get Table action. For more information about these properties, see [ActionSet- Get Table properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/actionset-actions-properties.md).
