...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/create-microsoft-sql-server-metadata-collector.html
release: australia
...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the Microsoft SQL Server collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/prepare-to-run-microsoft-sql-server-collector.md).
