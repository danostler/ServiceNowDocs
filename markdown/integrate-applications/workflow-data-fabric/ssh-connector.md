...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/ssh-connector.html
release: australia
...
-   To use a connector in RPA Desktop Design Studio, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/use-connector.md). Add the Secure Shell connector in the Global Objects.

    \[Omitted image "ssh-connector-add-global-object.png"\] Alt text: Add Secure Shell connector in the Global Objects

-   To learn more about the various methods in the SSH connector, see [Secure Shell \(SSH\) connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/connector-ssh-methods.md).

-   **[Secure Shell \(SSH\) connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/connector-ssh-methods.md)**  
