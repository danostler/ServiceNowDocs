...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/queue-connector.html
release: australia
...
To create a queue, see [Create a queue in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/create-queue.md).

To assign a bot process to a queue, see [Assign a bot process to a queue from Queues menu in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/assign-botprocess-queue.md).

You must first use, configure, and then expose the methods in the Queue connector to use its methods.

-   To use the Queue connector, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/use-connector.md).
...
-   **[Queue connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/connectors-queues-methods.md)**  
The Queue connector methods enable you to create and manage work items for queues in the RPA Hub.
-   **[Parameters for the Queue connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/queue-connector-method-parameters.md)**  
