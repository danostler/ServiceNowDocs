...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/use-actionset-ocr-read-table.html
release: australia
...
You can configure the properties for the OCR Read Table action. For more information about these properties, see [ActionSet OCR Read Table properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/actionset-actions-properties.md).
...
6.  Configure the properties of the OCR Read Table action in the Properties pane of the ACTIONSET SETTINGS window.
    ...
    For more information about these properties, see [ActionSet OCR Read Table properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/actionset-actions-properties.md).
