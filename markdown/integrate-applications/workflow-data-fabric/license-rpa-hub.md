...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/license-rpa-hub.html
release: australia
...
For more information about creating a robot license distribution record, see [Create a robot license distribution record in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/create-lua-record.md).

For more information about executing RPA scripts, see [Re-evaluate license distribution by executing RPA scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/execute-rpa-script.md).
...
To unassign a user, you must retire the associated attended robot. For more information, see [Unassign an attended user or group from an attended bot process in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/unassign-rda-users.md). To remove a user from a group, contact your organization.

To retire a robot if the robot machine is not working appropriately, retire the associated unattended robot. For more information, see [Retire a robot in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/retire-robot.md).

You can update a robot license distribution record. For more information, see [Update a robot license distribution record in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/update-license-record-rpa.md).
