...
3.  Create flow to generate buyer token.
    ...
    2.  Create a flow and include the Get Buyer Token spoke action.
        ...
        For more information about creating flows, see [Building flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/workflow-studio/flows.md).
