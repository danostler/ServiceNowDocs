...
1.  Configure MID Server using the SAP proprietary JAR files.
    ...
    4.  Upload the required SAP proprietary files \(JAR, SO, or DLL\) obtained after contacting your SAP S4 HANA RFC admin.
        ...
        For more information, see [Synchronize a JAR file to MID Servers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server/t_SynchronizeAJARFiletoMIDServers.md).
