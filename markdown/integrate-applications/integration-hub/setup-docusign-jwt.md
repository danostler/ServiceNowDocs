...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/setup-docusign-jwt.html
release: zurich
...
3.  Record the values of integrator key and secret key to register the app as a third-party OAuth provider on your ServiceNow instance.
    ...
    You need these values when you [Register Docusign as OAuth Provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/setup-docusign-jwt.md)
...
3.  Paste the Private Key you had earlier generated from your Docusign integrator app.
    ...
    For more information, see [Configure Docusign account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/setup-docusign-jwt.md).
