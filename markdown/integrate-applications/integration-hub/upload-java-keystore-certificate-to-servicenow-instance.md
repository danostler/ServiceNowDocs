...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/upload-java-keystore-certificate-to-servicenow-instance.html
release: zurich
