...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/csd2-jamf.html
release: zurich
...
-   Activate the Jamf spoke and set up the spoke. For more information about the spoke setup, see [Set up the Jamf spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/setup-jamf-spk.md).
