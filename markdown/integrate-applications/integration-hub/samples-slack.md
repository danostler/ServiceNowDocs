...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/samples-slack.html
release: zurich
...
1.  Configure the Slack commands on the Slash Commands page of your custom application. For more information, see [Configure Slack app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/configure-slack-workspace.md).
...
3.  [Configure inbound decisions in ServiceNow instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/conf-inbound-slack.md).
...
2.  [Configure outbound configurations in ServiceNow instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/conf-outbound-slack.md)
...
1.  [Configure outbound configurations in ServiceNow instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/conf-outbound-slack.md).
    1.  Open the default outbound configuration, **On Call: Assign by Acknowledgement**.
