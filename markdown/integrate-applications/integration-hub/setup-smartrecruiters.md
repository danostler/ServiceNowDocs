...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/setup-smartrecruiters.html
release: zurich
...
4.  On the dialog box, fill in the fields.
    ...
    |API Key|API key for your SmartRecruiters applications. Enter the same API key that you generated in [Generate a SmartRecruiters API key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/setup-smartrecruiters.md).|
