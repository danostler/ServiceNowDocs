...
-   Create an [Define an SCCM configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/orchestration/t_ConfigureSCCMCollections.md) for the application that names an appropriate uninstall collection.
