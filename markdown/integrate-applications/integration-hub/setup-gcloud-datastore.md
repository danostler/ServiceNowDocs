...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/setup-gcloud-datastore.html
release: zurich
...
8.  Copy these two values to a text file so that you can use them when you [Register Google Cloud Datastore as an OAuth provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/setup-gcloud-datastore.md).
