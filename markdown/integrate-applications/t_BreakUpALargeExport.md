...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/t\_BreakUpALargeExport.html
release: zurich
topic_type: task
...
1.  Create a filtered list of records that you want to export by following the steps in [Export directly from a URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/t_ExportDirectlyFromTheURL.md).
