...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/configure-the-sap-connector.html
release: zurich
product: RPA Hub
...
Ensure that the SAP plugin on the RPA Desktop Design Studio is installed. For more information, see [Manage plugins in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/install-plugins-rpa-studio.md).
...
2.  Drag the SAP connector under the Global Objects in the Project Explorer pane.
    ...
    To learn more about how to add the SAP connector, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-connector.md).
...
9.  To expose the element-level methods, do the following steps.
    ...
    5.  Use the Capture element dialog to capture one or more SAP application screen elements.
        ...
        For more information about how to use the Capture element dialog, see [Use the Capture element dialog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-context-dialog.md).
