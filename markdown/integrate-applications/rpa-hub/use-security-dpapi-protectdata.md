...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/use-security-dpapi-protectdata.html
release: zurich
product: RPA Hub
...
You can configure the properties for the ProtectData component. For more information about these properties, see [Properties of the DPAPI components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/properties-of-dpapi-components.md).
