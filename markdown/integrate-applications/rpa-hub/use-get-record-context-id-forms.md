...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/use-get-record-context-id-forms.html
release: zurich
product: RPA Hub
...
You can configure the properties for the GetRecordContextID component. For more information about these properties, see [Properties of the Forms components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/sn-forms-properties.md).
