...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/use-general-log.html
release: zurich
product: RPA Hub
...
4.  If you want to classify the message, configure the **Log level** property from the Properties explorer.
    ...
    For more information on how to configure the remaining properties of the Log component, see [Properties of the General components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/Properties-general-components.md).
