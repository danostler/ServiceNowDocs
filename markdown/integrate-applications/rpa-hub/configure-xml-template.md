...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/configure-xml-template.html
release: zurich
product: RPA Hub
...
The XmlTemplate component also provides methods to work with the templates. To expose the methods, see [View the XmlTemplate methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/view-xmltemplate-methods.md).
