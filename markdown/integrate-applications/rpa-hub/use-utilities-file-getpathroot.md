...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/use-utilities-file-getpathroot.html
release: zurich
product: RPA Hub
...
You can configure the properties for the GetPathRoot component. For more information about these properties, see [Properties of the File components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/util-file-prop.md).
