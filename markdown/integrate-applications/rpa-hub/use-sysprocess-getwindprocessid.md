...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/use-sysprocess-getwindprocessid.html
release: zurich
product: RPA Hub
...
You can configure the properties for the GetWindowProcessID component. For more information about these properties, see [Properties of the System Process components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/util-sysprocess-prop.md).
