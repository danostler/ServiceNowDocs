...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/map-credential-groups-to-bot-process.html
release: zurich
product: RPA Hub
...
8.  Provide access to authorized users.
    ...
    For more information, see [Provide users with access to a credential group in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/create-credential-group.md).
