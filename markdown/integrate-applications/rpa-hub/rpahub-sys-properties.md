...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/rpahub-sys-properties.html
release: zurich
product: RPA Hub
...
For more information, see [Run an automation using Attended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/run-rda-robot.md).
...
For more information about installing a user certificate, if you have the admin role, see [Install the user-generated certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-user-certificates-rpa.md).
...
For more information about execution logs, see [Bot Process form in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/bot-process-form.md).
...
For more information about the robot calendar, see [Using the robot calendar for RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/robot-calendar-rpa.md).
...
For more information about the queue form, see [Queue form in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-form.md).
...
If this value is set to No, then the users added in the Assigned Studio Users tab in the Robot form can impersonate as robot from the RPA Desktop Design Studio. For more information about adding the assigned studio users, see [Add assigned studio users to an unattended robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/assigned-studio-users-rpa.md).

For more information about assign bot process to an automation project, see [Assign bot process to an automation project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/assign-bot-process.md).
