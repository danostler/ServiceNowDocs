...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/use-environment-is16bitos.html
release: zurich
product: RPA Hub
...
You can configure the properties for the Is64BitOperatingSystem component. For more information about these properties, see [Properties of the Environment components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/util-environment-prop.md).
