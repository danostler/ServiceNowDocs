...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/install-rpa-runtime-login-agent.html
release: zurich
product: RPA Hub
...
-   Login agent clears the legal notice message if the **sn\_rpa\_fdn.bypass\_legal\_notice** system property is selected.
    ...
    For more information about this property, see [Configure RPA Hub properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/rpahub-sys-properties.md).
