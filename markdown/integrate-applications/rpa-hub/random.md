...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/random.html
release: zurich
product: RPA Hub
...
-   **[Use the Number component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-random-number-component.md)**  
Generate any random number between two integers by using the Number component in RPA Desktop Design Studio.
-   **[Use the Password component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-utilities-random-password.md)**  
Generate any random password by using the Password component in RPA Desktop Design Studio.
-   **[Use the String component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-utilities-random-string.md)**  
Generate a random string by using the String component in RPA Desktop Design Studio.
-   **[Properties of the Random components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/properties-random-component.md)**  
