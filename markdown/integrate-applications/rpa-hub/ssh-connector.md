...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/ssh-connector.html
release: zurich
product: RPA Hub
...
-   To use a connector in RPA Desktop Design Studio, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-connector.md). Add the Secure Shell connector in the Global Objects.

    \[Omitted image "ssh-connector-add-global-object.png"\] Alt text: Add Secure Shell connector in the Global Objects

-   To learn more about the various methods in the SSH connector, see [Secure Shell \(SSH\) connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/connector-ssh-methods.md).

-   **[Secure Shell \(SSH\) connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/connector-ssh-methods.md)**  
