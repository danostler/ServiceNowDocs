...
1.  Add a row for each record you want to add to the table.
    ...
    Each column corresponds to a field in the target table. Use the UI [Field administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/c_IntroductionToFields.md) to learn about the purpose and content of the field.
