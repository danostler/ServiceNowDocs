...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/system-import-sets/create-custom-type-data-source.html
release: zurich
...
For additional information, see [Custom \(Load by Script\) type data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/system-import-sets/custom-type-data-source.md).
...
Script used to load data. For more information, see [Custom \(Load by Script\) type data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/system-import-sets/custom-type-data-source.md).
