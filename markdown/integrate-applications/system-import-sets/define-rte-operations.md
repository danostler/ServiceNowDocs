...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/system-import-sets/define-rte-operations.html
release: zurich
...
6.  Complete the form.
    ...
    |Conditional Script|Condition specified as a string. For an example of a conditional script, see [Temporary entity model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/system-import-sets/temp-entity-model.md).|
