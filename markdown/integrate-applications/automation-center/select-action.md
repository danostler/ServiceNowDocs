...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/automation-center/select-action.html
release: zurich
...
Proceed from the **Select a spoke** section. For information on selecting a spoke, see [Select a spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/automation-center/select-spoke.md).
...
1.  Select an action.
    ...
    If you want to create a new action, select **Create action**. For detailed information, see [Creating an action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/automation-center/creating-action.md).
