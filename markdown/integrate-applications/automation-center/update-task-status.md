...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/automation-center/update-task-status.html
release: zurich
...
6.  Follow the steps in the [Edit a task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/automation-center/edit-task.md) section to update the status of the task.
