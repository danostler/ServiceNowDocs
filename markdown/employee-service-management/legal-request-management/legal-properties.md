...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/legal-request-management/legal-properties.html
release: zurich
...
The number of retries permitted before removing all errored permission entries from the job execution queue.
 ...
 -   Type: integer
-   Default value: 5
-   Learn more: [Configure an external storage system for legal requests and legal matters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-request-management/integrate-legal-ext-storage.md)
