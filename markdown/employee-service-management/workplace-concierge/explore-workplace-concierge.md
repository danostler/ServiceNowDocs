...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-concierge/explore-workplace-concierge.html
release: zurich
...
-   Create insights for employees, which are personalized and displayed on the Presence dashboard and the calendar section. For more information, see [Create custom insights using Proactive Prompts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown).
