...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/edit-schedule-plan.html
release: zurich
...
5.  Navigate to the Mapping page, then select **Create Plan**.
    ...
    For more information about user-space mapping and validation, see [Create a schedule plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/create-schedule-plan.md).
