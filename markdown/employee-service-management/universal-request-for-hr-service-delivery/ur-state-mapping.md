...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/universal-request-for-hr-service-delivery/ur-state-mapping.html
release: zurich
...
3.  On the form, fill in the fields.
    ...
    For more information on the field description, see [State mapping form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/universal-request-for-hr-service-delivery/ur-state-mapping-form.md).
