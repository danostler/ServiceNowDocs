...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/recruitment-workspace/manage-hiring-team.html
release: zurich
...
4.  Edit the relevant fields in the Hiring team list.
    ...
    |Field|Description|
    |-----|-----------|
    |Hiring role|Hiring role for the hiring team member. For details on roles, see [.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/roles-in-ta.md)|
