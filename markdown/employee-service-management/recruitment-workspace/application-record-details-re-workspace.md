...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/recruitment-workspace/application-record-details-re-workspace.html
release: zurich
...
You can schedule an interview with an applicant from the application page. For more information, see [Schedule an interview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/interview-management/schedule-interview.md).
...
-   As an interviewer, select the record assigned to you to provide feedback. For more information, see [Provide interview feedback](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/interview-management/provide-interview-feedback-recruiter.md).
