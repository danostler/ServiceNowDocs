...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/recruitment-workspace/config-task-mapping.html
release: zurich
...
6.  In the Answer new record form, fill in the fields, and select **Submit**.
    ...
    For a description of the field values, see [Task mapping form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/recruitment-workspace/answer-record-ta.md).
