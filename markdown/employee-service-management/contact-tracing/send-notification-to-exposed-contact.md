...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/contact-tracing/send-notification-to-exposed-contact.html
release: zurich
...
[Create a case task for each exposed contact](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/contact-tracing/create-task-exposed-contact.md).
