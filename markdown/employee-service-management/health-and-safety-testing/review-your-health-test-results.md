...
3.  Modify the record by adding an attachment or review the record.
    ...
    -   If you are adding an attachment, such as test results, add the attachment and then click **Update**.
        ...
        **Note:** For information on managing attachments, see [Manage attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/t_ManagingAttachments.md).
