...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/lifecycle-events/configure-schedule-content-template-for-lifecycle-event.html
release: zurich
...
|------------|-----------|
|[Configure mobile content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/now-mobile-employee-experience/ecpro-content-delivery-mobile.md)|Mobile content is delivered as a mobile banner in the Now Mobile and Mobile Onboarding apps.|
|[Content Publishing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ec-publish-content.md)|Portal content is delivered as content \(such as a banner, calendar, or video\) in a portal such as the Employee Service Center.|
|[Notification content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ec-notification-content.md)|Notification content is delivered as a notification.|
|[Creating to-do content that appears in a banner or styled content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ecpro-content-to-dos.md)|To-do content is delivered as a to-do in both portal and mobile.|
...
6.  Add additional fields with corresponding values, as needed.
    ...
    -   To-do content
    For a list of the available fields for each content type, see [Schedule content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ec-content-publishing-schedule.md).
