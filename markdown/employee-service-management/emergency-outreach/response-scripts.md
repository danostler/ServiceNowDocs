...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/emergency-outreach/response-scripts.html
release: zurich
...
**Note:** The [Employee Readiness Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/safe-workplace/employee-readiness-surveys.md) app must be installed to use response scripts.
