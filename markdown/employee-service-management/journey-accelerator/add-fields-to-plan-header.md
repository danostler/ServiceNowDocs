...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/journey-accelerator/add-fields-to-plan-header.html
release: zurich
...
8.  Click **Update** again.
    ...
    Configure unique plan headers for different plan types. For more information, see [Create and manage Journey Accelerator plan types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/journey-accelerator/create-manage-ja-plans.md).
