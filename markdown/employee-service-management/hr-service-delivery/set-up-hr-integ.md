...
3.  Create a flow in Flow Designer.
    ...
    For more information, refer to [Create a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/workflow-studio/create-flow.md).
