...
3.  Select a button.
    ...
    -   **Follow**: Track activity on the case or follow a record in Connect Chat to track activity as it happens. For more information, see [Follow a record in Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/connect/t_StartARecordConversation.md).
