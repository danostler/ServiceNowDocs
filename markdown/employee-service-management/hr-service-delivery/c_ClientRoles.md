...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/c\_ClientRoles.html
release: zurich
...
Client roles define access within the application. For more information, see [Manage HR roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/c_ManageRoles.md).
...
-   Alumni \(only used when you have the Alumni Center installed\). For more information, see [Setting up your Alumni Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/alumni-center/asc-configure.md).
-   Contingent
-   Contractor
-   Employee
-   Employment Type
...
-   **[Client role assignment rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/t_ClientRoleAssignRules.md)**  
