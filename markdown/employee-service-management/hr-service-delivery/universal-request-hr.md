...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/universal-request-hr.html
release: zurich
...
At any point in time, the HR agent can [transfer the HR case back](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/route-ur-hr-case.md) to the universal request queue with or without resolution.
...
-   **[Custom configurations in Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/setup-hr-ur.md)**  
...
-   **[Create an HR case from Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/create-ur-hr-case.md)**  
Restore service to a customer as soon as possible. After creating the HR case, you can investigate potential solutions.
-   **[Work on an HR case of Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/work-hr-ur-case.md)**  
Provide resolution to an HR case that is initiated from a universal request.
-   **[Transfer an HR case in Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/route-ur-hr-case.md)**  
Transfer an HR case back to the Universal Request, or to another department or service with or without resolution.
-   **[Creating a universal request from an HR case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/hr-ur-omnichannel.md)**  
...
-   **[Create associated tickets from an HR case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/associate-tickets.md)**  
