...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/activating-schedule-flows-sf.html
release: zurich
...
5.  Expand **Call Run SuccessFactors Service Subflow**.
    ...
    Once data is pulled into staging tables, transform maps moves data into target tables. For more details, refer to [Use transform maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/transform-maps-w.md).
