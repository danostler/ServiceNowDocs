...
5.  In the **Variables** related list, configure the variables for the HR catalog item as appropriate.
    ...
    -   Select Box
    -   Single Line Text
    To learn more about the different types of variables and how to configure them, see [Types of service catalog variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/service-catalog/r_VariableTypes.md).
