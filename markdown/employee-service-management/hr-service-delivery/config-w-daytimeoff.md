...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/config-w-daytimeoff.html
release: zurich
...
Configure the required reports for the Time Off request functionality. See [Configure reports HR Service Delivery Advanced Integration with Workday](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/awd-config-re.md).
