...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/journey-designer/jny-create-manage-journey-types.html
release: zurich
...
4.  Click the search icon next to a role to change the header configuration for that role.
    ...
    -   View for employee
    -   View for mentor
    See [Create and configure Journey designer headers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/journey-designer/jny-dsgnr-header-configuration.md) to customize headers for a plan.
