...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/legal-simple-contracts/legal-request-nda.html
release: zurich
...
-   **[Submit a legal request for a NDA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-contracts/submit-legal-contract-request.md)**  
Submit a legal request for a non-disclosure agreement with third parties such as vendors, customers, or partners.
-   **[Work on a legal contract request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-contracts/work-on-legal-contract-request.md)**  
...
-   **[Review and finalize the contract document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-contracts/finalize-contract-document-nda.md)**  
Review and finalize the contract document for sending it for signature.
-   **[Signature process for a legal request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-contracts/lsd-signature-workflow.md)**  
...
-   **[Add a manually signed contract](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-contracts/upload-contract-document-for-wet-signature.md)**  
