...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/topic-facets.html
release: zurich
...
-   The base system facet levels available are two. You can add up to 10 levels.
    ...
    For more information on adding facet levels, see [Configure search by the topic facets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/config-facets.md).
