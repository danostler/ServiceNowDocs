...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/add-hotspots-track-custom-widget-performance.html
release: zurich
...
Open the Performance details window to view how long the custom widget takes to load data: [View widget performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/view-widget-performance-metrics.md)
