...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/universal-task/config-catalog-task.html
release: zurich
...
**Previous topic:**[Configure Universal Task for your service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/universal-task/config-ut-for-service.md)

**Next topic:**[Configure the roles to view employee forms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/universal-task/ut-config-empform-view-roles.md)
