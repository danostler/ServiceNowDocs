...
7.  Click **Save**.
    ...
    **Note:** Due to access control list \(ACL\) restrictions, the **New** button might not work while you are creating a task. You can hide the **New** button on the related list and use the UI action to create a universal task.
    ...
    For more information on adding related lists, see [Related lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/c_RelatedLists.md).
