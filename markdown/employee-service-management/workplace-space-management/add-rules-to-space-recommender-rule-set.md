...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-space-management/add-rules-to-space-recommender-rule-set.html
release: zurich
...
-   Space recommender rules are already created. Otherwise, [Create a Space Recommender rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-space-management/create-a-space-recommender-rule.md).
-   Space recommender rule set is already created. Otherwise, [Configure a Space Recommender Rule set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-space-management/configure-space-recommender-rule-sets.md).
