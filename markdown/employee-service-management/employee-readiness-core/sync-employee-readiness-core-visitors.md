...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-readiness-core/sync-employee-readiness-core-visitors.html
release: zurich
...
-   The Workplace Visitor Management application must be installed. For more information, see [Install Workplace Visitor Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-visitor-management/install-workplace-visitor-mgmt.md).
