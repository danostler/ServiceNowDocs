...
4.  In the **User criteria** field, select a user criteria record.
    ...
    For more information about the fields on this form, see [User criteria form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/workplace-reservation-management/user-criteria-form.md).
