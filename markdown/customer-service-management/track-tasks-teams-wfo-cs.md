...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/track-tasks-teams-wfo-cs.html
release: zurich
topic_type: task
...
6.  Assign a work item to an agent.
    ...
    1.  Select a task that you want to assign to an agent.
        ...
        To add your own matching rule, see [Create a criteria for a matching rule in Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/assignment-rules-work-scheduler-wfo-cs.md).
    ...
    3.  Select and drag your mouse device for the time span on the calendar for which you want the agent to work on the task.
