...
1.  Deactivate the Propose Solution UI action for the Customer Service Management application.
    ...
    2.  Configure the list to show the Application column.
        ...
        For more information on how to configure a list, see [Configure the list layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/list-administration/t_ConfigureTheListLayout.md).
