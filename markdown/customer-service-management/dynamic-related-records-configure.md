...
Records appear in the Related Records tab in a card format. This format is created with [Entity View Action Mapper](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/entity-view-action-mapper-evam/entity-view-action-mapper.md) \(EVAM\), a ServiceNow AI Platform application that standardizes how different data sources display in cards and lists.
...
-   [Define an EVAM view configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/entity-view-action-mapper-evam/configuring-entity-view-action-mapper.md)
-   [Define an EVAM view template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/entity-view-action-mapper-evam/define-evam-template.md)
