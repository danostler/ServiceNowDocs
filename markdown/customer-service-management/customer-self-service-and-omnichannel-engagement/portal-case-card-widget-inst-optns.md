...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/customer-self-service-and-omnichannel-engagement/portal-case-card-widget-inst-optns.html
release: zurich
...
12. On the Instance form, fill in the fields.
    ...
    For a description of the field values, see [Portal Case Cards widget instance options form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/r-port-case-cards-instan-options.md).
