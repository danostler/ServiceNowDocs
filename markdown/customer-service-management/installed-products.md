...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/installed-products.html
release: zurich
...
|[Create installed products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/create-deployed-sold-item.md)|Create an installed product to create an association between sold products and install base items.|
