...
You can use the [Advanced Work Assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/awa-overview.md) \(AWA\) feature to automatically assign work items to users based on their availability and capacity.
...
1.  Create the case task service channel.
    ...
    2.  Fill in the fields on the Service Channel form.
        ...
        |Inbox order|Order in which channel items appear in the user inbox. The **Inbox Order** field is an integer [field type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/r_FieldTypes.md). This field can store whole numbers.|
    ...
    For more information about creating an AWA service channel, see [Create a service channel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/awa-create-service-channel.md).
...
2.  Configure the layout for the case task inbox card.
    ...
    For more information about configuring the card layout, see [Create or modify an inbox layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/awa-modify-inbox-layout.md).
...
3.  Create a queue for the case task service channel.
    ...
    For more information about configuring a queue, see [Create a work item queue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/awa-create-queue.md).
...
4.  Create an assignment rule for the Case Task Assignment queue.
    ...
    For more information about creating an assignment rule, see [Configure agent assignment rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/awa-create-assignment-rule.md).
...
5.  Create a group for the Case Task Assignment queue.
    ...
    For more information about creating a group, see [Create or modify groups for Advanced Work Assignment queues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/awa-groups.md)
...
7.  Activate the service channel.
    ...
    Once the service channel is activated, you can use it to assign work items. For more information, see [Service channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/awa-service-channels.md).
