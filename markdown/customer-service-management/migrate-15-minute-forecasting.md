...
1.  Set the **sn\_agent\_forecast.forecast\_interval** system property value to `15`.
    ...
    1.  Set the application scope to Agent Forecast using the [application picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/building-applications/c_ApplicationPicker.md).
