...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/create-task-plan-template-item-condition.html
release: zurich
topic_type: task
...
6.  Select **New**.
    ...
    For more information about these fields, see [Template item condition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/task-plan-template-item-condition-form.md).
