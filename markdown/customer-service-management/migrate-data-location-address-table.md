...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/migrate-data-location-address-table.html
release: zurich
topic_type: concept
...
**Note:** Review step 4 within the [Enable enhanced address model for accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/enable-enhanced-address-model.md) to get details on how to migrate data.
