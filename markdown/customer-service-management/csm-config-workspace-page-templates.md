...
</table>For more information, see [Create a page from a template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/ui-builder/reuse-page-definitions.md) in the UI Builder documentation.
