...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/environmental-social-governance/create-metric-data-template.html
release: zurich
topic_type: task
...
Upload the complete metric import template as part of an metric import job. For more information, see [Import historical metric data and tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/import-metric-data.md).

**Parent Topic:**[Importing historical metric data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/importing-metric-data.md)
