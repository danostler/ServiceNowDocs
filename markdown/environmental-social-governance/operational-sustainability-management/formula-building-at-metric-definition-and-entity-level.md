...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/environmental-social-governance/operational-sustainability-management/formula-building-at-metric-definition-and-entity-level.html
release: zurich
...
-   **[General guidelines for formula building](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/operational-sustainability-management/Formula-building-general-guidelines.md)**  
...
-   **[Configure the formula builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/operational-sustainability-management/configure-formula-builder.md)**  
Specify the formula context, the tables, and the identifiers before you can build a formula.
-   **[Import a formula into a calculated metric definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/operational-sustainability-management/import-a-formula-into-a-cmd.md)**  
...
-   **[Create a formula](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/operational-sustainability-management/create-a-formula.md)**  
Build your own formula using either entities or metric definitions.
-   **[Set default values for CMD formula operands](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/operational-sustainability-management/activate-default-values-for-cmd-calculations.md)**  
