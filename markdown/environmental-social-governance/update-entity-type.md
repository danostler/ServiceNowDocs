...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/environmental-social-governance/update-entity-type.html
release: zurich
topic_type: task
...
3.  On the form, update the fields as necessary.
    ...
    |-----|-----------|
    |Tabs|
    |Details tab|Information on the entity. See [Create an entity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/create-entity.md) for more information.|
    |Related lists|
