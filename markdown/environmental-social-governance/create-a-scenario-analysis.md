...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/environmental-social-governance/create-a-scenario-analysis.html
release: zurich
topic_type: task
...
By default, the instance chooses the best method for you automatically, based on the fit of the method. For more information, see [Automatic selection of forecast methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/configure-forecast-ts-viz.md).
...
For more information, see [Forecast methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/configure-forecast-ts-viz.md).
...
Adjust parameters to model different outcomes based on specific interventions or changes. For more information, see [Adjust parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/create-a-forecast-intervention.md).

**Parent Topic:**[Set up analysis contexts and analyses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/set-up-scenarios.md)
