...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/environmental-social-governance/add-locations-to-an-emission-factor.html
release: zurich
topic_type: task
...
**Parent Topic:**[Create an emission factor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/create-an-emission-factor.md)
