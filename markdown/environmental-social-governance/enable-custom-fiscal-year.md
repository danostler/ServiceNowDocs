...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/environmental-social-governance/enable-custom-fiscal-year.html
release: zurich
topic_type: task
...
Map the source and target calendars. For more information, see [Map target and source calendars](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/map-target-and-source-calendars.md).

-   **[Map target and source calendars](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/map-target-and-source-calendars.md)**  
...
-   **[Add entities for fiscal calendars](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/add-entities-for-a-fiscal-calendar.md)**  
