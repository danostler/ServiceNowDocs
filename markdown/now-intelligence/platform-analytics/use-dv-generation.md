...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/platform-analytics/use-dv-generation.html
release: zurich
...
7.  To add the visualization to a collaborative workspace in AI Data Explorer, select **Add to exploration**.
    ...
    For more information, see [Use AI to explore data with AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/now-assist-explorer.md).
...
-   **[Guidelines and example questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/example-questions-generating-dv.md)**  
...
-   **[Limitations to generating data visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/limitations-generating-dv.md)**  
...
**Parent Topic:**[Generate or export dashboards and data visualizations in the Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/analytics-assist-landing-page.md)
