...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/platform-analytics/add-table-semantic-layer.html
release: zurich
...
5.  Select whether to enable semantic generation for the table.
    ...
    By default, semantic generation is enabled. For more information, see [Enable semantic generation for tables in the semantic layer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/enable-semantics-generation.md).
