...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/platform-analytics/activate-now-ass-explorer.html
release: zurich
...
6.  Configure the analytics exploration skill.
    ...
    1.  In the **Advanced analysis** page, you can activate record-level analysis and set which tables it applies to.
        ...
        For more information, see [Configure record level analysis in AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/record-level-analysis.md).
