...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/platform-analytics/tables-sched-jobs-query-gen.html
release: zurich
...
A log of every call to Query Generation. For more information, see [Query Generation logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/query-generation-logs.md).
