...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/platform-analytics/analytics-assist-landing-page.html
release: zurich
...
[Explore\[Omitted image "bus-explore.svg"\] Alt text:Learn more about how you can work with Platform Analytics in the Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/exploring-analytics-assist.md)

</td><td>

[Configure\[Omitted image "bus-sdlc.svg"\] Alt text:Enable visualization generation and export skills for an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/configuring-now-ass-skills-pa.md)

</td><td>

[Generate data visualizations\[Omitted image "bus-app-creator.svg"\] Alt text:How to create data visualizations conversationally in the Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/use-dv-generation.md)
...
[Reference\[Omitted image "bus-learn.svg"\] Alt text:Roles and tables that are included with the data visualization generation and export skills](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/analgen-reference.md)
...
-   **[Explore generating or exporting dashboards and visualizations in the Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/exploring-analytics-assist.md)**  
Generate and export Platform Analytics artifacts from conversational interactions. For example, ask for information about the number of open incidents and get a single-score data visualization. Then export that visualization as a PDF file, all in the Now Assist panel.
-   **[Configuring Now Assist panel skills for Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/configuring-now-ass-skills-pa.md)**  
...
-   **[Generate visualizations in the Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/use-dv-generation.md)**  
...
-   **[Export dashboards and data visualizations from the Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/export-db-dv-now-assist-panel.md)**  
...
-   **[Reference for dashboard and visualization skills](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/analgen-reference.md)**  
...
**Parent Topic:**[Now Assist in Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/platform-analytics/now-assist-platform-analytics.md)
