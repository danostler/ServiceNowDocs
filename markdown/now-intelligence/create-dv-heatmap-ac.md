...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/create-dv-heatmap-ac.html
release: zurich
topic_type: task
...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for heatmap visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-dv-heatmap-table.md).
    -   If your visualization represents indicator data, go to [Indicator data options for heatmap visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-dv-heatmap-ind.md).
...
-   **[Table data options for heatmap visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-dv-heatmap-table.md)**  
When you select a table data source for a heatmap visualization, the following Data configuration options are available.
-   **[Indicator data options for heatmap visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-dv-heatmap-ind.md)**  
...
-   **[Heatmap visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/dv-example-heatmap.md)**  
