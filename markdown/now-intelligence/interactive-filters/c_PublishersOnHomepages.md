...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/interactive-filters/c\_PublishersOnHomepages.html
release: zurich
...
-   **[Add an interactive filter widget to a responsive dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/interactive-filters/t_AddIntFilterToAResponsiveDboard.md)**  
Add an interactive filter to a dashboard to filter reports on that dashboard.
-   **[Make a breakdown act as an interactive filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/interactive-filters/make-breakdown-interactive-filter.md)**  
...
-   **[Make a report follow interactive filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/interactive-filters/t_MakeAReportASubscriber.md)**  
...
-   **[Make a report act as an interactive filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/interactive-filters/t_MakeAReportAPublisher.md)**  
You can configure an existing report widget to filter other report widgets on the same dashboard.
-   **[Reset all interactive filters on a dashboard tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/interactive-filters/reset-all-filters.md)**  
