...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/spotlight/collect-spotlight-scores.html
release: zurich
product: Spotlight
...
1.  [Create a Spotlight group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/spotlight/create-spotlight-group.md)
2.  [Create Spotlight criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/spotlight/create-spotlight-criteria.md)
...
6.  If you are using domain separation, specify a user in the **Run as** field.
    ...
    For more information, see [Domain separation with Spotlight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/spotlight/domain-separation-spotlight.md).
