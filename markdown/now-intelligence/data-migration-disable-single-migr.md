...
2.  Add the system property **com.glide.par.coreui\_single\_migration.enabled** if it does not already exist.
    ...
    For more information, see [Available system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/r_AvailableSystemProperties.md).
