...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/configuring-dashboards.html
release: zurich
topic_type: concept
...
-   [Change dashboard name or description](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-db-in-ac.md)

    Provide an informative description of your dashboard for other users.

-   [Specify dashboard requester](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-db-in-ac.md)
...
-   [Transfer ownership of a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-db-in-ac.md)
...
-   [Set background colors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/configure-ac-db-settings.md)

    Select the background colors for one or more tabs on the dashboard.

-   [See who created a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-db-in-ac.md)
-   [See who the dashboard is shared with](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-db-in-ac.md)

## Admin configuration tasks

The following tasks require at least the dashboard\_admin if not the admin role.

-   [Set data refresh options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/configure-ac-db-settings.md)
...
-   [Certify a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/certify-db-ac.md)

    Certify that a dashboard has been officially approved for use by your organization. Requires the admin role.

-   [Configure Platform Analytics dashboard tab cache timeout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/configure-ac-db-timeout.md)
...
-   [Manage which workspaces are allowed to contain the dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/config-db-in-ac.md)
...
-   [Move a Platform Analytics dashboard with an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/move-pae-db-with-update-set.md)
...
-   [Configure a Process Mining map on a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/configure-po-map.md)
...
-   [Creating Process Mining projects from Proactive Analytics suggestions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/proactive-analytics/pm-projects-insights-suggestions.md)
