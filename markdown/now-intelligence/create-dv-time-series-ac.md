...
Display settings: Each visualization type, such as Area and Column, has a different set of display settings. See [Display settings for different time series data visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/display-settings-ts-charts.md).
...
-   **[Display settings for different time series data visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/display-settings-ts-charts.md)**  
