...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/process-mining/reco-setup.html
release: zurich
...
3.  Open a table from the **Configurations** tab.
    ...
    If you’re proceeding from the **Process details** page, then you come to this page. For more information, see [Configure process details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/process-mining/process-details.md).
...
5.  Fill the details in the **Breakdown fields** section.
    ...
    **Note:**
    ...
    For information about how these recommendations are provided when setting the breakdown definitions in a project, see [Set breakdown definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/process-mining/breakdown.md).
...
Priority
    ...
    For more information about how these settings are available in the child tables when creating a project, see [Set use cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/process-mining/adv-settings.md).
