...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/config-dv-pivot-uxa-data.html
release: zurich
...
You have selected a Usage Insights data source in [Create a pivot table data visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-dv-pivot-ac.md).
