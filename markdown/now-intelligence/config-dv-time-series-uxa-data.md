...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/config-dv-time-series-uxa-data.html
release: zurich
...
You have selected a Usage Insights data source in [Create time series data visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-dv-time-series-ac.md).
