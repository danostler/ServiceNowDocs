...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/show-compare-edit-records.html
release: zurich
topic_type: concept
...
-   Records are not available for [formula indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/performance-analytics-glossary.md), such as indicators that calculate percentages or averages.
...
You can compare records filtered on up to two [breakdowns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/performance-analytics-glossary.md), each with one element. You cannot compare records filtered on multiple level elements.
