...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/data-migration-relaunch.html
release: zurich
topic_type: task
...
Evaluate the newly migrated content. For more information, see [Evaluate full data migration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/data-migration-evaluate.md).
