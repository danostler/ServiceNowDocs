...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/config-dv-sing-sc-table-data.html
release: zurich
...
You have selected a Table data source in [Create a single score data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-dv-sing-sc-ac.md).
