...
4.  In the column **Do not migrate in bulk**, change the flag from false to true for the artifacts you want to exclude.
    ...
    You can select multiple consecutive or non-consecutive fields. For more information, see [Edit multiple records in a list using the list editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/t_EditMultRecUsingListEditor.md).
