...
8.  Clear the **Send an email invitation** check box.
    ...
    **Note:** Sending email from within your instance requires configuration of email servers. For more information, see [Basic email setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/c_StandardEmailConfiguration.md).
