...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/performance-analytics/t\_CreatingABreakdownForIndicators.html
release: zurich
...
**Note:** This process allows you to create a fully customized breakdown. To create a simple automated breakdown, see [Create a breakdown from a wizard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/t_CreateBreakdownFromWizard.md).
...
4.  Select a **Default elements filter**.
    ...
    Use element filters to restrict the elements that are visible to a user. For more information, see [Element filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/c_BreakdownElementFilters.md).
...
**Previous topic:**[Automated breakdowns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/automated-breakdowns.md)

**Next topic:**[Create a breakdown mapping on a breakdown record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/t_CrtBkdnBreakdownMpngs.md)
