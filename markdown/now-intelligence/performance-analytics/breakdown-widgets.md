...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/performance-analytics/breakdown-widgets.html
release: zurich
...
|\[Omitted image "scorecard-icon.png"\] Alt text: Scorecard icon|[Scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/create-scorecard-widget.md)|Shows the trends for one breakdown for a single indicator.|
...
|\[Omitted image "relative-compare-icon.png"\] Alt text: Relative compare icon|[Relative Compare](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/create-relative-compare-bkdn.md)|Shows how multiple breakdowns diverge over time.|
