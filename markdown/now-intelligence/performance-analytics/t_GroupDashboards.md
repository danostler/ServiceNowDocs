...
4.  Open the form of the dashboard group to modify its permissions.
    ...
    Dashboard groups use standard platform permissions. For more information, see [Access control list rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/access-control/access-control-rules.md).
