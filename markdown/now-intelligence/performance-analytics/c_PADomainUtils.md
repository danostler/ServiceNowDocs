...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/performance-analytics/c\_PADomainUtils.html
release: zurich
...
-   **[PADomainUtils - PADomainUtils\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/r_PADU-PADomainUtils.md)**  
Instantiates a new PADomainUtils object to move or copy Performance Analytics records from the global domain.
-   **[PADomainUtils - PADomainUtils\(String domainFrom\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/r_PADU-PADomainUtils_String.md)**  
Instantiates a new PADomainUtils object to move or copy Performance Analytics records from the specified domain.
-   **[PADomainUtils - setFoundation\(Boolean foundation\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/r_PADU-setFoundation_boolean.md)**  
Use this method to move or copy only foundational records in a hybrid domain configuration.
-   **[PADomainUtils - setOverrides\(Boolean overrides\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/r_PADU-setOverrides_boolean.md)**  
Use this method before copying records to set the sys\_override value of the new record to the original parent record.
-   **[PADomainUtils - copy\(String runAs\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/r_PADU-copy_String.md)**  
Copies Performance Analytics records to a different domain.
-   **[PADomainUtils - copyJob\(String paJob, String runAs\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/r_PADU-copyJob_String_String.md)**  
Copies a Performance Analytics scheduled data collection job record to another domain.
-   **[PADomainUtils - copyDashboard\(String dashboardId, String runAs\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/PADU-copyDashboard_S_S.md)**  
Copy a dashboard to another domain.
-   **[PADomainUtils - move\(String runAs\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/r_PADU-move_String.md)**  
Moves Performance Analytics records to a different domain.
-   **[PADomainUtils - isWriteable\(String table, String id\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/r_PADU-isWriteable_String_String.md)**  
