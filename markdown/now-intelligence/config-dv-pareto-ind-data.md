...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/config-dv-pareto-ind-data.html
release: zurich
...
You have selected an Indicator or Usage Insights data source in [Create a horizontal or vertical bar data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-dv-bar-ac.md).
