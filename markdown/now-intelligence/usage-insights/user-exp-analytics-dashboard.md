...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/usage-insights/user-exp-analytics-dashboard.html
release: zurich
...
breadcrumb: [Explore, Usage Insights, Platform Analytics]
---
...
\[Omitted image "uxa-overview-tabs.gif"\] Alt text: GIF alternating the Overview and Events tabs of the Usage Insights application
...
|Module|Description|
|------|-----------|
|Retention|Visualize new users and their rates of return and periods between visits. For more information, see [User retention](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/view-retention-analytics.md).|
...
|Navigation paths|Visualize users' journeys through your application, discovering the most and least popular paths. For more information, see [Navigation paths](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/view-navigation-paths.md).|
...
\[Omitted image "uxa-overview-sp-app.png"\] Alt text: Usage Insights overview - Service Portal application
...
**Parent Topic:**[Exploring Usage Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/exploring-user-exp-analytics.md)
