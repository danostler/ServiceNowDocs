...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/usage-insights/uxa-tracking-types.html
release: zurich
...
-   Analytics administrators can choose to store additional user properties. See [Add user properties as filters to User Experience Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/uxa-add-filters-uxa-pages.md) for more information.
...
-   **[View assigned consent policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/uxa-define-consent-policy.md)**  
...
-   **[View and update an individual country’s consent policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/uxa-view-policy-country.md)**  
View a list of all countries with their assigned consent policies and select a country to update its existing policy.
-   **[Define how to detect your user's location](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/uxa-define-detect-location.md)**  
...
-   **[Tracking controls and data collection behavior](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/uxa-tracking-controls-and-data-collection-behavior.md)**  
