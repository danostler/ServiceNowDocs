...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/applying-filters-to-process-optimization-maps.html
release: zurich
topic_type: concept
...
You can also see and change the breakdowns in the table configuration record for the project. For more information, see [Configure a breakdown definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/process-mining/configure-breakdown.md).
