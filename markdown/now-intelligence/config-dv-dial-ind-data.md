...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/config-dv-dial-ind-data.html
release: zurich
...
You have selected an indicator data source in [Create a dial data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-dv-dial-ac.md).
