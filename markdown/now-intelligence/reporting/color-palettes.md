...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/color-palettes.html
release: zurich
product: Reporting
...
**Tip:** A ServiceNow AI Platform or Performance Analytics admin can create custom Core UI color palettes. For more information, see [Create a color scheme](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/color-schemes-pa-widgets.md).
