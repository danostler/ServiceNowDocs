...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/reporting-roles.html
release: zurich
product: Reporting
...
For more information, see [Administer table and field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reporting/admin-table-field-descriptions.md).
