...
To create a report\_view ACL, follow the [general procedure for creating an ACL rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/access-control/t_CreateAnACLRule.md), but bearing the following points in mind:
...
[ACL rule types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/access-control/acl-rule-types.md)
