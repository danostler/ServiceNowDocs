...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/view-impacted-reports.html
release: zurich
product: Reporting
...
When this column is populated, the report is affected because of an ACL on an extended table. For more information, see [Report on extended tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reporting/t_AccessFieldExtendedTable.md).
...
</table>2.  Address the affected reports and users as described in [Manage Report ACL assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reporting/view-report-acl-remediation.md).
