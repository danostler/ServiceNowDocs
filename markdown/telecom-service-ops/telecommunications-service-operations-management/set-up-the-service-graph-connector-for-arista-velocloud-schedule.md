...
4.  Enable the Service Graph Connector to reference the VeloCloud connection by name, extracting active aliases from the CMDB, and initiate data collection on the associated HTTP connection by creating connection aliases, credentials, and HTTP connections.
    ...
    3.  Create the basic credentials to access the VeloCloud Orchestrator.
        ...
        3.  In the **API Key** field, enter the API key created in the VeloCloud Orchestrator.
            ...
            **Note:** Other authentication fields might be required depending on the authentication methods used in your instance. By default, use basic authentication credentials as part of the Guided setup. For more information, see .
