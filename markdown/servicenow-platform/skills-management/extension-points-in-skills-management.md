...
**Important:** You can configure additional groups using the `sn_skill_cfg_page.ManageSkillsConstants` script include. For information on script includes see, [Script includes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/scripts/c_ScriptIncludes.md).
