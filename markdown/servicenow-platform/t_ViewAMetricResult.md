...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/t\_ViewAMetricResult.html
release: zurich
topic_type: task
...
[Assessment group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/c_AssessmentGroups.md) to which the metric result is associated.
...
[method](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/c_AssessmentMetrics.md) of the metric.
...
[Assessment instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/c_AssessmentInstances.md) completed by the **Assigned to** user. This field is blank when the method is **Script**.
...
-   **Assessment**: Value obtained from the user response to the assessment instance question. The actual value is determined by the metric data type:
    ...
    -   **Template**: The actual value is equal to the **Value** of the [template definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/r_MetricTemplates.md) associated with the chosen answer option.
...
-   **[Assessment Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/r_AssessmentsOverviewModule.md)**  
...
-   **[View assessment reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/view-assessment-report.md)**  
Use the Assessment Overview dashboard to view your assessment reports.
-   **[Assessment results calculation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/c_AssessmentResultsCalculation.md)**  
For every assessment group, there are assessment results.
-   **[View a bubble chart for assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_view-bubble-chart-assessments.md)**  
