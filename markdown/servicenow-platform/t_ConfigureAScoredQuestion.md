...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/t\_ConfigureAScoredQuestion.html
release: zurich
topic_type: task
...
A question must have a correct answer specified to be scored. Only results for scored questions are displayed in the [quiz scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/c_QuizScorecards.md).
...
6.  Select the **Correct answer** for the question.
    ...
    **Note:** Multiple correct answers are supported for a few data types. See [Data types for quizzes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/r_AvailableDataTypes.md).
