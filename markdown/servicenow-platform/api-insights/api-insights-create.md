...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/api-insights/api-insights-create.html
release: zurich
...
The application administrator must configure an API creation tool. See [Configure settings to manage APIs in API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/api-insights/api-insights-config-settings.md).
