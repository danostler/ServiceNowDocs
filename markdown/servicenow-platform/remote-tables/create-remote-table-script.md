...
Option to support editing the remote table and its external data source from the instance. Use the v\_record API to customize script definitions for inserting, updating, and deleting data in the table.
    ...
    For more information about these APIs, see [v\_table – Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/server-api-reference/v_tableAPI.md), [v\_query – Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/server-api-reference/v_queryAPI.md), and [v\_record - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/server-api-reference/v_recordAPI.md).
