...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/knowledge-management/view-knowledge-logs.html
release: zurich
...
-   **[Search Log fields and description](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/knowledge-management/km-search-logs.md)**  
The knowledge search log stores the history of all knowledge searches performed by the users.
-   **[View Log fields and description](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/knowledge-management/km-view-logs.md)**  
The knowledge View log stores the history of knowledge articles views and their usage.
-   **[View the source of a knowledge article search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/knowledge-management/find-knowledge-search-source.md)**  
Analyze knowledge searches by finding the source used for searching a knowledge article.
-   **[Modify the data retention policy for View logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/knowledge-management/auto-flush-kb-use.md)**  
