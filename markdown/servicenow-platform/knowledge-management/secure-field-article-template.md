...
1.  Create an encryption module for the article template field to be encrypted.
    ...
    See [Create a cryptographic module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/platform-encryption/create-cryptographic-module.md) for details.

2.  Associate the article template field with the encryption module.

    See [Encrypting fields and attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/servicenow-ai-platform-security/field-encryption-key-management.md) for details.
