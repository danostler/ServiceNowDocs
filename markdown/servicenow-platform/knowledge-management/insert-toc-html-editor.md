...
2.  Select the table of contents icon \(\[Omitted image "toc.png"\] Alt text: Table of Contents icon\) on the HTML toolbar.
    ...
    If you do not see the table of contents icon on the toolbar, add it using steps available in [Customize TinyMCE attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/tinymce.md).
