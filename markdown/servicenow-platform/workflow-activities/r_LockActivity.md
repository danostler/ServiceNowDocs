...
A unique mutex key. The [Unlock activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown) activity uses this key to release the lock.
