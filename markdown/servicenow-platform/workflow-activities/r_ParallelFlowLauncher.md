...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/workflow-activities/r\_ParallelFlowLauncher.html
release: zurich
...
-   **[WorkflowCoordinator object](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/workflow-activities/c_WorkflowCoordinatorObject.md)**  
A WorkflowCoordinator object specifies which subflows to run and the input variables to pass to those subflows.
-   **[Completed subflow values in scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/workflow-activities/c_CompletedSubflowValuesInScripts.md)**  
The **Parallel Flow Launcher** activity exposes additional variables you can use in scripts.
-   **[Parallel Flow Launcher example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/workflow-activities/r_ParallelFlowLauncherExample.md)**  
...
**Parent Topic:**[Subflow activities in workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/workflow-activities/c_SubflowActivities.md)
