...
You can monitor the overall localization health of the Service Catalog items from the [Localization Insights dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/localization-framework/localization-insights-dashboard.md). The dashboard provides the localization health of the system with reports that are generated from the localization insights records as per the scheduled jobs.
