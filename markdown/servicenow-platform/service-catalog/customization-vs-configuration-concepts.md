...
For more information, see the [Customer Updates table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/servicenow-ai-platform-security/r_CustomerUpdatesTable.md). Note that the complexity of maintaining customizations dramatically increases as the number of customizations increases.
