...
For more information, see [Request translations for Service Catalog items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/localization-framework/request-translations-multiple-items.md).
...
For more information, see [Request ad hoc translation for Service Catalog items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/localization-framework/req-adhoc-translation-for-sc-items.md).

## Translation States

|State|Mode|Description|
|-----|----|-----------|
|Not available|Request translation and Self-translation|If the [Localization Framework Insights record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/localization-framework/localization-insights-dashboard.md) is not available, the translation state displayed by the system is **Not Available**, and the state appears near the language name.|
