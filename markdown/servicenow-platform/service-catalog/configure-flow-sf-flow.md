...
1.  Create a Workflow Studio flow \(With the trigger type as Service Catalog\).
    ...
    For information about creating a flow with Service Catalog trigger type, see [Create a flow with a Service Catalog trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/workflow-studio/create-sc-flow.md).
