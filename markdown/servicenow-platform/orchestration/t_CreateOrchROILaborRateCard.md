...
2.  Complete the fields in the form using the descriptions in [Manage a labor rate card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-business-management/cost-management/t_ManageALaborRateCard.md).
