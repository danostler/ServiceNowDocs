...
Provides the labor rate cards Orchestration ROI uses to determine the savings for each automated task. See [Cost Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-business-management/cost-management/r_CostManagement.md) for more information.
