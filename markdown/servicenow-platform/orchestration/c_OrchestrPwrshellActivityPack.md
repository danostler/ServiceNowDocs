...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/orchestration/c\_OrchestrPwrshellActivityPack.html
release: zurich
...
-   **[PowerShell activity designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/orchestration/c_PowershellActivityDesigner.md)**  
PowerShell activities are configured to return data to a workflow from a host using Microsoft PowerShell.
-   **[PowerShell protocols and troubleshooting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/orchestration/powershell-protocols.md)**  
...
-   **[Join Domain activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/orchestration/r_JoinDomainActivity.md)**  
The Join Domain activity joins a Windows computer to a domain.
-   **[Install Windows App activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/orchestration/r_InstallWindowsAppActivity.md)**  
The Install Windows App activity installs an application from an MSI package on a Windows target machine.
-   **[Change Service State activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/orchestration/r_ChangeServiceState.md)**  
The Change Service State activity starts or stops a Windows service on a remote system.
-   **[Restart Windows Server activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/orchestration/r_RestartWindowsServerActivity.md)**  
The Restart Windows Server activity stops and then restarts a Windows server using Powershell.
-   **[Uninstall Windows App activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/orchestration/r_UninstallWindowsAppActivity.md)**  
