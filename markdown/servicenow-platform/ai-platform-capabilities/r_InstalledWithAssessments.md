...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/ai-platform-capabilities/r\_InstalledWithAssessments.html
release: zurich
...
Stores all [assessable records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_assessable-records.md).
...
Stores all [category results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_SchedulePeriods.md).
...
Stores associations between users and metric categories that they can evaluate. A user that is associated to a category is a [category user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_CategoryUsersAndStakeholders.md).

</td><td>

Stores associations between users and surveys. A user that is associated to a survey is a [survey user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_SurveyUsersAndGroups.md) and is automatically associated to all the survey's categories.
...
Stores all [assessment groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_CategoryResults.md).
...
Stores all [assessment instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_AssessmentInstances.md).

</td><td>

Stores all [survey instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_ViewSurveyInstance.md).
...
Stores all [metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_AssessmentMetrics.md).
...
Stores all [metric definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_CreateAMetricDefinition.md).

</td><td>

Stores all [answer options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_CreateOrModifyAnswerOptions.md) for survey questions.
...
Stores all [metric templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_MetricTemplates.md).
...
Stores all [metric types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_AssessmentInstances.md).

</td><td>

Stores all [survey definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_SurveyDefinitions.md).
...
Stores all [metric template definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_MetricTemplates.md).
...
Users can specify metric categories as the X axis of a [decision matrix](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_AdministerDecisionMatrixes.md).
...
Stores all [bubble chart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_BubbleChartComponents.md) definitions.
...
Stores all [decision matrixes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_AdministerDecisionMatrixes.md).
...
Stores all [metric categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_AssessmentMetrics.md).
...
Stores all [metric results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_ViewAMetricResult.md).

</td><td>

Stores all [survey responses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_SurveyResults.md).
...
Stores all [signature records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_CreateAnAssessmentSignature.md) for assessments and \[\[Attestations\|GRC attestations\]\].

</td><td>

Stores all signature records for[Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_SurveyManagementLandingPage.md).
...
Stores all [assessment trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_CreateTriggerAssessment.md).

</td><td>

Stores all [survey trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_TriggerConditions.md).
...
-   Default value: **Yes**
 ...
 For more information about working with signatures, see [Signatures](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_CreateAnAssessmentSignature.md).
...
</table>For more information about customizing the appearance of a survey, see [Customize the appearance of a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_CustomizingAppearance.md).
...
|MigrateSurveyToAssessment|Code for [migrating legacy surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_MigrateSurveys.md) to assessment surveys.|
...
</table>**Parent Topic:**[Assessments and Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/assessments-surveys-landing-page.md)
