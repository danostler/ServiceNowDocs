...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/servicenow-platform/ai-platform-capabilities/using-assessments.html
release: australia
...
-   **[Assessment administrator tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_AssessmentProcess.md)**  
Before you create assessments, assign the assessment\_admin role to the appropriate users in your organization and determine your objectives for the assessment.
-   **[Take an assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/t_TakeAnAssessment.md)**  
Take the assessments assigned to you from the assessment and survey queue.
-   **[Metric types and assessable records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_MetricTypesAndAssessableRecords.md)**  
