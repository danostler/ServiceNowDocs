...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/servicenow-platform/ai-platform-capabilities/set-up-rtt-itsm.html
release: australia
...
If you have already deployed ServiceNow Voice and are upgrading, go through all of the steps for [Setting up ServiceNow Voice](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/ccc-setup.md), and the steps in this procedure, before completing the setup on Amazon Connect.
...
**Parent Topic:**[Configure Real Time Transcription for ServiceNow Voice for IT Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/configure-rtt-sn-voice-itsm.md)
