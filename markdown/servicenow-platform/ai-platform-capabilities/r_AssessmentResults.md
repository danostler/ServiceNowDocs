...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/ai-platform-capabilities/r\_AssessmentResults.html
release: zurich
...
The system calculates [metric results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_ViewAMetricResult.md) first, normalizes the scores, and then calculates [category results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_ViewAMetricResult.md). Each metric and category result record stores data from one assessment group, for a particular category and source record evaluated. Specifically:
...
**Note:** Although results data is available to view in the form of metric and category result records, the most meaningful way to view results is in [scorecards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_ViewAnAssessmentScorecard.md) and decision matrixes. These tools display only the most pertinent data in graphical, comparative formats.
...
-   The user does not answer the question and the [data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/r_DataTypes.md) is not Checkbox.
...
**Parent Topic:**[View a metric result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_ViewAMetricResult.md)
