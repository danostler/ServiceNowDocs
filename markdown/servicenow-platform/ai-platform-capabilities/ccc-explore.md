...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/ai-platform-capabilities/ccc-explore.html
release: zurich
...
-   Manage presence states within the ServiceNow instance. For information about the presence states of an agent, see [Agent Inbox controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/agent-experience.md).
