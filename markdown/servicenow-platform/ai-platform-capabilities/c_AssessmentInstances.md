...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/ai-platform-capabilities/c\_AssessmentInstances.html
release: zurich
...
The system generates assessment instances only when the required conditions are met, as described in [Scheduled assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_ScheduledAssessments.md) and [On-demand assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/c_OnDemandAssessments.md), and there are non-scripted metrics in at least one category.
...
When the system generates an on-demand assessment [for a specific assessable record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_GenOnDemandAssessOneAssessRec.md), the assessment instance contains questions about that assessable record and all its associated categories. When the system generates an on-demand assessment [for a metric type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/ai-platform-capabilities/t_GenOnDemandAssessMultAssessRec.md), the assessment instance contains questions about all that metric type's assessable records and their associated categories.
