...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/servicenow-platform/ai-platform-capabilities/r\_SurveyAdminTasks.html
release: australia
...
-   **[View survey reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/view-survey-overview.md)**  
Use the Survey Overview dashboard to view various survey reports, such as Surveys by Metric Type and State.
-   **[Survey designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_SurveyDesigner.md)**  
...
-   **[View a survey instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/t_ViewSurveyInstance.md)**  
...
-   **[Survey users and groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_SurveyUsersAndGroups.md)**  
Survey users and survey user groups help survey administrators control who can take a survey.
-   **[Copy a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/copy-survey.md)**  
Create a copy of a survey with at least one category to reduce the effort of creating another survey with similar data.
-   **[Publish a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/t_PublishASurvey.md)**  
You must publish a survey to enable people to receive and complete survey instances.
-   **[Customize the appearance of a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/t_CustomizingAppearance.md)**  
...
-   **[Survey definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_SurveyDefinitions.md)**  
A survey definition is the root record upon which a survey is built.
-   **[Create a survey designer template question](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/t_CreateASurveyDesignerTemplateQ.md)**  
You can create a question that uses choice lists from a template.
-   **[Survey questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_SurveyQuestion.md)**  
Survey questions appear on survey questionnaires for the associated survey definition.
-   **[Survey trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_TriggerConditions.md)**  
Trigger conditions specify when to send a particular survey and the persons to send it to.
-   **[Survey distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_SurveyDistribution.md)**  
There are several ways for survey administrators to distribute surveys to users.
-   **[Outlook Actionable Messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/outlook-actionable-messages.md)**  
Outlook actionable messages plugin enables users to respond to the survey from within the Microsoft Outlook application.
-   **[Sentiment analysis for surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/sentiment-analysis.md)**  
...
-   **[Surveys in Service Portal and the Now Mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_SurveyServicePortal.md)**  
...
-   **[Surveys in ITSM Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/survey-virtual-agent.md)**  
...
-   **[Legacy survey migration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/c_MigrateSurveys.md)**  
...
**Parent Topic:**[Using surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/using-surveys.md)
