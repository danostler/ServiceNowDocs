...
-   To view: Reporting role requirements might apply, see [Administering reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/reporting/c_AdminsteringReports.md) for Reporting role requirements.
...
CMDB Query Builder creates a report source which you can attach to a report and use with dashboards. For more details about report sources, see [Report sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/reporting/c_ReportSources.md).
