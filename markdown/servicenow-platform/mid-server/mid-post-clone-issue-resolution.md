...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/mid-server/mid-post-clone-issue-resolution.html
release: zurich
product: MID Server
...
**Note:** The [MID Server log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/mid-server/ecc-queue-mid-server.md) shows that the MID Server user associated with the target instance could not be authenticated or was missing the proper role.
