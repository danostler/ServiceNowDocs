...
The MID Servers that can use this IP address range.
    ...
    **Important:** IP ranges assigned manually prior to using auto-assignment in the [Discovery Quick Start](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/discovery/discovery-quick-start.md) are affected as follows:
