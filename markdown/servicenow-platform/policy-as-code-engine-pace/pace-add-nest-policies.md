...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/policy-as-code-engine-pace/pace-add-nest-policies.html
release: zurich
...
**Note:** You must create a policy before adding it to another policy. For more information, see [Create a PaCE policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/policy-as-code-engine-pace/pace-create-policy.md).
