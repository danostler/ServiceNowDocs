...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/password-reset/win-proxy-server-pac-file-password-reset.html
release: zurich
...
-   **[PAC file with registry setting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/win-pac-file-with-registry-setting.md)**  
