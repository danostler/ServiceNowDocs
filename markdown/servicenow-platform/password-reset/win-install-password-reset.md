...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/password-reset/win-install-password-reset.html
release: zurich
...
-   **[Use an EXE file from the command line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/win-install-pwr-exe.md)**  
As an alternative to command-line installation, you can use a wizard.
-   **[Use an MSI file from the command line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/win-install-pwr-msi.md)**  
...
-   **[Use a wizard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/win-install-pwr-wizard.md)**  
