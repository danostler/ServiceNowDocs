...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/password-reset/t\_CreateACredentialStoreType.html
release: zurich
...
5.  To use password reset subflows in Integration Hub, leave the **Use Flow** check box selected.
    ...
    **Note:** See [Customize password reset processes and integrate third-party credential services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/setup-pwd-reset-ihub.md) for information on creating provider-specific subflows.
