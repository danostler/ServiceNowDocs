...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/password-reset/win-pac-file-with-registry-setting.html
release: zurich
...
**Parent Topic:**[Configure a proxy server using PAC file \(automatic configuration script method\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/win-proxy-server-pac-file-password-reset.md)
