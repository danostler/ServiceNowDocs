...
-   **Homepages with a dashboard view**
    ...
    Password Reset has a new, modernized look and feel. For more information, see [Next Experience UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/next-experience-landing-page.md).
