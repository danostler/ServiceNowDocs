...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/upgrade-management/um-resolve-skipped-update.html
release: zurich
...
3.  In the Skipped Changes to Review related list, select the update record to resolve.
    ...
    See [Review skipped records using related lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/upgrade-management/um-access-rl.md).
