...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/install-now-actions.html
release: zurich
topic_type: task
...
To receive a ServiceNow notification in Microsoft Teams, create a message and a notification. See [Configure message content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configure-message-content.md) and [Create a messaging notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/create-messaging-notification.md).
