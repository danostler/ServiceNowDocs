...
To learn more about standard filtering options, see [Values for date/time fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/c_ValuesForDateTimeFields.md).
