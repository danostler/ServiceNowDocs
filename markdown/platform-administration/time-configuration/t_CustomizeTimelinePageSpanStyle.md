...
4.  Fill in the form and click **Submit**.
    ...
    |Field|Description|
    |-----|-----------|
    |Condition|[Condition Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/c_ConditionBuilder.md) that filters the results that appear in the timeline.|
