...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/cancel-clone-cac.html
release: zurich
topic_type: task
...
If you want to restart a canceled clone, you must create a [new clone request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_StartAClone.md).
