...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/exclude-a-table-from-cloning.html
release: zurich
topic_type: task
...
For information on excluding a table from cloning, see [General guidelines for excluding a table from cloning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/clone-exclusions-guidelines.md).
