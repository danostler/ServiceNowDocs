...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/noti-new-update-notification.html
release: zurich
topic_type: task
...
6.  Update the form using any of the available related lists.
    ...
    See [Create and add additional recipients](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/noti-add-additional-recipients.md) and [Create and add assignment groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/create-add-assignment-group.md) for more information.
...
-   **[Create and add additional recipients](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/noti-add-additional-recipients.md)**  
...
-   **[Create and add assignment groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/create-add-assignment-group.md)**  
