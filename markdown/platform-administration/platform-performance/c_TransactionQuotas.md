...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/platform-performance/c\_TransactionQuotas.html
release: zurich
...
5.  Sleeps until the next heartbeat, which is controlled by the **glide.quota.manager.heartbeat** [system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/platform-performance/r_ConfigureTransactionQuotaProps.md).
