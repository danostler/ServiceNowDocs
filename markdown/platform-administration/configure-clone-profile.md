...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/configure-clone-profile.html
release: zurich
topic_type: task
...
4.  Fill in the new clone profile form.
    ...
    For field information, see [Clone options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/clone-options.md).
