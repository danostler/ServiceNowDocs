...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/t\_CoalesceNormalValues.html
release: zurich
topic_type: task
...
6.  [Start](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_ApplyAliases.md) all the **Alias application** data jobs to replace the aliases with the normal value in existing records in the database.
