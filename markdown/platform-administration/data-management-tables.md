...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/data-management-tables.html
release: zurich
topic_type: concept
...
-   Access data usage and rule details by selecting a table in the list. See [Viewing data usage by table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/data-management-table-data.md).
