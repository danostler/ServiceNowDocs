...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/noti-provider-action-capabilities.html
release: zurich
topic_type: task
...
-   **[Create a scriptable notification action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/noti-scriptable-action.md)**  
Select **Scriptable Action** from the Notification Action wizard to create a scriptable notification action.
-   **[Create a flow notification action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/noti-flow-action.md)**  
