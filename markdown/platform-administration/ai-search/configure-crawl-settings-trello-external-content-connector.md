...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/configure-crawl-settings-trello-external-content-connector.html
release: zurich
product: AI Search
