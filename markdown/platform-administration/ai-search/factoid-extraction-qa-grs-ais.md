...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/factoid-extraction-qa-grs-ais.html
release: zurich
product: AI Search
...
For details on setting this system property, see the [Set the factoid extraction mode for Q&amp;A Genius Results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/set-factoid-extraction-mode-qna-gr.md) section. To learn about the effects of this system property's values, see the [System properties for factoid extraction in Q&amp;A Genius Results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/sys-props-factoid-extract-qna-gr.md) section.
