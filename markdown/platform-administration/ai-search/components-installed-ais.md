...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/components-installed-ais.html
release: zurich
product: AI Search
...
List of entries showing indexed record counts for indexed sources. For more information on these entries, see [Review record counts for indexed sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/record-counts-indexed-sources-ais.md).
