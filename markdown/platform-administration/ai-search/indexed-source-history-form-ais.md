...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/indexed-source-history-form-ais.html
release: zurich
product: AI Search
...
To learn how to review the ingestion history for an indexed source, see [Review ingestion history for an indexed source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/review-history-indexed-source-ais.md).
