...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/enable-ref-auto-domain-update-ais.html
release: zurich
product: AI Search
...
4.  On the Field Setting form, enter the following field values.
    ...
    For a description of the field values, see [Field Setting form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/field-setting-form-ais.md).
...
**Parent Topic:**[Domain separation and AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/ai-search-domain-separation.md)
