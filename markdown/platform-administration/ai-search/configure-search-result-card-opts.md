...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/configure-search-result-card-opts.html
release: zurich
product: AI Search
...
5.  In the Template field, edit the JSON for the Search Result card properties you want to customize.
    ...
    For details on available properties and their supported values, see [List of Search Result EVAM card properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/search-result-evam-card-opts.md).
...
-   **[List of Search Result EVAM card properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/search-result-evam-card-opts.md)**  
