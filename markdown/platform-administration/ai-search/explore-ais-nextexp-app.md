...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/explore-ais-nextexp-app.html
release: zurich
product: AI Search
...
**Note:** The AI Search for Next Experience application is automatically installed and enabled in new Zurich instances. If you upgrade to Zurich from a previous release, your administrators can manually install and enable the application.

For details on AI Search for Next Experience, including configuration steps and a usage guide, see [AI Search for Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/ais-next-experience-app.md).
