...
Enable your users to submit incidents and requests, manage tasks, and access company resources from anywhere using the [Now Mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/now-mobile-employee-experience/mobile-employee-experience.md) app.

For details on configuring and using AI Search as the Now Mobile search engine, see [AI Search in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/now-mobile-employee-experience/text-search-advanced-now.md).
...
For details on enabling and using AI Search as the Service Portal search engine, see [Enable and configure AI Search in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/service-portal/enable-ais-sp.md).
...
For information on how Virtual Agent uses AI Search, see [Improving the user experience with AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/virtual-agent/va-ai-search.md).
