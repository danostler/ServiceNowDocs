...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/dictionary-form-ais.html
release: zurich
product: AI Search
...
-   **fieldname**: Exclude terms found in the specified AI Search index field, such as **title** or **text**. For details on AI Search index fields, see [AI Search index fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/index-fields-list-ais.md).
