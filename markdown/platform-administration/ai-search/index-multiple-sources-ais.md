...
2.  Select the indexed sources with content that you want to make searchable.
    ...
    To select all indexed sources on the page, follow the instructions for your list version in [Perform actions on selected items in a list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/configure-use-list-functions.md).
