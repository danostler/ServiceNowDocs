...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/customize-fields-now-platform-landing.html
release: zurich
topic_type: concept
...
-   **[Add and customize a field in a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_CreatingNewFields.md)**  
Administrators can add new fields to a table to store and display data.
-   **[Make a field mandatory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_MakingAFieldMandatory.md)**  
...
-   **[Change the field label or hint](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_ChangeFieldLabelOrHint.md)**  
You can change a field's label or the text that appears as a hint when you point your mouse device to the field.
-   **[Delete a field from a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_DeleteFields.md)**  
...
-   **[Highlight list fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/highlight-list-fields-platform.md)**  
Color fields in lists to call an agent's attention to them.
-   **[Modify string field length](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_ModifyingStringFieldLength.md)**  
You can modify the maximum character limit for a string field.
-   **[Specify a default field value](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_SpecifyingADefaultValue.md)**  
...
-   **[Require unique values for a field](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_RequiringUniqueValuesForAField.md)**  
...
-   **[Define field styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_DefineFieldStyles.md)**  
Field styles enable you to declare individual CSS styles for a field in a list or form.
-   **[Record numbering](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/c_ManagingRecordNumbering.md)**  
