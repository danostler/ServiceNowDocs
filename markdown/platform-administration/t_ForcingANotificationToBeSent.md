...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/t\_ForcingANotificationToBeSent.html
release: zurich
topic_type: task
...
3.  Configure the form and add the **Force delivery** field.
    ...
    **Note:** This field does not appear by default.
    ...
    3.  Select **Save**.
        ...
        For more information about configuring the form, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configure-form-layout.md).
