...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/create-notification-filter-configuration.html
release: zurich
topic_type: task
...
6.  Select the User Criteria from the list of target records or create a new [user criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/user-criteria-form-notifications.md).
