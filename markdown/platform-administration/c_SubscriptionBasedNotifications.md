...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/c\_SubscriptionBasedNotifications.html
release: zurich
topic_type: concept
...
-   **[Create personal notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/create-personal-notifications.md)**  
...
-   **[Create a service provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_CreateAServiceProvider.md)**  
Administrators can configure service providers for devices that use SMS.
-   **[Make a notification mandatory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_MakingANotificationMandatory.md)**  
To prevent users from turning off or deleting a subscription to a notification, make the notification mandatory.
-   **[Force a notification to be sent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_ForcingANotificationToBeSent.md)**  
To force a notification to be sent to the specified users, enable forced delivery.
-   **[Create a notification filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_NotificationFilters.md)**  
