...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/upgrade-center/uc-monitor-module.html
release: zurich
...
**Note:** For detailed information about the upgrade process, see [Upgrade your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/release-notes/upgrades-overview.md).
...
3.  On the upgraded non-production instance, [process the skipped list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/upgrade-center/uc-process-skipped-records.md).
...
For details on reconciling conflicts, see [Process the skipped records list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/upgrade-center/uc-process-skipped-records.md).
