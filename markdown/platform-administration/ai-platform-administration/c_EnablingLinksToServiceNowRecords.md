...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/c\_EnablingLinksToServiceNowRecords.html
release: zurich
...
-   **[Enable links to records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/c_EnableLinksToServiceNowRecords.md)**  
Adding the special **$\{URI\}** parameter to an outbound email body or template creates a link to a specific record.
-   **[Change the link text](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/c_ChangeTheLinkText.md)**  
...
-   **[Link to related records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/c_LinkToRelatedRecords.md)**  
A notification can link to a related record by specifying a reference field in front of the**$\{URI\}** or **$\{URI\_REF\}** parameters.
-   **[Content page links in email notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/c_LinkingToContentPages.md)**  
