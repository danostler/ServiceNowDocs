...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/add-dynamic-attributes.html
release: zurich
...
-   Create a dynamic attribute store field. When you create a dynamic attribute store field, a dynamic namespace is automatically created and associated with the store field. See [Create a dynamic attribute store field](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/create-dynamic-attribute-store-field.md).
-   Create a dynamic namespace manually. See [Create a dynamic namespace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/create-dynamic-namespace.md).
