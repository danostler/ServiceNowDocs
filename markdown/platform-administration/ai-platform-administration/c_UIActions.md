...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/c\_UIActions.html
release: zurich
...
**Note:** To hide or restrict the **New** or **Edit** UI action on the related list, use [list control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/list-administration/t_ConfigureListControls.md).
...
-   **[Create a UI action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_EditingAUIAction.md)**  
You can create a new UI action or edit an existing one.
-   **[Override a UI action for an extended table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_OverrideOrRmvAUIActionForExtTbl.md)**  
