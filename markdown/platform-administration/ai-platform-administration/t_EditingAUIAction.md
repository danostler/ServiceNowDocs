...
To direct a user to a record, use this syntax, where **new\_record** is the variable name for the [GlideRecord](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/server-api-reference/c_GlideRecordScopedAPI.md):
