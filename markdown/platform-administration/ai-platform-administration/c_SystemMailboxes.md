...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-platform-administration/c\_SystemMailboxes.html
release: australia
...
For information about the fields that are shown in the System Mailbox, see [System email log and mailboxes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/r_EmailLogs.md). You can configure the layout of a system mailbox to show any of the email log fields, not only the ones that are shown by default.
