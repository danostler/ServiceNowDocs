...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/t\_EmbeddingImagesInHTMLFields.html
release: zurich
...
**Note:** Administrators and users with the image\_admin role manage the image library at **System UI** &gt; **Images**. See [Storing images in the database](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/c_StoringImagesInTheDatabase.md) .
