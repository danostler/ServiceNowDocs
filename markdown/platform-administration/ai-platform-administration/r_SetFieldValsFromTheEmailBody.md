...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/r\_SetFieldValsFromTheEmailBody.html
release: zurich
...
See [Redirecting Emails](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/r_RedirEmailDifferentAssignGrp.md) for an example of using **setDisplayValue\(\)** in an inbound email action.
