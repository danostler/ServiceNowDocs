...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-platform-administration/t\_ConfigureAnEmailAccount.html
release: australia
 ...
 **Note:** Account type is specific to personal corporate mailbox. For more information,see [Personal corporate mailbox](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/personal-corporate-mailbox.md).
...
System address filter to apply to the email account. If left blank, the system uses the default system address filter for inbound or outbound email.
 ...
 For more information, see [System address filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/system-address-filters.md).
...
**Parent Topic:**[Email accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/c_EmailAccounts.md)
