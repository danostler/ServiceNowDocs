...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-platform-administration/noti-provider-action-capabilities.html
release: australia
...
-   **[Create a scriptable notification action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/noti-scriptable-action.md)**  
Select **Scriptable Action** from the Notification Action wizard to create a scriptable notification action.
-   **[Create a flow notification action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/noti-flow-action.md)**  
