...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/t\_CreateAPushMessage.html
release: zurich
...
The [Push notification plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_ActivatePushNotifications.md) must be active. The plugin is active by default.
...
Optional. Select the attributes that apply to this notification. For details, see [Create an attribute value or action for a push message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreateAPushMessageAttributeValue.md).

</td></tr></tbody>
</table>
## What to do next

[Set up the push notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreatePushNotification.md) that contains the message created or update an existing push notification to use the push message.
