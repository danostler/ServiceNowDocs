...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-platform-administration/t\_ForcingANotificationToBeSent.html
release: australia
...
3.  Configure the form and add the **Force delivery** field.
    ...
    **Note:** This field does not appear by default.
    ...
    3.  Select **Save**.
        ...
        For more information about configuring the form, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/configure-form-layout.md).
