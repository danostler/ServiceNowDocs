...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/sensitive-data-redaction.html
release: zurich
...
-   [Sensitive Data Redaction for Inbound Emails plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/activate-data-redaction-emails-plugin.md)
-   [Data Discovery application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/data-discovery/activate-data-discovery.md)
...
To create inbound email actions, see [Create an inbound email action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreatingAnInboundEmailAction.md).

Redaction time for the record can be viewed by checking the **Email Log**. For more information, see [System email log and mailboxes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/servicenow-ai-platform-security/r_EmailLogs.md).

-   **[Activate sensitive data redaction for inbound emails plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/activate-data-redaction-emails-plugin.md)**  
...
-   **[Customize behavior for sensitive data redaction](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/customize-data-redaction.md)**  
