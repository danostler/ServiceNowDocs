...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-platform-administration/t\_JDBCProbe.html
release: australia
...
-   **[Direct JDBC Probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/c_DirectJDBCProbe.md)**  
A direct JDBC probe specifies all the parameters necessary in the outbound ECC Queue XML payload.
-   **[JDBC Probes via Data Source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/c_JDBCProbesViaDataSource.md)**  
JDBC probes are executed via a JDBC data source when an import is running against the data source.
-   **[Select \* JDBC Probe short cut](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/c_SelectJDBCProbeShortCut.md)**  
...
-   **[Parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/r_DirectJDBCProbeParameters.md)**  
The following parameters are available in a direct JDBC probe.
-   **[Using the Work Element](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/c_UsingTheWorkElement.md)**  
The work element encodes SQL statements to be executed by the probe.

**Parent Topic:**[Supported integration interfaces](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/r_SupportedIntegrationInterfaces.md)
