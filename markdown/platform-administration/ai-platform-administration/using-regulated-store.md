...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-platform-administration/using-regulated-store.html
release: australia
...
2.  Procure an application from an isolated federal or regional instance of the ServiceNow Store.
    ...
    -   To get an application that's available at no additional cost, log in to your federal or regional instance of the ServiceNow Store and use the same process that users of the commercial ServiceNow Store do. For more information, see [Get a free application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/store-get-free-app.md).
    -   To request a paid application, see [Request a paid app for a regulated environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/request-paid-app-regulated.md).
    -   To complete procurement of an application for an on-premise instance, see [Get an app or product as an on-premise customer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/get-app-on-prem.md).
3.  Install an application in a regulated environment.
    ...
    -   If you self-host your instance, see [Upload an app to an on-premise instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/upload-app-on-prem-instance.md).

## Additional info

-   [Environments with federal or regional ServiceNow Store instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/isolated-store-instances.md)
...
-   [Listing types not available in regulated environments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/unavailable-listing-reg-store.md)
...
-   [Terms and conditions in the ServiceNow Store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/sn-store-tncs.md)
