...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/t\_CreateAPushMessageAttributeValue.html
release: zurich
...
5.  [Create a push message attribute definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreateAPushMessageAttribute.md)
...
These push message attribute values override values that you set in an [attribute definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreateAPushMessageAttribute.md) on the Push Content form.
...
5.  Click **Submit**.
    ...
    |Field|Description|
    |-----|-----------|
    |Attribute|Select a [push message attribute definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreateAPushMessageAttribute.md).|
...
\(Optional\) [Create a push action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreateAMobileActionScript.md) to perform an action on the instance.
