...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/request-paid-app-regulated.html
release: zurich
...
1.  Access the federal or regional ServiceNow Store instance that corresponds to your regulated environment.
    ...
    For more information, see [Access the ServiceNow Store for a regulated environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/access-regulated-store.md).
