...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/t\_CreateAnEmailClientTemplate.html
release: zurich
...
The email client uses its own [email templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/c_EmailTemplates.md) to define default values for fields. Use the following sections in the Email Client Template form to build a client template:
...
<table id="choicetable_f3x_twt_pfc"><thead><tr><th align="left" id="d39035e499">

Type

</th><th align="left" id="d39035e502">

Description

</th></tr></thead><tbody><tr><td id="d39035e508">
...
**Parent Topic:**[Configure email client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/configuring-email-client.md)
...
3.  Fill in the fields to compose an email.
    ...
    See [Create an email client template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreateAnEmailClientTemplate.md) for field details.
