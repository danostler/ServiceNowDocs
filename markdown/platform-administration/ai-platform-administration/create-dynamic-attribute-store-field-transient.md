...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-platform-administration/create-dynamic-attribute-store-field-transient.html
release: australia
...
Populate the dynamic attribute store field with one or more attributes. See [Add transient attributes to a record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/add-transient-attributes.md).
