...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/configure-notif-custom-Slack-app.html
release: zurich
...
-   [Request Messaging Notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/request-messaging-notification.md)
...
4.  On the JSON Configuration window, paste the JSON that you created in Step [1](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/configure-notif-custom-Slack-app.md).
...
-   Create notifications for your custom Slack app by following the steps in [Create a messaging notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/create-messaging-notification.md) and [Configure message content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/configure-message-content.md).
