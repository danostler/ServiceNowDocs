...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-platform-administration/update-dynamic-namespace-dynamic-attribute-store.html
release: australia
