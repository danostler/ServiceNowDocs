...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/email-service.html
release: zurich
...
By default, Email Service only allows admin users to access the [Email API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/rest-apis/email-api.md). Administrators can [grant access to the Email API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/grant-access-to-email-api.md) by:
...
Non-admin users with the email\_api\_send role can access the Email API from the [REST API Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/rest-api-explorer/use-REST-API-Explorer.md).

-   **[Create a system address filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/create-system-address-filter.md)**  
