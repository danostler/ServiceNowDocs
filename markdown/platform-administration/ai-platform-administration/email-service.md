...
By default, Email Service only allows admin users to access the Email API. Administrators can [grant access to the Email API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/grant-access-to-email-api.md) by:
