...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/r\_ConfigureE.164PhoneNumberFields.html
release: zurich
...
Change the E.164 phone number to use the local format in certain circumstances by [adding the following system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md):
...
[Add the following system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md) to display the territory label next to the number in an E.164 phone number.
...
[Add the following system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md) to display the international direct dialing prefix.
...
[Add the following system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md) to show or hide the territory selector choice list.
...
Determines whether all phone number fields must match the display format for the selected territory. When the value is **true**, the phone number input field displays a red line underneath the phone numbers that do not match the format for the selected territory. Users cannot save the phone number.
 ...
 -   Type: true \| false
-   Default value: true
-   Location: [Add](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md) to the System Properties \[sys\_properties\] table.
