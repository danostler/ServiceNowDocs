...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-platform-administration/t\_ConvertADataPolicyToAUIPolicy.html
release: zurich
...
3.  Edit the fields on the UI policy record as necessary.
    ...
    For details about the fields, see [Create a UI Policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-platform-administration/t_CreateAUIPolicy.md).
