...
Create a JWT signing key to assign to your JKS certificate. For more information, see [Configure a JWT signing key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/authentication/JWT-Bearer-token-support.md).
