...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/create-system-address-filter.html
release: zurich
topic_type: task
...
Complete the steps in [Set email address filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/set-email-address-filters.md).
...
For a non-default filter, the next step is to apply the filter to an email account manually. For more information on applying a filter to an email account, see [Create an email account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_ConfigureAnEmailAccount.md).

**Parent Topic:**[Email service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/email-service.md)
