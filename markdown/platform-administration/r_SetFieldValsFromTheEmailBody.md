...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/r\_SetFieldValsFromTheEmailBody.html
release: zurich
...
See [Redirecting Emails](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/r_RedirEmailDifferentAssignGrp.md) for an example of using **setDisplayValue\(\)** in an inbound email action.
...
**Parent Topic:**[Configure inbound email actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configure-inbound-email.md)
