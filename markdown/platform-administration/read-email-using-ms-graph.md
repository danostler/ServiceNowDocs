...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/read-email-using-ms-graph.html
release: zurich
topic_type: concept
...
-   **[Activate Email - Support for Email Processing by Microsoft Graph API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ms-graph-plugin.md)**  
...
-   **[Configure an OAuth profile to use a client ID and secret for token generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/microsoft-graph.md)**  
...
-   **[Configure an OAuth profile to use certificates for authentication with Microsoft Azure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configure-oauth-profile-using-certificates.md)**  
Configure an OAuth application profile to authenticate using certificates.
-   **[Create an email account for Microsoft Graph \(receive\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/create-email-account-ms-graph.md)**  
