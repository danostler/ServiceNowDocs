...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/c\_SystemMailboxes.html
release: zurich
topic_type: concept
...
For information about the fields that are shown in the System Mailbox, see [System email log and mailboxes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/r_EmailLogs.md). You can configure the layout of a system mailbox to show any of the email log fields, not only the ones that are shown by default.
