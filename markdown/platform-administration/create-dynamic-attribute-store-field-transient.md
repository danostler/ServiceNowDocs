...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/create-dynamic-attribute-store-field-transient.html
release: zurich
topic_type: task
...
Populate the dynamic attribute store field with one or more attributes. See [Add transient attributes to a record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/add-transient-attributes.md).
