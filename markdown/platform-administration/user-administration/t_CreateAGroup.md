...
3.  On the form, fill in the fields.
    ...
    Some fields appear after personalizing the form. [Personalize a form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/t_PersonalizeAForm.md).
...
Helpful information about the group.
    ...
    2.  Create a new before query business rule on the \[sys\_user\_group\] \(Group\) table with the following script:
        ...
        **Note:** For more information, see [Before Query business rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/servicenow-ai-platform-security/bp-before-query-business-rules.md).
