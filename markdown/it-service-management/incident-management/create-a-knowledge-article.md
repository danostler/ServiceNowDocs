...
3.  Access the Incident-KCS article - HTML form using one of the following methods:
    ...
    The base system **Incident-KCS article - HTML** template appears by default. To use a custom template instead, refer to [Create an article template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/create-a-new-article-templates.md).
