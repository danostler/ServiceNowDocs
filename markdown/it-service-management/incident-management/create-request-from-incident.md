...
5.  Check out the required catalog item, order guide, or record producer.
    ...
    For information on checkout models, see [Service Catalog checkout models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/service-catalog/c_EnableATwoStepCheckout.md).
