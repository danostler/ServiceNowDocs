...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/itsm-success-dashboard-indicators/configure-va.html
release: zurich
...
-   **[Configure Virtual Agent topics for ITSM Success Dashboard indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/itsm-success-dashboard-indicators/instrument-virtual-agent-sdb.md)**  
Configure the Virtual Agent \(VA\) topics for ITSM Success Dashboard indicators so that data is displayed correctly if you have topics other than the base system topics.
-   **[Configure Virtual Agent topics for ITSM Success Dashboard using self-service analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/itsm-success-dashboard-indicators/instrument-va-sdb2.md)**  
