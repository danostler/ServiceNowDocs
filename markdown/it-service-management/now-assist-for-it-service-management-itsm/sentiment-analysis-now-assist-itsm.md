...
<table id="choicetable_svt_mlg_w2c"><thead><tr><th align="left" id="d361862e88">

To

</th><th align="left" id="d361862e91">

Do this

</th></tr></thead><tbody><tr><td id="d361862e97">
...
**Note:** If the **Sentiment** field does not appear, you must configure the form layout. For more information, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/configure-form-layout.md) and add the **Sentiment** field.

</td></tr><tr><td id="d361862e170">
