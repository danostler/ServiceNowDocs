...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/task-intelligence-for-itsm/create-incident-prediction-model.html
release: zurich
...
To set up a new model using a template, see [Set up your incident prediction model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/task-intelligence-for-itsm/set-up-model.md).

-   **[Set up your incident prediction model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/task-intelligence-for-itsm/set-up-model.md)**  
