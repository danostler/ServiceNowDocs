...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/digital-end-user-experience-dex/view-da-usage-metrics.html
release: zurich
...
3.  Under Desktop Assistant, select **Usage metrics**.
    ...
    For more details on the usage metrics, see [Desktop Assistant usage metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-end-user-experience-dex/dex-desktop-exp-dashboard.md).
