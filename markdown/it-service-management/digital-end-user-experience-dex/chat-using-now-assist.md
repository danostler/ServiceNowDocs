...
3.  Use the prompts from Now Assist to create a ticket, check the status of an existing ticket, or resolve other issues you might have.
    ...
    **Note:**
    ...
    -   To customize the topics that must be displayed and available on the **Show me everything** window, see [Getting started with Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/virtual-agent/conversation-designer-virtual-agent.md)
