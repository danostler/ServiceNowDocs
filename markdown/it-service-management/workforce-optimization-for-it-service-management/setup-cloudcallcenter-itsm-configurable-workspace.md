...
1.  Create placeholder queues for an Amazon Connect \(phone\) service channel if you need additional queues.
    ...
    For more information on creating a queue, see [Create a work item queue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/advanced-work-assignment/awa-create-queue.md).
