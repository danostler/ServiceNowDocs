...
7.  To create a KPI report that explicitly apply to your teams, do the following:
    ...
    2.  Fill in the details on the form. For more information, see [Single score report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/reporting/c_SingleScoreCharts.md).
    3.  Select **Save**.
    ...
    7.  Select the KPI report's table name and field name. For more information, see [Create a reference field interactive filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/interactive-filters/t_CreateAReferenceFieldPublisher.md).
    8.  Select **Submit**.
