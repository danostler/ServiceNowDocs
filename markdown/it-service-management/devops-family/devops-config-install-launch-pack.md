...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-family/devops-config-install-launch-pack.html
release: zurich
...
The DevOps Config Exporter content pack contains a set of [Default DevOps Config exporters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/devops-config-default-exporters.md) to export your configuration data.
...
**Parent Topic:**[Install DevOps Config](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/install-devops-config.md)
