...
For more information, see [Approval with e-signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/approvals/approval-with-e-signature.md).

## Requirements

Before you can use e-signatures with change approvals, verify the following requirements:

-   The e-signature platform plugin is activated on your instance. For activation instructions, see [Activate Approval with e-Signature plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/approvals/activate-approval-esignature.md).
