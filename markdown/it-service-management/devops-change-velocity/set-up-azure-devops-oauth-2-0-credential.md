...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-change-velocity/set-up-azure-devops-oauth-2-0-credential.html
release: zurich
...
4.  Enter the name of your ADO organization and location, and then select **Continue**. \[Omitted image "create-ado-org.png"\] Alt text: Create ADO org page
    ...
    This newly created org will be connected with the tenant created in the [Create a tenant in Microsoft Entra](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-change-velocity/set-up-azure-devops-oauth-2-0-credential.md) topic.
