...
<table id="choicetable_g4v_f5r_gwb"><thead><tr><th align="left" id="d42121e88">

Option

</th><th align="left" id="d42121e91">

Steps

</th></tr></thead><tbody><tr><td id="d42121e97">
...
</td></tr><tr><td id="d42121e177">

**Using Classic UI**

</td><td>

Set a password for the DevOps integration user by navigating to **All** &gt; **User Administration** &gt; **Users**. For more information, see [Set password for a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/authentication/reset-your-password.md).
