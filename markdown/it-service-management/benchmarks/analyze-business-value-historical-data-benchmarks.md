...
1.  Set up Benchmarks historical data collection.
    ...
    5.  Select **Execute**.
        ...
        For detailed information on scheduling a data collection job, refer to [Create or schedule a data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/performance-analytics/t_CreatASchedDataCollJob.md).
