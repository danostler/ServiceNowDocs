...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/benchmarks/t\_NewViewBenchKPIData.html
release: zurich
product: Benchmarks
...
2.  Select one of the **KPI categories** from the [KPI list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/benchmarks/c_BenchKPIConfig.md).
...
Click a KPI to view [Benchmarks KPI performance trend](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/benchmarks/c_NewbenchKPItrendrecommend.md).
