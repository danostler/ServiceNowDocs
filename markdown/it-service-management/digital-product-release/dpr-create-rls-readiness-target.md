...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/digital-product-release/dpr-create-rls-readiness-target.html
release: zurich
...
5.  In the dialog box, fill in the fields.
    ...
    For more information on release readiness target field descriptions, see [Release readiness target form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-product-release/create-release-readiness-target-form.md).
