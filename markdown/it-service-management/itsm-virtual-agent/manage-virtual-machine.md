...
-   **Topics that use the [Cloud Provisioning and Governance plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/cloud-configuration-governance/request-plugin-cloud-mgt.md) \(com.snc.cloud.mgmt\)**
...
Requirement: [Cloud Provisioning and Governance plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/cloud-configuration-governance/request-plugin-cloud-mgt.md) \(com.snc.cloud.mgmt\)
...
2.  Virtual Agent does one of the following:
    -   Provides a link to the [Cloud User Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/cloud-configuration-governance/cloudmgt-cloud-user-portal.md), along with instructions for requesting a VM from the catalog.
