...
-   [Activate Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/virtual-agent/activate-virtual-agent.md) to use Virtual Agent as a response channel.
