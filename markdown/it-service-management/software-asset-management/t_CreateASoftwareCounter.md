...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/software-asset-management/t\_CreateASoftwareCounter.html
release: zurich
...
Depending on the [license type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/software-asset-management/r_LicenseCalculationTypes.md) you select for a counter, multiple installations can count as a single license, such as when using the per user license type. This licensing concept is used on occasion by companies like Microsoft and Adobe. It grants users the right to install software on multiple machines if those users already have rights to install the software.

**Note:** You can [create new counters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/software-asset-management/t_CreatingNewModels.md) from Discovery model records or from the list view.
...
6.  Reload the form to view the [counter results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/software-asset-management/t_ViewASoftwareCounterResult.md).
...
Select the check box to generate the details of the entitlement records. For more information, see [Setting Up Quick Counters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/software-asset-management/c_SetUpQuickCounters.md).
...
\[Required\] Select the method for counting licenses. For example, Per named user or Per workstation.
 ...
 For more information, see [License Calculation Types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/software-asset-management/r_LicenseCalculationTypes.md).
...
Displays all [results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/software-asset-management/t_ViewASoftwareCounterResult.md) for this software counter.
