...
-   Attach documents such as release and deployment plans, installation manuals, and training documentation to a release.
    ...
    For more information, see [Add and manage attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/t_AddingAnAttachment.md).
