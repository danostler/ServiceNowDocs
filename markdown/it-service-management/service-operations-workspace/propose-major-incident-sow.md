...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/service-operations-workspace/propose-major-incident-sow.html
release: zurich
...
2.  On the incident record, use the following information to decide if you want to propose this incident:
    ...
    For more information on the tabs, see [Managing a major incident record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/managing-major-incident-sow.md).
