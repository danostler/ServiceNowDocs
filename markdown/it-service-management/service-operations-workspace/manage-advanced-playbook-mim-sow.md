...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/service-operations-workspace/manage-advanced-playbook-mim-sow.html
release: zurich
...
5.  Perform unplanned communication and collaboration.
    ...
    2.  Select the one of the following options for unplanned communications and collaboration.
        ...
        -   For adhoc collaboration, you can do the following actions:
            ...
            -   Start a chat – Select **Open discussion** to start a chat. For more information, see [Collaborate with stakeholders during a major incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/collaborate-stakeholders-mim-sow.md).
6.  Select **Resolve**.
