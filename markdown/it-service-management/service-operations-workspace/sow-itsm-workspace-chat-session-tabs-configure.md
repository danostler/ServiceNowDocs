...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/service-operations-workspace/sow-itsm-workspace-chat-session-tabs-configure.html
release: zurich
...
Enable the [ITSM Configurable Workspace chat session tabs in SOW](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/sow-itsm-workspace-chat-session-tabs.md) feature and select the workspace that the feature applies to. You can also select values for two different chat SLA threshold timers that alert agents about unread messages in inactive chats. These timers alert agents by changing the tab colors of the inactive chats. For more information to change the tab colors, see [tab colors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/sow-itsm-workspace-chat-session-tabs.md).
...
**Parent Topic:**[ITSM Configurable Workspace chat session tabs in SOW](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/sow-itsm-workspace-chat-session-tabs.md)
