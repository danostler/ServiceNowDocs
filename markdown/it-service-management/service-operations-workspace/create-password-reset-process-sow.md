...
14. Right-click on the form header, and select **Save**.
    ...
    For more information on password reset process, see [Configure your Password Reset process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/password-reset/t_CreateAPasswordResetProcess.md).
