...
3.  Click the Additional actions icon and select **Configure** &gt; **Form Layout**.
    ...
    For more information, refer [Configuring form layouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ai-platform-administration/configure-form-layout.md).
