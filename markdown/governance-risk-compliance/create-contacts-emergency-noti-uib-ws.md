...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/create-contacts-emergency-noti-uib-ws.html
release: zurich
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For more information on the fields, see [Contact form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/contact-form.md).

4.  Select **Submit**.

5.  To import contacts based on contact sync rules, select the **Import users** button.

    To import the contacts using a sync rule, you must first [Create the contact import rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/create-contact-import-rules.md). Refresh the form page to get the imported list of users.
...
-   **[Contact form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/contact-form.md)**  
Use the Contact form to create the contacts manually and then synchronize the contacts with Everbridge.
-   **[Create the contact import rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/create-contact-import-rules.md)**  
...
**Parent Topic:**[Setup for Everbridge notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/setup-steps-for-emergency-notification-uib-ws.md)
