...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/create-contact-rules-emergency-notifications.html
release: zurich
topic_type: task
...
6.  To import contacts using a sync rule, you must first [create a contact import rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/contact-import-sync-rule.md).
