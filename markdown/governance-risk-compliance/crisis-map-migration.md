...
For information on the form headers, see [Configure a form header for a workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/config-ws-form-header.md).
