...
<table id="choicetable_ib1_wzc_tcc"><tbody><tr><td id="d156448e247">
...
Select **Create New Block**.
    ...
    For more information on Document Templates, see [Configure a PDF document template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/hr-service-delivery/configure-editable-pdf.md).
