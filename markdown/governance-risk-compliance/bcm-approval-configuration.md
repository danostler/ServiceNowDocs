...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/bcm-approval-configuration.html
release: zurich
topic_type: concept
...
For more information on the roles in the Business Continuity Management application, see [Components installed with Business Continuity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/installed-with-bcm.md).
...
-   **[Set up approval configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/setup-bcm-approval-configurator.md)**  
...
-   **[Set up approval levels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/setup-bcm-approval-levels.md)**  
Assign multiple levels of approvals to users or groups to support each step of your BIA, BCP, or events workflow processes.
-   **[Set up approval rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/setup-bcm-approval-rules.md)**  
