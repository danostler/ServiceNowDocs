...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/generate-pdf-for-bcp.html
release: zurich
topic_type: task
...
4.  To format the BCP PDF template, follow the instructions in [Format PDF templates for BIAs, BCPs, and Events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/update-pdf-format-for-bia-bcp-event.md).
