...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/crisis-map-admin-tasks.html
release: zurich
topic_type: concept
...
-   **Alert Rules**: Configure an alert rule in Crisis map so that you can specify the conditions under which a feed can be displayed in the dashboard as an alert. For more information, see [Configure alert rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/conf-alert-rule-uib-ws.md).
-   **Alert Actions**: Configure an alert action in UIB Workspace for the Crisis map application. For more information, see [Configure alert actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/configure-alert-action-uib-ws.md).

-   **[Customization properties for Google Maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/crisis-map-customization-properties-for-g-maps.md)**  
...
-   **[Google Maps APIs used in Fam-map component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/g-maps-api-in-fam-map-component.md)**  
...
-   **[Configure Scheduled Data Imports records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/sched-data-imports-crisis-map-uib-ws.md)**  
...
-   **[Configure Resource Configuration records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/conf-resource-for-crisis-map-uib-ws.md)**  
...
-   **[Configure alert rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/conf-alert-rule-uib-ws.md)**  
...
-   **[Configure alert actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/configure-alert-action-uib-ws.md)**  
