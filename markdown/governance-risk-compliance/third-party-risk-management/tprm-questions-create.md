...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/third-party-risk-management/tprm-questions-create.html
release: zurich
...
1.  Define or select the assessment category that is appropriate for the question that you plan to add.
    ...
    -   For instructions on defining an assessment category, see [Set up and maintain a question bank](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/third-party-risk-management/tprm-question-bank-create.md).
