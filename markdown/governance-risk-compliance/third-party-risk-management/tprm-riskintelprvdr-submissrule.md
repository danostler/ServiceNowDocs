...
-   If Change type = Normalized rating, enter a risk rating threshold that will trigger the rule in the **Normalized risk rating** field.
    ...
    1.  Use the [condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/c_ConditionBuilder.md) to define conditions for identifying the third parties to be affected by the rule.
