...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/start-exercise-event-in-uib-ws.html
release: zurich
topic_type: task
...
2.  Fill in the required fields in the **Details** tab.
    ...
    For more information on the fields, see [Create Exercise Event form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/create-exercise-event-ref-form.md).
...
-   **[Create Exercise Event form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/create-exercise-event-ref-form.md)**  
