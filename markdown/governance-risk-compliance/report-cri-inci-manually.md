...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/report-cri-inci-manually.html
release: zurich
topic_type: task
...
4.  On the New record form, fill in the fields.
    ...
    To view more information on the fields, see the [Create New Digital Resilience Incident form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/create-new-dig-res-inci.md).
