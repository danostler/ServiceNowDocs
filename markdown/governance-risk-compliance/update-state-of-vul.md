...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/update-state-of-vul.html
release: zurich
topic_type: task
...
3.  Select **Update state** UI action.
    ...
    For more information on the state transition model, see [Set up the State model and Action task model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/establish-state-model-record.md).
