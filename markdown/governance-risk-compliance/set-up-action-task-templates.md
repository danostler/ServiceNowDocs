...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/set-up-action-task-templates.html
release: zurich
topic_type: task
