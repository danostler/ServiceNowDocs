...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/create-scenario-analysis-in-ws.html
release: zurich
topic_type: task
...
6.  In the **Analysis approver** field, select the owner, plan approver, and analysis approver for the analysis.
    ...
    For the descriptions of the field values on the User New record form, see [Create New Scenario analysis form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/scenario-analyses-reference-in-ws.md).
