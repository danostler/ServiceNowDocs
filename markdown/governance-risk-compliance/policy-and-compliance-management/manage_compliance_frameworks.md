...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/policy-and-compliance-management/manage\_compliance\_frameworks.html
release: zurich
...
-   **[Activate Compliance UCF](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/policy-and-compliance-management/activate-grc-comp-ucf.md)**  
The GRC: Compliance UCF \(com.sn\_comp\_ucf\) plugin is available as a separate subscription.
-   **[Configure the UCF integration using a UCF-supplied API key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/policy-and-compliance-management/config_using_ucf_api_key.md)**  
UCF integrates with your ServiceNow instance through an authentication process which validates your subscription.
-   **[Configure the UCF integration using the UCF Common Controls Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/policy-and-compliance-management/configure-UCF-integration.md)**  
