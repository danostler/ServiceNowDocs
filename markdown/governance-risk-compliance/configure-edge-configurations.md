...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/configure-edge-configurations.html
release: zurich
topic_type: task
...
3.  In the Edge configurations related list, select **New**.
    ...
    For more information on the fields, see [Edge configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/edge-configuration-form.md).
