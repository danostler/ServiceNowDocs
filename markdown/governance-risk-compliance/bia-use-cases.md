...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/bia-use-cases.html
release: zurich
topic_type: concept
...
For more information on the recovery time objective, recovery point objective, and recovery tiers, see [RTO, RPO, and recovery tiers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/rto-rpo-recovery-tiers.md).
