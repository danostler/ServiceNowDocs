...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/imp-analysis-dep-update-config.html
release: zurich
topic_type: task
...
**Parent Topic:**[Scheduling an auto-update of dependencies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/update-impactanalysis-dep-based-on-cmdb-changes.md)
