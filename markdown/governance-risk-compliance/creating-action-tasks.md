...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/creating-action-tasks.html
release: zurich
topic_type: concept
...
-   [Manage an assessment-type action task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/create-action-task-op-vul.md)
-   [Manage an investigation-type action task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/update-state-of-action-task.md)
