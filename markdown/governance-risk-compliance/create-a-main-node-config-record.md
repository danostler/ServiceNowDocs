...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/create-a-main-node-config-record.html
release: zurich
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For information on the fields in the form, see [Main node configuration new record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/main-node-configuration-form.md).
...
-   **[Main node configuration new record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/main-node-configuration-form.md)**  
