...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/configure-impact-category-uib-ws.html
release: zurich
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For more information on the fields in the form, see [Impact Category record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/impact-category-new-record-form.md).

4.  Select **Submit**.


-   **[Impact Category record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/impact-category-new-record-form.md)**  
