...
2.  Install the BCM mobile application on the ServiceNow AI Platform instance that you want to view on your mobile device.
    ...
    **Note:** The BCM mobile app and the ServiceNow AI Platform instance should be from the same family release.
    ...
    For more information about getting entitlement, downloading, and installing the BCM mobile app, see [GRC and the ServiceNow Store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/governance-risk-compliance/governance-risk-and-compliance/grc-and-store.md).
