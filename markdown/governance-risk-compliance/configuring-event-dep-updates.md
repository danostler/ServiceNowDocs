...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/configuring-event-dep-updates.html
release: zurich
topic_type: concept
...
For more information on configuring the Event dependency source configuration record, see [Configure Event dependency source configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/conf-event-dep-source-confi-module.md).

-   **[Configure Event dependency source configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/conf-event-dep-source-confi-module.md)**  
