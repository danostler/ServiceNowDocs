...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/generate-pdf-for-bia.html
release: zurich
topic_type: task
...
6.  To format the BIA PDF template, follow the instructions in [Format PDF templates for BIAs, BCPs, and Events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/update-pdf-format-for-bia-bcp-event.md).
