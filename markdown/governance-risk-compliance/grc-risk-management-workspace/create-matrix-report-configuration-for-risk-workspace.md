...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-risk-management-workspace/create-matrix-report-configuration-for-risk-workspace.html
release: zurich
...
3.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Matrix report configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-risk-management-workspace/matrix-report-configuration-form-risk-workspace.md).

4.  Select **Submit**.


-   **[Matrix report configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-risk-management-workspace/matrix-report-configuration-form-risk-workspace.md)**  
