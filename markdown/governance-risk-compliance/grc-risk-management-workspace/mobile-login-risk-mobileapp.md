...
-   Scan a QR code.
 For more information about the mobile app, see [Log in to an instance with a mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/login-end-user.md)
