...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-risk-management-workspace/configure-feedback-integration.html
release: zurich
...
3.  On the form, fill in the fields.
    ...
    For a description of the field values on the Feedback Integration Configuration form, see [Feedback integration configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-risk-management-workspace/feedback-integration-configuration-form.md).

4.  Select **Submit**.


-   **[Feedback integration configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-risk-management-workspace/feedback-integration-configuration-form.md)**  
