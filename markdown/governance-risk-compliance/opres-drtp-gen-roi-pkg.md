...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/opres-drtp-gen-roi-pkg.html
release: zurich
topic_type: task
...
4.  Select **Export info register** to initiate the download process.
    ...
    For more information on validation, see [Validate the Register of Information packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/opres-drtp-validate-roi.md).
