...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-common-functions/configure-confidentilaity-on-grc-tables.html
release: zurich
...
2.  In the new confidential configuration form, fill in the fields that are required for enabling confidentiality for the GRC tables.
    ...
    For more information about the fields, see [Confidentiality configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-common-functions/confidentiality-configuration-form.md).
...
-   **[Confidentiality configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-common-functions/confidentiality-configuration-form.md)**  
