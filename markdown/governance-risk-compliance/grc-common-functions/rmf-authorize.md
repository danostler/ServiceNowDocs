...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-common-functions/rmf-authorize.html
release: zurich
...
-   **[Authorize targets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-common-functions/rmf-authorize-targets.md)**  
Authorize a target record based on the overall security posture determined by the security officer.
-   **[Monitor the NIST RMF Authorize dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-common-functions/monitor-rmf-authorize-dashboard.md)**  
