...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/financial-services-operations/financial-services/configure-fso-integration-socure.html
release: zurich
...
6.  Configure the KYC service definitions, Socure - CDD - Customer and Socure - CDD - Contact.
    ...
    For information on configuring flows and service definitions, see [Configure flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/financial-services-operations/financial-services/configure-flow-designer-flows-fso-apps.md) and [Configure service definitions for Financial Services Operations applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/financial-services-operations/financial-services/configure-service-definitions.md).
