...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/financial-services-operations/configure-fso-integration-socure.html
release: zurich
topic_type: task
...
6.  Configure the KYC service definitions, Socure - CDD - Customer and Socure - CDD - Contact.
    ...
    For information on configuring flows and service definitions, see [Configure flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/financial-services-operations/configure-flow-designer-flows-fso-apps.md) and [Configure service definitions for Financial Services Operations applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/financial-services-operations/configure-service-definitions.md).
