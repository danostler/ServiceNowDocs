...
4.  In Catalog Builder, configure a record producer using the **ShoppingHub: Additional information on supplier products or product models or product categories** template.
    ...
    **Note:** For information on how to create a record producer, see [Create a catalog item using a template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/service-catalog/create-item-cat-builder.md).
