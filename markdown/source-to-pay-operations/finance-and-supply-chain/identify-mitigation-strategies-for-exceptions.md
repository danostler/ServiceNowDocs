...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/finance-and-supply-chain/identify-mitigation-strategies-for-exceptions.html
release: zurich
...
3.  Use any of the following steps:
    ...
    -   [View a purchase order exception](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/finance-and-supply-chain/view-purch-order-exception.md). Select the **Now Assist** button on the exception record.
