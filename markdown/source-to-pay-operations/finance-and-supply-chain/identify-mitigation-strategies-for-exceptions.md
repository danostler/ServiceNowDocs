...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/source-to-pay-operations/finance-and-supply-chain/identify-mitigation-strategies-for-exceptions.html
release: australia
...
3.  Use any of the following steps:
    ...
    -   [View a purchase order exception](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/source-to-pay-operations/finance-and-supply-chain/view-purch-order-exception.md). Select the **Now Assist** button on the exception record.
...
**Parent Topic:**[Identify and execute mitigation strategies for purchase order exceptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/source-to-pay-operations/finance-and-supply-chain/mitigation-strategies-for-po-exceptions.md)
