...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/source-to-pay-operations/finance-and-supply-chain/activate-poe-mitigation-strategy-workflow.html
release: australia
...
3.  Open the workflow configuration page by selecting **Define PO exception mitigation strategy**.
    ...
    If you want to modify this AI agent, you can refer to . Adjust the settings for your specific needs, and activate the duplicated version of the agentic workflow.
...
**Parent Topic:**[Configure Now Assist for Purchase Order Management \(POM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/source-to-pay-operations/finance-and-supply-chain/configure-now-assist-purch-order-mgmt.md)
