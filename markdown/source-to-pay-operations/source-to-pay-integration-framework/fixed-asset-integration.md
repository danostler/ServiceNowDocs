...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/source-to-pay-integration-framework/fixed-asset-integration.html
release: zurich
...
For more information on automatic fixed asset creation, see [Fixed asset creation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/sourcing-and-procurement-operations/fixed-asset-creation.md).
