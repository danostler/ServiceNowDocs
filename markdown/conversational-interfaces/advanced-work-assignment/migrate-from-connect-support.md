...
If you are currently using Connect Support APIs, see [AWA Routing API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/rest-apis/queue-api.md) for information on AWA APIs.
