...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/configure-sn-instance-google-dialogflow.html
release: zurich
...
[Generate a Java Keystore file from the JSON private key file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/generate-jks-from-json-dialogflow.md).
...
4.  Use the JSON file you downloaded in a [previous step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/create-srvc-acct-key-dialogflow.md) to fill in the form.
    ...
    |Keystore Password|The password that you used when you created the Java Keystore \(JKS\) file in a [previous step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/generate-jks-from-json-dialogflow.md).|
...
**Previous topic:**[Generate a Java Keystore file from the JSON private key file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/generate-jks-from-json-dialogflow.md)

**Next topic:**[Create a Virtual Agent Bot Interconnect shell topic to call Google Dialogflow topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/link-ggl-dialogflow-intents-va.md)
