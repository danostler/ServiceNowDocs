...
**Note:** For information about configuring components of the Virtual Agent Analytics dashboard \(such as Performance Analytics widgets\), see [Add and configure components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/ui-builder/add-components.md).
