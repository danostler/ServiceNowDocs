...
-   Core ServiceNow® mobile plugins
    ...
    For more information, see [Mobile plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/sg-mobile-plugins.md).
