...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/vad-configure-dialogflow-security.html
release: zurich
...
5.  In your ServiceNow instance, update the Google Dialogflow JWT provider record.
    ...
    4.  In the Standard Claims related list, enter the email address for your Google Dialogflow agent service account as the **Claim Value** for the **iss** entry.
        ...
        For more information, refer to [Create a service account and private key in Google Dialogflow ES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-create-srvc-acct-key-dialogflow.md).
...
8.  Specify Google Dialogflow ES as your NLU provider in Virtual Agent.
    ...
    For more information, see [Configure Natural Language Understanding in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/configure-nlu-settings.md).
...
**Previous topic:**[Create a service account and private key in Google Dialogflow ES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-create-srvc-acct-key-dialogflow.md)

**Next topic:**[Activate the Google Dialogflow ES service and enable it in your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/activate-ggl-df-es-service.md)
