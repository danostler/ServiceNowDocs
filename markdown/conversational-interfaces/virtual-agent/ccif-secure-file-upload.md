...
**Note:** Subdomains under a trusted domain are also trusted. You do not need to specify subdomains in this list.
 ...
 If this field is not visible, you can [configure the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/configure-form-layout.md) to show it.
