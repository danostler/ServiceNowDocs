...
You can publish the model at the same time as the Virtual Agent topic if the model meets publication criteria. Make sure your model has passed through all phases of development and is ready to publish. For more information, see [Model management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/nlu-service/model-management-phases.md).

For more information on providing feedback using thumbs icons in the results, see [Test panel feedback](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/nlu-service/test-model-panel-feedback.md).
