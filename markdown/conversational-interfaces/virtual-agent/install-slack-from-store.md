...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/install-slack-from-store.html
release: zurich
...
-   The Slack app creates a one-to-one association between the ServiceNow instance that you are installing from and the Slack workspace in which the integration runs.
    ...
    -   If you use a non-production instance for testing, use a Self-configured bot.
        ...
        For more information, see [Integrate your ServiceNow instance with a self-configured bot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/integ-slack-self-config-bot.md).
