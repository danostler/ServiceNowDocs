...
2.  Enable the generative AI experience for a catalog item request submission in Virtual Agent.
    ...
    2.  Select a catalog item that must be requested in the conversation mode.
        ...
        For information about catalog items that are supported in the conversation mode, see [Topic blocks to request catalog items through conversational experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/service-catalog/request-topic-blocks-va-llm.md).
...
<table id="choicetable_omj_3fl_lzb"><thead><tr><th align="left" id="d59456e311">

Option

</th><th align="left" id="d59456e314">

Description

</th></tr></thead><tbody><tr><td id="d59456e320">
...
</td></tr><tr><td id="d59456e359">

**Build additional logic in a new subflow. For example, to refer to a new record producer for each business.**

</td><td>

1.  Create a subflow to return the sys\_id of a record producer. For information about Flow Designer subflows, see [Building subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/workflow-studio/subflows.md).
...
[Service Catalog topic blocks in Virtual Agent powered by NLU](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/service-catalog/request-topic-blocks-va.md)

[Topic blocks to request catalog items through conversational experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/service-catalog/request-topic-blocks-va-llm.md)
