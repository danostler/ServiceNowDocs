...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/ac-configure-pre-chat-surveys.html
release: zurich
...
[Create the chat survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/create-chat-surveys.md) to be used in this pre-chat survey configuration.
