...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/ac-configure-context-variables.html
release: zurich
...
Virtual Agent provides pre-built context variables. Before you add a variable, review the list of [available Live Agent context variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/live-agent-chat-context-vars.md).
...
-   **[Live agent chat context variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/live-agent-chat-context-vars.md)**  
