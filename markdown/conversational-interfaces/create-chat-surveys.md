...
2.  Select the **Configuration** tab and configure the survey.
    ...
    -   Select **Save**.
    For details, see [Configure a survey in the survey designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/t_ConfigSurveyInSurveyDesgnr.md).
...
3.  Select the **Design** tab and give your survey a **Name**.
    ...
    -   Select **Save**.
    For details, see [Create a question in the survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/ai-platform-capabilities/t_CreateQuestSurveyDesigr.md).
